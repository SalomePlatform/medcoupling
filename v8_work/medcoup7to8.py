...
REPLACEMENTS = [
    ...
    ("isIdentity2", "isIota"),
    (
        "SWIGTYPE_p_MEDCoupling__MEDCouplingExtrudedMesh",
    ...
    (
        "MEDCoupling_DataArrayByte_locateTuple",
        "MEDCoupling_DataArrayByte_findIdFirstEqualTuple",
    ),
    (
        "MEDCoupling_DataArrayAsciiChar_locateTuple",
        "MEDCoupling_DataArrayAsciiChar_findIdFirstEqualTuple",
    ),
...
parser = OptionParser()
parser.set_usage(
    "Automatic code renaming, corresponding to the API changes between version 7x and 8x of MEDCoupling.\n"
