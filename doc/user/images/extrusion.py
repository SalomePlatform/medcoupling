...
<ViewState>
    ...
    <ViewScale Parallel="6.42314" X="1" Y="1" Z="1"/>
...
# set up entry SMESH_4 (myCurveLinearMesh) parameters
...
# set up entry SMESH_5 (Extruded) parameters
...
# set up entry SMESH_6 (Extruded) parameters
