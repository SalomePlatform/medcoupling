...
medfile = os.path.join(
    os.getenv("MEDCOUPLING_ROOT_DIR"), "share", "resources", "med", "pointe.med"
)
...
partmed.AllArrays = [
    "TS0/maa1/ComSup0/fieldnodeint@@][@@P1",
    "TS0/maa1/ComSup0/maa1@@][@@P0",
]
