...
// This file contains code used only for
// generation of documentation. Not working?

/*!
 * \namespace INTERP_KERNEL
 * \brief Low level structures and algorithms used in MEDCoupling. Not considered as part of the public API.
 */
