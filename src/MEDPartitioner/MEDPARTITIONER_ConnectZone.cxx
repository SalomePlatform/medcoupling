...
MEDPARTITIONER::ConnectZone::~ConnectZone()
{
    for (std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::iterator iter = _entity_corresp.begin();
         iter != _entity_corresp.end();
         iter++)
    {
        iter->second->decrRef();
    }
...
std::string
MEDPARTITIONER::ConnectZone::getName() const
{
    return _name;
}

std::string
MEDPARTITIONER::ConnectZone::getDescription() const
{
    return _description;
}

int
MEDPARTITIONER::ConnectZone::getDistantDomainNumber() const
{
    return _distant_domain_number;
}

int
MEDPARTITIONER::ConnectZone::getLocalDomainNumber() const
{
    return _local_domain_number;
}

MEDCouplingUMesh *
MEDPARTITIONER::ConnectZone::getLocalMesh() const
{
    return _local_mesh;
}

MEDCouplingUMesh *
MEDPARTITIONER::ConnectZone::getDistantMesh() const
{
    return _distant_mesh;
}

bool
MEDPARTITIONER::ConnectZone::isEntityCorrespPresent(mcIdType localEntity, mcIdType distantEntity) const
{
...
const mcIdType *
MEDPARTITIONER::ConnectZone::getNodeCorrespIndex() const
{
    return _node_corresp->getIndex();
}

const mcIdType *
MEDPARTITIONER::ConnectZone::getNodeCorrespValue() const
{
    return _node_corresp->getValues();
}

mcIdType
MEDPARTITIONER::ConnectZone::getNodeNumber() const
{
    return _node_corresp->getNumberOf();
}

const MEDCouplingSkyLineArray *
MEDPARTITIONER::ConnectZone::getNodeCorresp() const
{
    return (const MEDCouplingSkyLineArray *)_node_corresp;
}

const mcIdType *
MEDPARTITIONER::ConnectZone::getFaceCorrespIndex() const
{
    return _face_corresp->getIndex();
}

const mcIdType *
MEDPARTITIONER::ConnectZone::getFaceCorrespValue() const
{
    return _face_corresp->getValues();
}

mcIdType
MEDPARTITIONER::ConnectZone::getFaceNumber() const
{
    return _face_corresp->getNumberOf();
}

const MEDCouplingSkyLineArray *
MEDPARTITIONER::ConnectZone::getFaceCorresp() const
{
    return _face_corresp;
}

const mcIdType *
MEDPARTITIONER::ConnectZone::getEntityCorrespIndex(mcIdType localEntity, mcIdType distantEntity) const
{
    typedef std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::const_iterator map_iter;
...
const mcIdType *
MEDPARTITIONER::ConnectZone::getEntityCorrespValue(mcIdType localEntity, mcIdType distantEntity) const
{
    typedef std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::const_iterator map_iter;
...
mcIdType
MEDPARTITIONER::ConnectZone::getEntityCorrespNumber(mcIdType localEntity, mcIdType distantEntity) const
{
    typedef std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::const_iterator map_iter;
...
mcIdType
MEDPARTITIONER::ConnectZone::getEntityCorrespLength(mcIdType localEntity, mcIdType distantEntity) const
{
    typedef std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::const_iterator map_iter;
...
MEDPARTITIONER::ConnectZone::getEntities() const
{
    std::vector<std::pair<mcIdType, mcIdType> > types;

    std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::const_iterator iter = _entity_corresp.begin();
...
void
MEDPARTITIONER::ConnectZone::setName(const std::string &name)
{
    _name = name;
}

void
MEDPARTITIONER::ConnectZone::setDescription(const std::string &description)
{
    _description = description;
}

void
MEDPARTITIONER::ConnectZone::setDistantDomainNumber(int distantDomainNumber)
{
    _distant_domain_number = distantDomainNumber;
}

void
MEDPARTITIONER::ConnectZone::setLocalDomainNumber(int localDomainNumber)
{
    _local_domain_number = localDomainNumber;
}

void
MEDPARTITIONER::ConnectZone::setLocalMesh(MEDCouplingUMesh *localMesh)
{
    _local_mesh = localMesh;
}

void
MEDPARTITIONER::ConnectZone::setDistantMesh(MEDCouplingUMesh *distantMesh)
{
 ...
 */
void
MEDPARTITIONER::ConnectZone::setNodeCorresp(const mcIdType *nodeCorresp, mcIdType nbnode)
{
...
void
MEDPARTITIONER::ConnectZone::setNodeCorresp(MEDCouplingSkyLineArray *array)
{
 ...
 */
void
MEDPARTITIONER::ConnectZone::setFaceCorresp(const mcIdType *faceCorresp, mcIdType nbface)
{
    MCAuto<DataArrayIdType> indexArr(DataArrayIdType::New());
    MCAuto<DataArrayIdType> valueArr(DataArrayIdType::New());
...
void
MEDPARTITIONER::ConnectZone::setFaceCorresp(MEDCouplingSkyLineArray *array)
{
    MCAuto<MEDCouplingSkyLineArray> arr(array);
    _face_corresp = arr;
}
 ...
 */
void
MEDPARTITIONER::ConnectZone::setEntityCorresp(
    mcIdType localEntity, mcIdType distantEntity, const mcIdType *entityCorresp, mcIdType nbentity
)
{
    MCAuto<DataArrayIdType> indexArr(DataArrayIdType::New());
    MCAuto<DataArrayIdType> valueArr(DataArrayIdType::New());
...
void
MEDPARTITIONER::ConnectZone::setEntityCorresp(
    mcIdType localEntity, mcIdType distantEntity, MEDCouplingSkyLineArray *array
)
{
    MEDCouplingSkyLineArray *nullArray = 0;
    std::map<std::pair<mcIdType, mcIdType>, MEDCouplingSkyLineArray *>::iterator it;
    it = _entity_corresp.insert(std::make_pair(std::make_pair(localEntity, distantEntity), nullArray)).first;
    if (it->second != nullArray)
        it->second->decrRef();
    it->second = array;
}
