...
/*
  ...
  medpartitioner --input-file=medpartitioner_blade.xml --output-file=ttmp1_ --ndomains=2 --dump-cpu-memory
  --verbose=$verb medpartitioner --input-file=ttmp1_.xml --output-file=tttmp1_ --ndomains=4 --dump-cpu-memory
  --verbose=$verb
*/
...
main(int argc, char **argv)
{
    ...
    string desc(
        "Available options of medpartitioner V1.0:\n"
    ...
    for (int i = 1; i < argc; i++)
    {
        ...
        else if (TestArg(argv[i], "--create-joints", value))
            MyGlobals::_Create_Joints = 1;
...
// user choice
    ...
    try
    {
        ...
        if (MyGlobals::_Is0verbose)
            cout << "Computing partition with " << library << endl;
