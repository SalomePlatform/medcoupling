...
ParMETISGraph::ParMETISGraph(MEDCoupling::MEDCouplingSkyLineArray *graph, int *edgeweight) : Graph(graph, edgeweight) {}

ParMETISGraph::~ParMETISGraph() {}

void
ParMETISGraph::partGraph(int ndomain, const std::string &options_string, ParaDomainSelector *parallelizer)
{
    using std::vector;
    ...
    */
    ...
    throw INTERP_KERNEL::Exception(
        "ParMETISGraph::partGraph : PARMETIS is not available. Check your products, please."
    );
#else
    ...
    ParMETIS_PartKway(
        vtxdist, xadj, adjncy, vwgt, adjwgt, &wgtflag, &base, &nparts, options, &edgecut, partition, &comm
    );
