...
TransformedTriangleTest::setUp()
{
    ...
    p2[0] = 0.000000000084654984189118;
    p2[1] = -0.000000000000000027536546231654231688873;
    p2[2] = 0.0000000000000001649875466831349431;
    q2[0] = -p2[0] + err;
    q2[1] = -p2[1] + err;
    q2[2] = -p2[2] + err;
    r2[0] = 2.01;
 ...
 */
void
TransformedTriangleTest::tearDown()
{
    delete tri1;
    delete tri2;
}
...
/// \brief Status : pass
void
TransformedTriangleTest::test_constructor()
{
    // test that _coords has correct values after constructor is called

    double good_values1[15] = {
        p1[0], p1[1], p1[2], hp1, Hp1, q1[0], q1[1], q1[2], hq1, Hq1, r1[0], r1[1], r1[2], hr1, Hr1
    };

    double good_values2[15] = {
        p2[0], p2[1], p2[2], hp2, Hp2, q2[0], q2[1], q2[2], hq2, Hq2, r2[0], r2[1], r2[2], hr2, Hr2
    };
...
/// \brief Status : pass
void
TransformedTriangleTest::test_calcUnstableC()
{
    ...
    double correct_c_vals[24] = {
        p1[0] * q1[1] - p1[1] * q1[0], p1[1] * q1[2] - p1[2] * q1[1], p1[2] * q1[0] - p1[0] * q1[2],
        p1[0] * hq1 - hp1 * q1[0],     p1[1] * hq1 - hp1 * q1[1],     p1[2] * hq1 - hp1 * q1[2],
        Hp1 * q1[0] - p1[0] * Hq1,     p1[1] * Hq1 - Hp1 * q1[1],     q1[0] * r1[1] - q1[1] * r1[0],
        q1[1] * r1[2] - q1[2] * r1[1], q1[2] * r1[0] - q1[0] * r1[2], q1[0] * hr1 - hq1 * r1[0],
        q1[1] * hr1 - hq1 * r1[1],     q1[2] * hr1 - hq1 * r1[2],     Hq1 * r1[0] - q1[0] * Hr1,
        q1[1] * Hr1 - Hq1 * r1[1],     r1[0] * p1[1] - r1[1] * p1[0], r1[1] * p1[2] - r1[2] * p1[1],
        r1[2] * p1[0] - r1[0] * p1[2], r1[0] * hp1 - hr1 * p1[0],     r1[1] * hp1 - hr1 * p1[1],
        r1[2] * hp1 - hr1 * p1[2],     Hr1 * p1[0] - r1[0] * Hp1,     r1[1] * Hp1 - Hr1 * p1[1]
    };
...
/// \brief Status : pass
void
TransformedTriangleTest::test_calcUnstableT()
{
    ...
    const double correct_t_vals[4] = {
        p1[0] * (q1[1] * r1[2] - q1[2] * r1[1]) - q1[0] * (p1[1] * r1[2] - p1[2] * r1[1]) +
            r1[0] * (p1[1] * q1[2] - p1[2] * q1[1]),

        -(hp1 * (q1[1] * r1[2] - q1[2] * r1[1]) - hq1 * (p1[1] * r1[2] - p1[2] * r1[1]) +
          hr1 * (p1[1] * q1[2] - p1[2] * q1[1])),

        -(p1[0] * (hq1 * r1[2] - q1[2] * hr1) - q1[0] * (hp1 * r1[2] - p1[2] * hr1) +
          r1[0] * (hp1 * q1[2] - p1[2] * hq1)),

        -(p1[0] * (q1[1] * hr1 - r1[1] * hq1) - q1[0] * (p1[1] * hr1 - r1[1] * hp1) +
          r1[0] * (p1[1] * hq1 - q1[1] * hp1))
    };

    // test that triple products are correctly calculated
    for (TetraCorner corner = TransformedTriangle::O; corner <= TransformedTriangle::Z;
         corner = TetraCorner(corner + 1))
    {
...
TransformedTriangleTest::test_calcStableC_Consistency()
{
    ...
    // grandy, eq 14
    double correct_c_vals[24] = {
        p2[0] * q2[1] - p2[1] * q2[0], p2[1] * q2[2] - p2[2] * q2[1], p2[2] * q2[0] - p2[0] * q2[2],
        p2[0] * hq2 - hp2 * q2[0],     p2[1] * hq2 - hp2 * q2[1],     p2[2] * hq2 - hp2 * q2[2],
        Hp2 * q2[0] - p2[0] * Hq2,     p2[1] * Hq2 - Hp2 * q2[1],     q2[0] * r2[1] - q2[1] * r2[0],
        q2[1] * r2[2] - q2[2] * r2[1], q2[2] * r2[0] - q2[0] * r2[2], q2[0] * hr2 - hq2 * r2[0],
        q2[1] * hr2 - hq2 * r2[1],     q2[2] * hr2 - hq2 * r2[2],     Hq2 * r2[0] - q2[0] * Hr2,
        q2[1] * Hr2 - Hq2 * r2[1],     r2[0] * p2[1] - r2[1] * p2[0], r2[1] * p2[2] - r2[2] * p2[1],
        r2[2] * p2[0] - r2[0] * p2[2], r2[0] * hp2 - hr2 * p2[0],     r2[1] * hp2 - hr2 * p2[1],
        r2[2] * hp2 - hr2 * p2[2],     Hr2 * p2[0] - r2[0] * Hp2,     r2[1] * Hp2 - Hr2 * p2[1]
    };
    ...
    for (TriSegment seg = TransformedTriangle::PQ; seg <= TransformedTriangle::RP; seg = TriSegment(seg + 1))
    {
        ...
        if ((num_zero == 1 && num_neg != 1) || num_zero == 2 || (num_neg == 0 && num_zero != 3) || num_neg == 3)
        {
                 ...
                 corner = TetraCorner(corner + 1))
            {
                ...
                const double ptQ[3] = {
                    tri2->_coords[5 * ((seg + 1) % 3)],
                    tri2->_coords[5 * ((seg + 1) % 3) + 1],
                    tri2->_coords[5 * ((seg + 1) % 3) + 2]
                };
            ...
            static const DoubleProduct DOUBLE_PRODUCTS[12] = {
                TransformedTriangle::C_YZ,
                TransformedTriangle::C_XY,
                TransformedTriangle::C_ZX,  // O
                TransformedTriangle::C_ZH,
                TransformedTriangle::C_YZ,
                TransformedTriangle::C_YH,  // X
                TransformedTriangle::C_ZH,
                TransformedTriangle::C_ZX,
                TransformedTriangle::C_XH,  // Y
                TransformedTriangle::C_XY,
                TransformedTriangle::C_YH,
                TransformedTriangle::C_XH  // Z
            };

            for (int i = 0; i < 3; ++i)
            {
                DoubleProduct dp = DOUBLE_PRODUCTS[3 * min_corner + i];
                //        std::cout << std::endl << "in test inconsistent (seg,dp) :(" << seg <<", " << dp << ")" <<
                //        std::endl;
