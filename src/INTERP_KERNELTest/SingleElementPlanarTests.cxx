...
// \brief Status : pass
void
SingleElementPlanarTests::diamondsBasic()
{
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Basic diamond crossing test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}

void
SingleElementPlanarTests::diamondsBasic_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _losange2, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Basic diamond crossing test failed (TRIANGULATION)",
...
// \brief Status : pass
void
SingleElementPlanarTests::tangentDiamonds()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamond exclusion tangency test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::tangentDiamonds_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _losange3, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamond exclusion tangency test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::tangentSquares()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    expected_result.push_back(0.);
    expected_result.push_back(0.25);
    expected_result.push_back(0.);
    expected_result.push_back(-0.25);
    expected_result.push_back(1.);
    expected_result.push_back(-0.25);
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Squares inclusion tangency test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::tangentSquares_Triangulation()
{
    std::vector<double> actual_result;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Squares inclusion tangency test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::diamondsSharingVertex1()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamond sharing (1) vertex test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::diamondsSharingVertex1_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _losange4, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamonds sharing (1) vertex test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::identicalSquares()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    /*
      ////////////////// TEST DEACTIVATED by A. GEAY because memory fault :
      // conditional jump INTERP_KERNEL::PolygonAlgorithms<2>::intersectConvexPolygons(double const*, double const*,
    int, int) (PolygonAlgorithms.txx:629) std::deque< double > actual_result =
    intersector.intersectConvexPolygons(_square1,_square1,4,4); std::deque< double > expected_result;
    ...
    CPPUNIT_ASSERT_MESSAGE("Identical squares test failed (CONVEX)",
                           (INTERP_KERNEL::checkEqualPolygons<std::deque<double>,2>(&actual_result, &expected_result,
    _Epsilon)));
    */
}
void
SingleElementPlanarTests::identicalSquares_Triangulation()
{
    std::vector<double> actual_result;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Identical squares test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::squareAndDiamondBasic()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Square and diamond basic test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::squareAndDiamondBasic_Triangulation()
{
    std::vector<double> actual_result;
    ...
    expected_result.push_back(1.);
    expected_result.push_back(0.5);
    expected_result.push_back(0.75);
    expected_result.push_back(0.75);
    expected_result.push_back(0.5);
    expected_result.push_back(1.);
    expected_result.push_back(0.);
    ...
    // CPPUNIT_ASSERT_MESSAGE("Square and diamond basic test failed (TRIANGULATION), maybe not significant (0,0) should
    // be removed", (INTERP_KERNEL::checkEqualPolygons<vector<double>,2>(&actual_result, &expected_result, _Epsilon)));
}
...
void
SingleElementPlanarTests::squareAndDiamondCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Square and diamond critical tangency test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::squareAndDiamondCritical_Triangulation()
{
    std::vector<double> actual_result;
    ...
    //     CPPUNIT_ASSERT_MESSAGE("Square and diamond basic test failed (TRIANGULATION) maybe not significant (0,0)
    //     should be removed",
    //                            (INTERP_KERNEL::checkEqualPolygons<vector<double>,2>(&actual_result, &expected_result,
    //                            _Epsilon)));
}
...
// \brief Status : pass
void
SingleElementPlanarTests::diamondsCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
...
void
SingleElementPlanarTests::diamondsCritical_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange6, _losange7, 6, 5, actual_result, _Epsilon / _Precision, _Precision
    );
...
// \brief Status : pass
void
SingleElementPlanarTests::quadranglesCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Critical quadrangles with tangency test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::quadranglesCritical_Triangulation()
{
    std::vector<double> actual_result;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Critical quadrangles with tangency test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::quadrangleAndDiamondCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
...
void
SingleElementPlanarTests::quadrangleAndDiamondCritical_Triangulation()
{
    std::vector<double> actual_result;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Square and diamond critical tangency test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}  //  square and diamond intersecting at four degenerated pointss
//
...
void
SingleElementPlanarTests::diamondsCritical2()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamonds with crossing at double vertex test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::diamondsCritical2_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _losange9, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamonds with crossing at double vertex test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::hexagonsCritical1()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "First hexagon critical crossing test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::hexagonsCritical1_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _hexagon1, _hexagon2, 6, 6, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    expected_result.push_back(-1.5);
    expected_result.push_back(0.5);
    expected_result.push_back(-8. / 7);
    expected_result.push_back(2. / 7);
    expected_result.push_back(-1.4);
    expected_result.push_back(0.2);
    expected_result.push_back(-4. / 3);
    expected_result.push_back(0.);
    expected_result.push_back(-2. / 3);
    expected_result.push_back(0.);
    expected_result.push_back(-1.25);
    expected_result.push_back(-0.25);
    expected_result.push_back(-1.);
    expected_result.push_back(-1.);
    expected_result.push_back(1.);
    ...
    expected_result.push_back(5. / 3);
    expected_result.push_back(1. / 3);
    expected_result.push_back(1.125);
    expected_result.push_back(0.875);
    expected_result.push_back(1.);
    expected_result.push_back(1.);
    expected_result.push_back(0.25);
    expected_result.push_back(0.75);
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "First hexagon critical crossing test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::hexagonsCritical2()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Second hexagon critical crossing test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::hexagonsCritical2_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _hexagon1, _hexagon3, 6, 6, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Second hexagon critical crossing test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::squareAndQuadrangleCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Identical squares test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::squareAndQuadrangleCritical_Triangulation()
{
    std::vector<double> actual_result;
...
// \brief Status : pass
void
SingleElementPlanarTests::diamondsSharingVertex2()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamond sharing vertex (2) test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::diamondsSharingVertex2_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _losange10, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Diamond sharing vertex (2) test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::triangleAndDiamondCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangle and diamonds critical test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::triangleAndDiamondCritical_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _losange1, _triangle1, 4, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangle and diamonds critical test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::triangleAndSquareBasic()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
...
void
SingleElementPlanarTests::triangleAndSquareBasic_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _square1, _triangle2, 4, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    expected_result.push_back(1.);
    expected_result.push_back(1. / 6);
    expected_result.push_back(0.375);
    expected_result.push_back(0.375);
    expected_result.push_back(0.);
    expected_result.push_back(0.5);
    expected_result.push_back(0.);
...
// \brief Status : pass
void
SingleElementPlanarTests::trianglesCritical()
{
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles critical test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 3>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesCritical_Triangulation()
{
    std::vector<double> actual_result;
    ...
    INTERP_KERNEL::intersec_de_polygone<2>(
        _triangle3rotated, _triangle4rotated, 3, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles critical test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::paralellogramsCritical1()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Paralellogram tangency test (1) failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::paralellogramsCritical1_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _parallel1, _parallel2, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Paralellogram tangency test (1) failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::paralellogramsCritical2()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Paralellogram tangency test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::paralellogramsCritical2_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _parallel1, _parallel3, 4, 4, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Paralellogram tangency test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::trianglesTangencyCritical()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesTangencyCritical_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _triangle5, _triangle6, 3, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
...
// \brief Status : pass
void
SingleElementPlanarTests::trianglesTangencyCritical2()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (2) test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesTangencyCritical2_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _triangle1, _triangle7, 3, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (2) test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
// \brief Status : pass
void
SingleElementPlanarTests::trianglesTangencyCritical3()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (3) test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesTangencyCritical3_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _triangle8, _triangle9, 3, 3, actual_result, _Epsilon / _Precision, _Precision
    );

    std::vector<double> expected_result;
    expected_result.push_back(22.4601);
    expected_result.push_back(35.2129);
    expected_result.push_back(13.9921);
    expected_result.push_back(34.693);

    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (3) test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesTangencyCritical4()
{
    INTERP_KERNEL::PolygonAlgorithms<2> intersector(_Epsilon, _Precision);
    ;
    ...
    std::deque<double> expected_result;
    expected_result.push_back(82.745193090443536);
    expected_result.push_back(96.184114390029166);
    expected_result.push_back(82.260099999999994);
    expected_result.push_back(95.720200000000006);
    expected_result.push_back(80);
    expected_result.push_back(100.);

    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (4) test failed (CONVEX)",
        (INTERP_KERNEL::checkEqualPolygons<std::deque<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
void
SingleElementPlanarTests::trianglesTangencyCritical4_Triangulation()
{
    std::vector<double> actual_result;
    INTERP_KERNEL::intersec_de_polygone<2>(
        _triangle10, _triangle11, 3, 3, actual_result, _Epsilon / _Precision, _Precision
    );
    ...
    CPPUNIT_ASSERT_MESSAGE(
        "Triangles tangency critical (4) test failed (TRIANGULATION)",
        (INTERP_KERNEL::checkEqualPolygons<std::vector<double>, 2>(&actual_result, &expected_result, _Epsilon))
    );
}
