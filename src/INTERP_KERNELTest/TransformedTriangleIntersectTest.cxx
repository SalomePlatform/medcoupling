...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle1()
{
    ...
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::PQ, TT::O) && tri->testSegmentCornerIntersection(TT::PQ, TT::O)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::PQ, TT::X) && tri->testSegmentCornerIntersection(TT::PQ, TT::X)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::PQ, TT::Y) && tri->testSegmentCornerIntersection(TT::PQ, TT::Y)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::PQ, TT::Z) && tri->testSegmentCornerIntersection(TT::PQ, TT::Z)
    );

    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::QR, TT::O) && tri->testSegmentCornerIntersection(TT::QR, TT::O)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::QR, TT::X) && tri->testSegmentCornerIntersection(TT::QR, TT::X)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::QR, TT::Y) && tri->testSegmentCornerIntersection(TT::QR, TT::Y)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::QR, TT::Z) && tri->testSegmentCornerIntersection(TT::QR, TT::Z)
    );

    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::RP, TT::O) && tri->testSegmentCornerIntersection(TT::RP, TT::O)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::RP, TT::X) && tri->testSegmentCornerIntersection(TT::RP, TT::X)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::RP, TT::Y) && tri->testSegmentCornerIntersection(TT::RP, TT::Y)
    );
    CPPUNIT_ASSERT_EQUAL(
        false, TEST_ZERO_DP_CORNER(TT::RP, TT::Z) && tri->testSegmentCornerIntersection(TT::RP, TT::Z)
    );
...
/// \brief Status: pass
void
TransformedTriangleIntersectTest::testTriangle2()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle3()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle4()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle5()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle6()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle7()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle8()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle9()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle10()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle11()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle12()
{
...
/// \brief Status : pass
void
TransformedTriangleIntersectTest::testTriangle13()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol1()
{
    ...
    for (const auto &pt : tri._polygonA) LOG(3, vToStr(pt));
    LOG(3, "  --- Final points in polygon B");
    for (const auto &pt : tri._polygonB) LOG(3, vToStr(pt));
...
// Extract from BoxHexa1.med (or was it BoxHexa2.med ?)
void
TransformedTriangleIntersectTest::testTriangle_vol2()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol3()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol4()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol5()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol6()
{
    LOG(1, "+++++++ Testing testTriangle_vol6");

    double coords[9] = {1.000000000000004, 0, 0, 0, 0, 0.9999999999999929, 3.552713678800501e-15, 1, 0};
    double refVol = -1 / 6.;
...
void
TransformedTriangleIntersectTest::testTriangle_vol7()
{
...
void
TransformedTriangleIntersectTest::testTriangle_vol8()
{
    ...
    //    CPPUNIT_ASSERT (! tri.isTriangleInPlaneOfFacet(TransformedTriangle::XYZ) ); // not degenerate if threshold
    //    == 20.0
    CPPUNIT_ASSERT_DOUBLES_EQUAL(vol, refVol, 1.0e-10);
}
