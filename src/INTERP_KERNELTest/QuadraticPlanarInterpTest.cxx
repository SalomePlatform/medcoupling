...
void
QuadraticPlanarInterpTest::setUp()
{
}

void
QuadraticPlanarInterpTest::tearDown()
{
}

void
QuadraticPlanarInterpTest::cleanUp()
{
}

void
QuadraticPlanarInterpTest::ReadWriteInXfigElementary()
{
...
void
QuadraticPlanarInterpTest::ReadWriteInXfigGlobal()
{
    ...
    edge->changeMiddle(n1);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(0.24375, edge->getRadius(), ADMISSIBLE_ERROR);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(-0.49741997818704586, edge->getAngle(), ADMISSIBLE_ERROR);  // 5.7857653289925404 +
                                                                                             // 2*PI
    n1->decrRef();
    // A half circle.
...
void
QuadraticPlanarInterpTest::BasicGeometricTools()
{
...
void
QuadraticPlanarInterpTest::IntersectionBasics()
{
    ...
    Bounds *bound = e1->getBounds().amIIntersectingWith(e2->getBounds());
    ...
    bound = e3->getBounds().amIIntersectingWith(e4->getBounds());
    CPPUNIT_ASSERT(bound);
...
void
QuadraticPlanarInterpTest::EdgeLinUnitary()
{
 ...
 */
void
QuadraticPlanarInterpTest::IntersectionEdgeOverlapUnitarySegSeg()
{
    ComposedEdge &v1 = *(new ComposedEdge);
    ComposedEdge &v2 = *(new ComposedEdge);
    QuadraticPlanarPrecision::setPrecision(
        5.0e-14
    );  // [ABN] man, those tests are really close to epsilon! I need to relax this a bit.
    MergePoints v3;
    // Testing merge of geometric equals seg2.
    Edge *e1 = new EdgeLin(0.5, 0.5, 1., 1.);
    Edge *e2 = new EdgeLin(0.5, 0.5, 1., 1.);
    ...
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e1) && v2[0]->getDirection());
    v1.clear();
    v2.clear();
    v3.clear();
    //  - testing by adding some noise
    e1->decrRef();
    e1 = new EdgeLin(0.5 + 5.e-15, 0.5 - 5.e-15, 1., 1. + 7.e-15);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(2, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(1, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    ...
    e1 = new EdgeLin(0.5, 0.5, 0.7, 0.7);
    e2 = new EdgeLin(0.7 + 6.e-15, 0.7 - 2.e-15, 0.5 + 3.e-15, 0.5 - 4.e-15);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(2, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(1, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e1) && v1[0]->getDirection());
    CPPUNIT_ASSERT(
        v2[0]->intresincEqCoarse(e1) && !v2[0]->getDirection()
    );  // compared 8 lines above !v2[0]->getDirection()
    e2->decrRef();
    e1->decrRef();
    v1.clear();
    v2.clear();
    ...
    CPPUNIT_ASSERT(e1->getStartNode() == v1[0]->getStartNode());
    CPPUNIT_ASSERT(e1->getEndNode() == v1[1]->getEndNode());
    CPPUNIT_ASSERT(v2[0]->getEndNode() == v2[1]->getStartNode());
    CPPUNIT_ASSERT(e2->getStartNode() == v2[0]->getStartNode());
    CPPUNIT_ASSERT(e2->getEndNode() == v2[1]->getEndNode());
    ...
    e1 = new EdgeLin(0., 0., 1., 1.);
    e2 = new EdgeLin(0.5, 0.5, 1.5, 1.5);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(2, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(2, (int)v2.size());
    ...
    e1 = new EdgeLin(0., 0., 1., 1.);
    e2 = new EdgeLin(1.5, 1.5, 0.5, 0.5);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(2, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(2, (int)v2.size());
    ...
    CPPUNIT_ASSERT(v1[0]->getEndNode() == v1[1]->getStartNode());
    CPPUNIT_ASSERT(v1[1]->getEndNode() == v1[2]->getStartNode());
    CPPUNIT_ASSERT(v1[0]->getStartNode() == e1->getStartNode());
    CPPUNIT_ASSERT(v1[2]->getEndNode() == e1->getEndNode());
    ...
    e1 = new EdgeLin(0., 0., 1., 1.);
    e2 = new EdgeLin(0.25, 0.25, 0.75, 0.75);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(3, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    ...
    e1 = new EdgeLin(0., 0., 1., 1.);
    e2 = new EdgeLin(0.75, 0.75, 0.25, 0.25);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(3, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    ...
    double center[2] = {0., 0.};
    double radius = 1.;
    e1 = buildArcOfCircle(center, radius, -M_PI, 0);
    e2 = buildArcOfCircle(center, radius, -2 * M_PI / 3. + 2 * M_PI, -M_PI / 3.);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        5. * M_PI / 3., e2->getCurveLength(), 1e-12
    );  // To check that in the previous line +2.M_PI has done its job.
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(3, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(3, (int)v2.size());
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(v2[0]->getPtr()));
    CPPUNIT_ASSERT(v1[0]->getDirection());
    CPPUNIT_ASSERT(!v2[0]->getDirection());
    CPPUNIT_ASSERT(v1[2]->intresincEqCoarse(v2[2]->getPtr()));
    CPPUNIT_ASSERT(v1[2]->getDirection());
    CPPUNIT_ASSERT(!v2[2]->getDirection());
    ...
    e1 = buildArcOfCircle(center, radius, -M_PI, 0);
    e2 = buildArcOfCircle(center, radius, -M_PI / 3., -2 * M_PI / 3. + 2 * M_PI);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        5. * M_PI / 3., e2->getCurveLength(), 1e-12
    );  // To check that in the previous line +2.M_PI has done its job.
    ...
    CPPUNIT_ASSERT_EQUAL(3, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(3, (int)v2.size());
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(v2[2]->getPtr()));
    CPPUNIT_ASSERT(v1[0]->getDirection());
    CPPUNIT_ASSERT(v2[2]->getDirection());
    CPPUNIT_ASSERT(v1[2]->intresincEqCoarse(v2[0]->getPtr()));
    CPPUNIT_ASSERT(v1[2]->getDirection());
    CPPUNIT_ASSERT(v2[0]->getDirection());
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, v2[1]->getCurveLength(), 1.e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI / 3., v1[1]->getCurveLength(), 1.e-12);
    ...
    CPPUNIT_ASSERT(v2[2]->getDirection());
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        M_PI, v2[1]->getCurveLength(), 1.e-5
    );  // << not maximal precision because node switching
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI / 3., v1[1]->getCurveLength(), 1.e-12);
    CPPUNIT_ASSERT(v2[1]->getStartNode() == e1->getStartNode());
    CPPUNIT_ASSERT(v2[1]->getEndNode() == e1->getEndNode());
    CPPUNIT_ASSERT(v1[0]->getStartNode() == e1->getStartNode());
    ...
    e1 = new EdgeLin(0., 0., 1., 1.);
    e2 = new EdgeLin(-0.5, -0.5, 0.5, 0.5);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(0, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(2, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(2, (int)v2.size());
    ...
    e1 = new EdgeLin(0., 0., 0.7, 0.);
    e2 = new EdgeLin(0., 0., 0.7, 0.);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(2, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(1, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e1) && v1[0]->getDirection());
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e1) && v2[0]->getDirection());
    CPPUNIT_ASSERT(e1->getStartNode() == e2->getStartNode());
    CPPUNIT_ASSERT(e1->getEndNode() == e2->getEndNode());
    CPPUNIT_ASSERT(e1->getStartNode() == v1.front()->getStartNode() && e1->getEndNode() == v1.back()->getEndNode());
    CPPUNIT_ASSERT(e2->getStartNode() == v2.front()->getStartNode() && e2->getEndNode() == v2.back()->getEndNode());
    e2->decrRef();
    ...
    e1 = new EdgeLin(0., 0., 0.7, 0.7);
    e2 = new EdgeLin(0., 0., 0.7, 0.7);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(2, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(1, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    ...
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e1) && v1[0]->getDirection());
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e1) && !v2[0]->getDirection());
    CPPUNIT_ASSERT(e1->getStartNode() == e2->getEndNode());
    CPPUNIT_ASSERT(e1->getEndNode() == e2->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == v1.front()->getStartNode() && e1->getEndNode() == v1.back()->getEndNode());
    CPPUNIT_ASSERT(e2->getStartNode() == v2.front()->getStartNode() && e2->getEndNode() == v2.back()->getEndNode());
    e2->decrRef();
    e1->decrRef();
    ...
    CPPUNIT_ASSERT(e1->getStartNode() == v1[0]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == e2->getStartNode());
    CPPUNIT_ASSERT(v2[1]->getEndNode() == e2->getEndNode());
    CPPUNIT_ASSERT(v2[0]->getEndNode() == v2[1]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == v1.front()->getStartNode() && e1->getEndNode() == v1.back()->getEndNode());
    CPPUNIT_ASSERT(e2->getStartNode() == v2.front()->getStartNode() && e2->getEndNode() == v2.back()->getEndNode());
    e2->decrRef();
    ...
    e1 = new EdgeLin(0., 0., 1., 0.);
    e2 = new EdgeLin(0., 0., 0.5, 0.);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(2, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(1, (int)v2.size());
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e2) && v1[0]->getDirection());
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e2) && v2[0]->getDirection());
    CPPUNIT_ASSERT(e2->getStartNode() == v1[0]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == e2->getStartNode());
    CPPUNIT_ASSERT(e1->getEndNode() == v1[1]->getEndNode());
    CPPUNIT_ASSERT(v1[0]->getEndNode() == v1[1]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == v1.front()->getStartNode() && e1->getEndNode() == v1.back()->getEndNode());
    ...
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e2) && !v1[0]->getDirection());
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e2) && v2[0]->getDirection());
    CPPUNIT_ASSERT(e2->getEndNode() == v1[0]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == e2->getEndNode());
    CPPUNIT_ASSERT(e1->getEndNode() == v1[1]->getEndNode());
    CPPUNIT_ASSERT(v1[0]->getEndNode() == v1[1]->getStartNode());
    CPPUNIT_ASSERT(e1->getStartNode() == v1.front()->getStartNode() && e1->getEndNode() == v1.back()->getEndNode());
    ...
    e1 = buildArcOfCircle(center, radius, -M_PI, 2. * M_PI);
    e2 = buildArcOfCircle(center, radius, M_PI / 3., -M_PI);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(4. * M_PI / 3., e2->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT_EQUAL(2, (int)v1.size());
    CPPUNIT_ASSERT_EQUAL(2, (int)v2.size());
    ...
    e1 = buildArcOfCircle(center, radius, -M_PI, 2. * M_PI);
    e2 = buildArcOfCircle(center, radius, -M_PI, M_PI / 3.);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(4. * M_PI / 3., e2->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    ...
    e1 = buildArcOfCircle(center, radius, -M_PI, 2. * M_PI);
    e2 = buildArcOfCircle(center, radius, 0., -4. * M_PI / 3);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(4. * M_PI / 3., e2->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    ...
    e1 = buildArcOfCircle(center, radius, -M_PI, 2. * M_PI);
    e2 = buildArcOfCircle(center, radius, -4. * M_PI / 3, 0.);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(M_PI, e1->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT_DOUBLES_EQUAL(4. * M_PI / 3., e2->getCurveLength(), 1e-12);
    CPPUNIT_ASSERT(e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
 ...
 */
void
QuadraticPlanarInterpTest::IntersectionPointOnlyUnitarySegSeg()
{
    // 0deg - classical
    ...
    CPPUNIT_ASSERT(!e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT(v3.isStart1(0));
    CPPUNIT_ASSERT(v3.isStart2(0));
    e2->decrRef();
    e1->decrRef();
    v1.clear();
    v2.clear();
    ...
    // Test 2
    e1 = new EdgeLin(0., 0., 1., 0.);
    e2 = new EdgeLin(1., 1., 1., 0.);
    CPPUNIT_ASSERT(!e1->intersectWith(e2, v3, v1, v2));
    CPPUNIT_ASSERT_EQUAL(1, (int)v3.getNumberOfAssociations());
    CPPUNIT_ASSERT(v3.isEnd1(0));
    CPPUNIT_ASSERT(v3.isEnd2(0));
    e2->decrRef();
    e1->decrRef();
    v1.clear();
    v2.clear();
    ...
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e2) && v2[0]->getDirection());
    CPPUNIT_ASSERT(
        v1[0]->getStartNode() == e1->getStartNode() && v1[0]->getEndNode() == e2->getEndNode() &&
        v1[1]->getStartNode() == e2->getEndNode() && v1[1]->getEndNode() == e1->getEndNode()
    );
    ...
    CPPUNIT_ASSERT(v2[0]->intresincEqCoarse(e2) && v2[0]->getDirection());
    CPPUNIT_ASSERT(
        v1[0]->getStartNode() == e1->getStartNode() && v1[0]->getEndNode() == e2->getStartNode() &&
        v1[1]->getStartNode() == e2->getStartNode() && v1[1]->getEndNode() == e1->getEndNode()
    );
    CPPUNIT_ASSERT(v1[0]->getDirection() && v1[1]->getDirection());
    e2->decrRef();
    e1->decrRef();
    ...
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e1) && v1[0]->getDirection());
    CPPUNIT_ASSERT(
        v2[0]->getStartNode() == e2->getStartNode() && v2[0]->getEndNode() == e1->getStartNode() &&
        v2[1]->getStartNode() == e1->getStartNode() && v2[1]->getEndNode() == e2->getEndNode()
    );
    ...
    CPPUNIT_ASSERT(v1[0]->intresincEqCoarse(e1) && v1[0]->getDirection());
    CPPUNIT_ASSERT(
        v2[0]->getStartNode() == e2->getStartNode() && v2[0]->getEndNode() == e1->getEndNode() &&
        v2[1]->getStartNode() == e1->getEndNode() && v2[1]->getEndNode() == e2->getEndNode()
    );
    CPPUNIT_ASSERT(v2[0]->getDirection() && v2[1]->getDirection());
    e2->decrRef();
    e1->decrRef();
