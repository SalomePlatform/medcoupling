...
void
ExprEvalInterpTest::testBuildStringFromFortran()
{
    char toto1[] = "123456  ";
    char result[] = "123456";
    std::string titi;
...
void
ExprEvalInterpTest::testDeleteWhiteSpaces()
{
...
void
ExprEvalInterpTest::testInterpreter0()
{
...
void
ExprEvalInterpTest::testInterpreter1()
{
    ...
    INTERP_KERNEL::ExprParser expr22(
        "3.*max(((3.2*(ln((2*5.2+6.)+(1.2*1.2+3.))))),((3.2*(exp((6.+2*5.2)+(1.2*1.2+3.))))))"
    );
    expr22.parse();
...
void
ExprEvalInterpTest::testInterpreter2()
{
    ...
    expected.insert("x");
    expected.insert("y");
    expected.insert("IVec");
    expected.insert("JVec");
    CPPUNIT_ASSERT(std::equal(res.begin(), res.end(), expected.begin()));
...
void
ExprEvalInterpTest::testInterpreterUnit0()
{
...
void
ExprEvalInterpTest::testInterpreterUnit1()
{
...
void
ExprEvalInterpTest::testInterpreter3()
{
 ...
 */
void
ExprEvalInterpTest::testInterpreter4()
{
 ...
 */
void
ExprEvalInterpTest::testInterpreter5()
{
    std::set<std::string> res;
    double input[3];
    double res2[3];
    ...
    //
    INTERP_KERNEL::ExprParser expr4(
        "3.*max(((3.2e+1*(ln((2*5.2E-02+6.)+(1.2E-001*1.2E+2+3e-4))))),((3.2E-2*(exp((6e-1+2*5.2e-2)+(1.2E001*1.2+3.)))"
        ")))"
    );
    expr4.parse();
 ...
 */
void
ExprEvalInterpTest::testInterpreter6()
{
    ...
    //
    stackOfVal.clear();
    INTERP_KERNEL::ExprParser expr9("x*x/2");  // this test is very important to test for iso priority with more than
                                               // one
    expr9.parse();
