...
class MEDCouplingFieldDiscretization : public RefCountObject, public TimeLabel
{
   public:
    ...
    MEDCOUPLING_EXPORT virtual MEDCouplingFieldDiscretization *clonePart(
        const mcIdType *startCellIds, const mcIdType *endCellIds
    ) const;
    MEDCOUPLING_EXPORT virtual MEDCouplingFieldDiscretization *clonePartRange(
    ...
    MEDCOUPLING_EXPORT virtual mcIdType getNumberOfTuplesExpectedRegardingCode(
    ...
    MEDCOUPLING_EXPORT virtual void integral(
    ...
    MEDCOUPLING_EXPORT virtual void computeMeshRestrictionFromTupleIds(
    ...
    MEDCOUPLING_EXPORT virtual MEDCouplingFieldDouble *getMeasureField(
        const MEDCouplingMesh *mesh, bool isAbs
    ) const = 0;
    MEDCOUPLING_EXPORT virtual void getValueOn(
        const DataArrayDouble *arr, const MEDCouplingMesh *mesh, const double *loc, double *res
    ) const = 0;
    MEDCOUPLING_EXPORT virtual void getValueOnPos(
        const DataArrayDouble *arr, const MEDCouplingMesh *mesh, mcIdType i, mcIdType j, mcIdType k, double *res
    ) const = 0;
    MEDCOUPLING_EXPORT virtual DataArrayDouble *getValueOnMulti(
        const DataArrayDouble *arr, const MEDCouplingMesh *mesh, const double *loc, mcIdType nbOfPoints
    ) const = 0;
    MEDCOUPLING_EXPORT virtual DataArrayIdType *computeTupleIdsToSelectFromCellIds(
        const MEDCouplingMesh *mesh, const mcIdType *startCellIds, const mcIdType *endCellIds
    ) const = 0;
    MEDCOUPLING_EXPORT virtual MEDCouplingMesh *buildSubMeshData(
        const MEDCouplingMesh *mesh, const mcIdType *start, const mcIdType *end, DataArrayIdType *&di
    ) const = 0;
    MEDCOUPLING_EXPORT virtual MEDCouplingMesh *buildSubMeshDataRange(
        const MEDCouplingMesh *mesh,
    ...
    MEDCOUPLING_EXPORT virtual void renumberValuesOnNodes(
        double epsOnVals, const mcIdType *old2New, mcIdType newNbOfNodes, DataArrayDouble *arr
    ) const = 0;
    MEDCOUPLING_EXPORT virtual void renumberValuesOnCells(
        double epsOnVals, const MEDCouplingMesh *mesh, const mcIdType *old2New, mcIdType newSz, DataArrayDouble *arr
    ) const = 0;
    MEDCOUPLING_EXPORT virtual void renumberValuesOnCellsR(
        const MEDCouplingMesh *mesh, const mcIdType *new2old, mcIdType newSz, DataArrayDouble *arr
    ) const = 0;
    MEDCOUPLING_EXPORT virtual MCAuto<MEDCouplingFieldDiscretization> aggregate(
    ...
    MEDCOUPLING_EXPORT virtual void resizeForUnserialization(
        const std::vector<mcIdType> &tinyInfo, DataArrayIdType *&arr
    );
    MEDCOUPLING_EXPORT virtual void checkForUnserialization(
        const std::vector<mcIdType> &tinyInfo, const DataArrayIdType *arr
    );
    MEDCOUPLING_EXPORT virtual void setGaussLocalizationOnType(
    ...
    MEDCOUPLING_EXPORT virtual std::set<mcIdType> getGaussLocalizationIdsOfOneType(
        INTERP_KERNEL::NormalizedCellType type
    ) const;
    MEDCOUPLING_EXPORT virtual void getCellIdsHavingGaussLocalization(
   ...
   protected:
    ...
    MEDCOUPLING_EXPORT static void RenumberEntitiesFromO2NArr(
        double epsOnVals,
        const mcIdType *old2NewPtr,
        mcIdType newNbOfEntity,
        DataArrayDouble *arr,
        const std::string &msg
    );
    MEDCOUPLING_EXPORT static void RenumberEntitiesFromN2OArr(
        const mcIdType *new2OldPtr, mcIdType new2OldSz, DataArrayDouble *arr, const std::string &msg
    );
    template <class FIELD_DISC>
    static MCAuto<MEDCouplingFieldDiscretization> EasyAggregate(
        std::vector<const MEDCouplingFieldDiscretization *> &fds
    );
...
class MEDCouplingFieldDiscretizationP0 : public MEDCouplingFieldDiscretization
{
   public:
    ...
    MEDCOUPLING_EXPORT mcIdType getNumberOfTuplesExpectedRegardingCode(
        const std::vector<mcIdType> &code, const std::vector<const DataArrayIdType *> &idsPerType
    ) const;
    ...
    MEDCOUPLING_EXPORT void renumberArraysForCell(
        const MEDCouplingMesh *mesh, const std::vector<DataArray *> &arrays, const mcIdType *old2NewBg, bool check
    );
    ...
    MEDCOUPLING_EXPORT void computeMeshRestrictionFromTupleIds(
        const MEDCouplingMesh *mesh,
        const mcIdType *tupleIdsBg,
        const mcIdType *tupleIdsEnd,
        DataArrayIdType *&cellRestriction,
    ...
    MEDCOUPLING_EXPORT void getValueOnPos(
        const DataArrayDouble *arr, const MEDCouplingMesh *mesh, mcIdType i, mcIdType j, mcIdType k, double *res
    ) const;
    MEDCOUPLING_EXPORT DataArrayDouble *getValueOnMulti(
        const DataArrayDouble *arr, const MEDCouplingMesh *mesh, const double *loc, mcIdType nbOfPoints
    ) const override;
    MEDCOUPLING_EXPORT void renumberValuesOnNodes(
        double epsOnVals, const mcIdType *old2New, mcIdType newNbOfNodes, DataArrayDouble *arr
    ) const;
    MEDCOUPLING_EXPORT void renumberValuesOnCells(
        double epsOnVals, const MEDCouplingMesh *mesh, const mcIdType *old2New, mcIdType newSz, DataArrayDouble *arr
    ) const;
    MEDCOUPLING_EXPORT void renumberValuesOnCellsR(
        const MEDCouplingMesh *mesh, const mcIdType *new2old, mcIdType newSz, DataArrayDouble *arr
    ) const;
    MEDCOUPLING_EXPORT MCAuto<MEDCouplingFieldDiscretization> aggregate(
        std::vector<const MEDCouplingFieldDiscretization *> &fds
    ) const override;
    MEDCOUPLING_EXPORT MEDCouplingMesh *buildSubMeshData(
        const MEDCouplingMesh *mesh, const mcIdType *start, const mcIdType *end, DataArrayIdType *&di
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingMesh *buildSubMeshDataRange(
        const MEDCouplingMesh *mesh,
        mcIdType beginCellIds,
        mcIdType endCellIds,
        mcIdType stepCellIds,
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *computeTupleIdsToSelectFromCellIds(
        const MEDCouplingMesh *mesh, const mcIdType *startCellIds, const mcIdType *endCellIds
    ) const;
...
class MEDCouplingFieldDiscretizationP1 : public MEDCouplingFieldDiscretizationOnNodes
{
   ...
   protected:
    MEDCOUPLING_EXPORT void getValueInCell(
...
class MEDCouplingFieldDiscretizationPerCell : public MEDCouplingFieldDiscretization
{
   public:
    ...
    MEDCOUPLING_EXPORT std::vector<DataArrayIdType *> splitIntoSingleGaussDicrPerCellType(
   ...
   protected:
    ...
    MEDCouplingFieldDiscretizationPerCell(
        const MEDCouplingFieldDiscretizationPerCell &other,
        mcIdType beginCellIds,
        mcIdType endCellIds,
        mcIdType stepCellIds
    );
...
class MEDCouplingFieldDiscretizationGauss : public MEDCouplingFieldDiscretizationPerCell
{
   public:
    ...
    MEDCOUPLING_EXPORT MEDCouplingFieldDiscretization *clone() const override;
    MEDCOUPLING_EXPORT MEDCouplingFieldDiscretization *clonePart(
        const mcIdType *startCellIds, const mcIdType *endCellIds
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDiscretization *clonePartRange(
        mcIdType beginCellIds, mcIdType endCellIds, mcIdType stepCellIds
    ) const;
    MEDCOUPLING_EXPORT std::string getStringRepr() const;
    MEDCOUPLING_EXPORT const char *getRepr() const;
    ...
    MEDCOUPLING_EXPORT double getIJK(
        const MEDCouplingMesh *mesh, const DataArrayDouble *da, mcIdType cellId, mcIdType nodeIdInCell, int compoId
    ) const;
    MEDCOUPLING_EXPORT void checkCoherencyBetween(const MEDCouplingMesh *mesh, const DataArray *da) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *getMeasureField(const MEDCouplingMesh *mesh, bool isAbs) const override;
    ...
    MEDCOUPLING_EXPORT void setGaussLocalizationOnCells(
        const MEDCouplingMesh *mesh,
        const mcIdType *begin,
        const mcIdType *end,
        const std::vector<double> &refCoo,
    ...
    MEDCOUPLING_EXPORT std::set<mcIdType> getGaussLocalizationIdsOfOneType(
        INTERP_KERNEL::NormalizedCellType type
    ) const;
   ...
   protected:
    MEDCouplingFieldDiscretizationGauss(
        const MEDCouplingFieldDiscretizationGauss &other,
    ...
    MEDCouplingFieldDiscretizationGauss(DataArrayIdType *dpc, const std::vector<MEDCouplingGaussLocalization> &loc)
        : MEDCouplingFieldDiscretizationPerCell(dpc), _loc(loc)
    {
    }
...
/*!
 * Gauss with points of values located on nodes of element. This is a specialization of
 * MEDCouplingFieldDiscretizationGauss.
 */
class MEDCouplingFieldDiscretizationGaussNE : public MEDCouplingFieldDiscretization
{
   public:
    ...
    MEDCOUPLING_EXPORT DataArrayDouble *getLocalizationOfDiscValues(const MEDCouplingMesh *mesh) const;
    MEDCOUPLING_EXPORT void integral(
        const MEDCouplingMesh *mesh, const DataArrayDouble *arr, bool isWAbs, double *res
    ) const;
    MEDCOUPLING_EXPORT void computeMeshRestrictionFromTupleIds(
        const MEDCouplingMesh *mesh,
    ...
    MEDCOUPLING_EXPORT void reprQuickOverview(std::ostream &stream) const;
    MEDCOUPLING_EXPORT static const double *GetWeightArrayFromGeometricType(
        INTERP_KERNEL::NormalizedCellType geoType, std::size_t &lgth
    );
    MEDCOUPLING_EXPORT static const double *GetRefCoordsFromGeometricType(
        INTERP_KERNEL::NormalizedCellType geoType, std::size_t &lgth
    );
    MEDCOUPLING_EXPORT static const double *GetLocsFromGeometricType(
        INTERP_KERNEL::NormalizedCellType geoType, std::size_t &lgth
    );
...
class MEDCouplingFieldDiscretizationKriging : public MEDCouplingFieldDiscretizationOnNodes
{
   ...
   public:  // specific part
    MEDCOUPLING_EXPORT DataArrayDouble *computeEvaluationMatrixOnGivenPts(
        const MEDCouplingMesh *mesh, const double *loc, mcIdType nbOfTargetPoints, mcIdType &nbCols
    ) const;
    MEDCOUPLING_EXPORT DataArrayDouble *computeInverseMatrix(
        const MEDCouplingMesh *mesh, mcIdType &isDrift, mcIdType &matSz
    ) const;
    MEDCOUPLING_EXPORT DataArrayDouble *computeMatrix(
        const MEDCouplingMesh *mesh, mcIdType &isDrift, mcIdType &matSz
    ) const;
    MEDCOUPLING_EXPORT DataArrayDouble *computeVectorOfCoefficients(
    ...
    MEDCOUPLING_EXPORT DataArrayDouble *performDrift(
    ...
    MEDCOUPLING_EXPORT static DataArrayDouble *PerformDriftRect(
        const DataArrayDouble *matr, const DataArrayDouble *arr, mcIdType &delta
    );
...
MEDCouplingFieldDiscretization::EasyAggregate(std::vector<const MEDCouplingFieldDiscretization *> &fds)
{
    if (fds.empty())
    ...
    for (const MEDCouplingFieldDiscretization *it : fds)
    {
        ...
        if (!itc)
            throw INTERP_KERNEL::Exception(
                "MEDCouplingFieldDiscretization::aggregate : same field discretization expected for all input "
                "discretizations !"
            );
    }
    return fds[0]->clone();
