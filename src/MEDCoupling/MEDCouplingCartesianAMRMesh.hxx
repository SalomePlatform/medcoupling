...
{
   public:
    MEDCOUPLING_EXPORT virtual MEDCouplingCartesianAMRPatchGen *deepCopy(
        MEDCouplingCartesianAMRMeshGen *father
    ) const = 0;
...
class MEDCouplingCartesianAMRPatch : public MEDCouplingCartesianAMRPatchGen
{
   public:
    ...
    MEDCOUPLING_EXPORT void addPatch(
    ...
    MEDCOUPLING_EXPORT bool isInMyNeighborhoodDiffLev(
    ...
    MEDCOUPLING_EXPORT static bool IsInMyNeighborhood(
        mcIdType ghostLev,
    ...
    static void FindNeighborsOfSubPatchesOf(
        mcIdType ghostLev,
    ...
    static void UpdateNeighborsOfOneWithTwo(
        mcIdType ghostLev,
    ...
    static void UpdateNeighborsOfOneWithTwoExt(
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRPatch *p1,
        const MEDCouplingCartesianAMRPatch *p2,
        DataArrayDouble *dataOnP1,
    ...
    static void UpdateNeighborsOfOneWithTwoMixedLev(
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRPatch *p1,
        const MEDCouplingCartesianAMRPatch *p2,
        DataArrayDouble *dataOnP1,
   ...
   private:
    static void ComputeZonesOfTwoRelativeToOneDiffLev(
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRPatch *p1,
        const MEDCouplingCartesianAMRPatch *p2,
   ...
   private:
    ...
    static const MEDCouplingCartesianAMRMeshGen *FindCommonAncestor(
        const MEDCouplingCartesianAMRPatch *p1, const MEDCouplingCartesianAMRPatch *p2, mcIdType &lev
    );
    static std::vector<mcIdType> ComputeOffsetFromTwoToOne(
        const MEDCouplingCartesianAMRMeshGen *comAncestor,
        mcIdType lev,
        const MEDCouplingCartesianAMRPatch *p1,
        const MEDCouplingCartesianAMRPatch *p2
    );
    static void UpdateNeighborsOfOneWithTwoInternal(
        mcIdType ghostLev,
        const std::vector<mcIdType> &factors,
        const std::vector<std::pair<mcIdType, mcIdType> > &p1,
        const std::vector<std::pair<mcIdType, mcIdType> > &p2,
 ...
 * This class does \b NOT inherit from MEDCouplingMesh because this class overlaps image grid structured meshes to
 * perform adaptative mesh refinement. But this class aggregates MEDCouplingMesh instances !
 */
class MEDCouplingCartesianAMRMeshGen : public RefCountObject, public TimeLabel
{
   public:
    MEDCOUPLING_EXPORT virtual MEDCouplingCartesianAMRMeshGen *deepCopy(
        MEDCouplingCartesianAMRMeshGen *father
    ) const = 0;
    ...
    MEDCOUPLING_EXPORT virtual std::vector<std::pair<mcIdType, mcIdType> > positionRelativeToGodFather(
        std::vector<mcIdType> &st
    ) const = 0;
    ...
    MEDCOUPLING_EXPORT virtual std::vector<MEDCouplingCartesianAMRPatchGen *> retrieveGridsAt(
        mcIdType absoluteLev
    ) const;
    MEDCOUPLING_EXPORT void addPatch(
        const std::vector<std::pair<mcIdType, mcIdType> > &bottomLeftTopRight, const std::vector<mcIdType> &factors
    );
    ...
    MEDCOUPLING_EXPORT void createPatchesFromCriterion(
    ...
    MEDCOUPLING_EXPORT DataArrayDouble *createCellFieldOnPatch(
        mcIdType patchId, const DataArrayDouble *cellFieldOnThis
    ) const;
    // coarse to fine
    MEDCOUPLING_EXPORT void fillCellFieldOnPatch(
        mcIdType patchId,
        const DataArrayDouble *cellFieldOnThis,
        DataArrayDouble *cellFieldOnPatch,
        bool isConservative = true
    ) const;
    MEDCOUPLING_EXPORT void fillCellFieldOnPatchGhost(
        mcIdType patchId,
        const DataArrayDouble *cellFieldOnThis,
        DataArrayDouble *cellFieldOnPatch,
        mcIdType ghostLev,
    ...
    MEDCOUPLING_EXPORT void fillCellFieldOnPatchOnlyOnGhostZone(
    ...
    MEDCOUPLING_EXPORT void fillCellFieldOnPatchGhostAdv(
        mcIdType patchId,
        const DataArrayDouble *cellFieldOnThis,
        mcIdType ghostLev,
    ...
    // fine to fine
    MEDCOUPLING_EXPORT void fillCellFieldOnPatchOnlyGhostAdv(
        mcIdType patchId, mcIdType ghostLev, const std::vector<const DataArrayDouble *> &arrsOnPatches
    ) const;
    MEDCOUPLING_EXPORT void fillCellFieldOnPatchOnlyOnGhostZoneWith(
        mcIdType ghostLev,
    ...
    // fine to coarse
    MEDCOUPLING_EXPORT void fillCellFieldComingFromPatch(
        mcIdType patchId,
        const DataArrayDouble *cellFieldOnPatch,
        DataArrayDouble *cellFieldOnThis,
        bool isConservative = true
    ) const;
    MEDCOUPLING_EXPORT void fillCellFieldComingFromPatchGhost(
        mcIdType patchId,
        const DataArrayDouble *cellFieldOnPatch,
        DataArrayDouble *cellFieldOnThis,
        mcIdType ghostLev,
    ...
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildCellFieldOnRecurseWithoutOverlapWithoutGhost(
   ...
   protected:
    ...
    std::vector<const DataArrayDouble *> extractSubTreeFromGlobalFlatten(
   ...
   public:
    virtual void getPositionRelativeToInternal(
...
class MEDCouplingCartesianAMRMeshSub : public MEDCouplingCartesianAMRMeshGen
{
   public:
    ...
    MEDCOUPLING_EXPORT std::vector<std::pair<mcIdType, mcIdType> > positionRelativeToGodFather(
        std::vector<mcIdType> &st
    ) const;
...
{
   public:
    MEDCOUPLING_EXPORT static MEDCouplingCartesianAMRMesh *New(
        const std::string &meshName,
        int spaceDim,
        const mcIdType *nodeStrctStart,
        const mcIdType *nodeStrctStop,
    ...
    MEDCOUPLING_EXPORT void createPatchesFromCriterionML(
