...
class DataArrayDoubleCollection : public RefCountObject, public TimeLabel
{
   public:
    ...
    static void SynchronizeCoarseToFine(
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRMeshGen *fatherOfFineMesh,
        mcIdType patchId,
    ...
    static void SynchronizeFineEachOther(
        mcIdType patchId,
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRMeshGen *fatherOfFineMesh,
    ...
    static void SynchronizeCoarseToFineOnlyInGhostZone(
        mcIdType ghostLev,
        const MEDCouplingCartesianAMRMeshGen *fatherOfFineMesh,
        mcIdType patchId,
        const DataArrayDoubleCollection *coarse,
    ...
    static void SynchronizeGhostZoneOfOneUsingTwo(
        mcIdType ghostLev,
    ...
    void synchronizeMyGhostZoneUsing(
        mcIdType ghostLev,
    ...
    void synchronizeMyGhostZoneUsingExt(
        mcIdType ghostLev,
        const DataArrayDoubleCollection &other,
        const MEDCouplingCartesianAMRPatch *thisp,
        const MEDCouplingCartesianAMRPatch *otherp
...
{
   public:
    static MEDCouplingGridCollection *New(
    ...
    void synchronizeFineEachOther(
        mcIdType ghostLev,
        const std::vector<std::pair<const MEDCouplingCartesianAMRPatch *, const MEDCouplingCartesianAMRPatch *> > &ps
    ) const;
    void synchronizeFineEachOtherExt(
        mcIdType ghostLev,
        const std::vector<std::pair<const MEDCouplingCartesianAMRPatch *, const MEDCouplingCartesianAMRPatch *> > &ps
    ) const;
    std::vector<std::pair<const MEDCouplingCartesianAMRPatch *, const MEDCouplingCartesianAMRPatch *> > findNeighbors(
        mcIdType ghostLev
    ) const;
    static void SynchronizeCoarseToFineOnlyInGhostZone(
        mcIdType ghostLev, const MEDCouplingGridCollection *coarse, const MEDCouplingGridCollection *fine
    );
    void fillIfInTheProgenyOf(
...
class MEDCouplingDataForGodFather : public RefCountObject
{
   ...
   public:
    ...
    MEDCOUPLING_EXPORT virtual void synchronizeAllGhostZonesOfDirectChidrenOf(
        const MEDCouplingCartesianAMRMeshGen *mesh
    ) = 0;
...
{
   public:
    MEDCOUPLING_EXPORT static MEDCouplingAMRAttribute *New(
    ...
    MEDCOUPLING_EXPORT const DataArrayDouble *getFieldOn(
    ...
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildCellFieldOnWithGhost(
        MEDCouplingCartesianAMRMeshGen *mesh, const std::string &fieldName
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildCellFieldOnWithoutGhost(
        MEDCouplingCartesianAMRMeshGen *mesh, const std::string &fieldName
    ) const;
   ...
   private:
    ...
    std::vector<std::pair<const MEDCouplingCartesianAMRPatch *, const MEDCouplingCartesianAMRPatch *> >
        _mixed_lev_neighbors;
    std::vector<std::vector<std::pair<const MEDCouplingCartesianAMRPatch *, const MEDCouplingCartesianAMRPatch *> > >
        _cross_lev_neighbors;
};
}  // namespace MEDCoupling
