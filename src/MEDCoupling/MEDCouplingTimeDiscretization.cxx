...
MEDCouplingTimeDiscretization::New(TypeOfTimeDiscretization type)
{
    switch (type)
    {
...
bool
MEDCouplingTimeDiscretization::areCompatibleForMeld(const MEDCouplingTimeDiscretization *other) const
{
...
bool
MEDCouplingTimeDiscretization::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec, std::string &reason
) const
{
...
bool
MEDCouplingTimeDiscretization::isEqual(const MEDCouplingTimeDiscretization *other, double prec) const
{
    std::string reason;
...
bool
MEDCouplingTimeDiscretization::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec
) const
{
    std::string tmp;
...
bool
MEDCouplingTimeDiscretization::isBefore(const MEDCouplingTimeDiscretization *other) const
{
    int iteration, order;
...
bool
MEDCouplingTimeDiscretization::isStrictlyBefore(const MEDCouplingTimeDiscretization *other) const
{
    int iteration, order;
    double time1 = getEndTime(iteration, order) + _time_tolerance;
    double time2 = other->getStartTime(iteration, order) - other->getTimeTolerance();
...
MEDCouplingTimeDiscretization *
MEDCouplingTimeDiscretization::computeVectorFieldCyl(
    const DataArrayDouble *coords, const double center[3], const double vect[3]
) const
{
    ...
    for (std::size_t j = 0; j < arrays.size(); j++) arrays3[j] = arrays2[j];
...
MEDCouplingTimeDiscretization *
MEDCouplingTimeDiscretization::keepSelectedComponents(const std::vector<std::size_t> &compoIds) const
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::setSelectedComponents(
    const MEDCouplingTimeDiscretization *other, const std::vector<std::size_t> &compoIds
)
{
    ...
    for (std::size_t i = 0; i < arrays1.size(); i++)
    {
        if (arrays1[i] != 0 && arrays2[i] != 0)
            ...
            throw INTERP_KERNEL::Exception(
                "TimeDiscretization::setSelectedComponents : some time array in correspondence are not defined "
                "symmetrically !"
            );
    }
}
...
void
MEDCouplingTimeDiscretization::changeNbOfComponents(std::size_t newNbOfComp, double dftValue)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::sortPerTuple(bool asc)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    for (std::size_t j = 0; j < arrays.size(); j++)
...
void
MEDCouplingTimeDiscretization::setUniformValue(mcIdType nbOfTuple, int nbOfCompo, double value)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::setOrCreateUniformValueOnAllComponents(mcIdType nbOfTuple, double value)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::applyLin(double a, double b, int compoId)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    for (std::size_t j = 0; j < arrays.size(); j++)
...
void
MEDCouplingTimeDiscretization::applyLin(double a, double b)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    for (std::size_t j = 0; j < arrays.size(); j++)
...
void
MEDCouplingTimeDiscretization::applyFunc(int nbOfComp, FunctionToEvaluate func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::applyFunc(int nbOfComp, const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::applyFuncCompo(int nbOfComp, const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::applyFuncNamedCompo(
    int nbOfComp, const std::vector<std::string> &varsOrder, const std::string &func
)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
...
void
MEDCouplingTimeDiscretization::applyFunc(const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::applyFuncFast32(const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    for (std::size_t j = 0; j < arrays.size(); j++)
...
void
MEDCouplingTimeDiscretization::applyFuncFast64(const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    for (std::size_t j = 0; j < arrays.size(); j++)
...
void
MEDCouplingTimeDiscretization::fillFromAnalytic(const DataArrayDouble *loc, int nbOfComp, FunctionToEvaluate func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays2[j] = loc->applyFunc(nbOfComp, func);
    std::vector<DataArrayDouble *> arrays3(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays3[j] = arrays2[j];
    setArrays(arrays3, 0);
}
...
void
MEDCouplingTimeDiscretization::fillFromAnalytic(const DataArrayDouble *loc, int nbOfComp, const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
...
void
MEDCouplingTimeDiscretization::fillFromAnalyticCompo(const DataArrayDouble *loc, int nbOfComp, const std::string &func)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays2[j] = loc->applyFuncCompo(nbOfComp, func);
    std::vector<DataArrayDouble *> arrays3(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays3[j] = arrays2[j];
    setArrays(arrays3, 0);
}
...
void
MEDCouplingTimeDiscretization::fillFromAnalyticNamedCompo(
    const DataArrayDouble *loc, int nbOfComp, const std::vector<std::string> &varsOrder, const std::string &func
)
{
    std::vector<DataArrayDouble *> arrays;
    getArrays(arrays);
    std::vector<MCAuto<DataArrayDouble> > arrays2(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays2[j] = loc->applyFuncNamedCompo(nbOfComp, varsOrder, func);
    std::vector<DataArrayDouble *> arrays3(arrays.size());
    for (std::size_t j = 0; j < arrays.size(); j++) arrays3[j] = arrays2[j];
    setArrays(arrays3, 0);
}
...
bool
MEDCouplingTimeKeeper::isEqualIfNotWhy(const MEDCouplingTimeKeeper &other, double prec, std::string &reason) const
{
...
bool
MEDCouplingTimeKeeper::isEqual(const MEDCouplingTimeKeeper &other, double prec) const
{
    if (_iteration != other._iteration)
        return false;
    if (_order != other._order)
...
void
MEDCouplingTimeKeeper::copyFrom(const MEDCouplingTimeKeeper &other)
{
    _time = other._time;
...
void
MEDCouplingTimeKeeper::checkTimePresence(double time, double eps) const
{
...
MEDCouplingTimeDiscretizationInt32::MEDCouplingTimeDiscretizationInt32(
    const MEDCouplingTimeDiscretizationInt32 &other, bool deepCopy
)
    : MEDCouplingTimeDiscretizationSimple<Int32>(other, deepCopy)
{
}
...
MEDCouplingTimeDiscretizationInt32 *
MEDCouplingTimeDiscretizationInt32::New(TypeOfTimeDiscretization type)
{
    switch (type)
    {
...
bool
MEDCouplingTimeDiscretizationInt32::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<Int32> *other, Int32 prec, std::string &reason
) const
{
    if (prec != 0)
...
bool
MEDCouplingTimeDiscretizationInt32::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<Int32> *other, Int32 prec
) const
{
    if (prec != 0)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingTimeDiscretizationInt32::isEqualWithoutConsideringStr : only precision 0 is supported !"
        );
    const MEDCouplingTimeDiscretizationInt32 *otherC(dynamic_cast<const MEDCouplingTimeDiscretizationInt32 *>(other));
    if (!otherC)
        throw INTERP_KERNEL::Exception(
            "isEqualWithoutConsideringStr : other is not a MEDCouplingTimeDiscretizationInt !"
        );
    std::string tmp;
    if (!areStrictlyCompatible(other, tmp))
        return false;
...
MEDCouplingTimeDiscretizationInt64::MEDCouplingTimeDiscretizationInt64(
    const MEDCouplingTimeDiscretizationInt64 &other, bool deepCopy
)
    : MEDCouplingTimeDiscretizationSimple<Int64>(other, deepCopy)
{
}
...
MEDCouplingTimeDiscretizationInt64 *
MEDCouplingTimeDiscretizationInt64::New(TypeOfTimeDiscretization type)
{
    switch (type)
    {
...
bool
MEDCouplingTimeDiscretizationInt64::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<Int64> *other, Int64 prec, std::string &reason
) const
{
    if (prec != 0)
        throw INTERP_KERNEL::Exception("isEqualIfNotWhy : only precision equal to 0 supported for int !");
...
MEDCouplingTimeDiscretizationInt64::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<Int64> *other, Int64 prec
) const
{
    if (prec != 0)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingTimeDiscretizationInt64::isEqualWithoutConsideringStr : only precision 0 is supported !"
        );
    const MEDCouplingTimeDiscretizationInt64 *otherC(dynamic_cast<const MEDCouplingTimeDiscretizationInt64 *>(other));
    if (!otherC)
        throw INTERP_KERNEL::Exception(
...
MEDCouplingTimeDiscretizationFloat::MEDCouplingTimeDiscretizationFloat(
    const MEDCouplingTimeDiscretizationFloat &other, bool deepCopy
)
    : MEDCouplingTimeDiscretizationSimple<float>(other, deepCopy)
{
}
...
MEDCouplingTimeDiscretizationFloat *
MEDCouplingTimeDiscretizationFloat::New(TypeOfTimeDiscretization type)
{
    switch (type)
    {
...
bool
MEDCouplingTimeDiscretizationFloat::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<float> *other, float prec, std::string &reason
) const
{
    if (!other)
    {
...
bool
MEDCouplingTimeDiscretizationFloat::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<float> *other, float prec
) const
{
    if (prec != 0)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingTimeDiscretizationFloat::isEqualWithoutConsideringStr : only precision 0 is supported !"
        );
    const MEDCouplingTimeDiscretizationFloat *otherC(dynamic_cast<const MEDCouplingTimeDiscretizationFloat *>(other));
    if (!otherC)
        throw INTERP_KERNEL::Exception(
            "isEqualWithoutConsideringStr : other is not a MEDCouplingTimeDiscretizationFloat !"
        );
    std::string tmp;
    if (!areStrictlyCompatible(other, tmp))
        return false;
...
MEDCouplingNoTimeLabel::MEDCouplingNoTimeLabel(const MEDCouplingTimeDiscretization &other, bool deepCopy)
    : MEDCouplingTimeDiscretization(other, deepCopy)
{
}

std::string
MEDCouplingNoTimeLabel::getStringRepr() const
{
    std::ostringstream stream;
    stream << REPR;
...
void
MEDCouplingNoTimeLabel::synchronizeTimeWith(const MEDCouplingMesh *mesh)
{
    throw INTERP_KERNEL::Exception(
        "MEDCouplingNoTimeLabel::synchronizeTimeWith : impossible to synchronize time with a MEDCouplingMesh because "
        "the time discretization is incompatible with it !"
    );
}

bool
MEDCouplingNoTimeLabel::areCompatible(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
...
bool
MEDCouplingNoTimeLabel::areStrictlyCompatible(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, std::string &reason
) const
{
...
bool
MEDCouplingNoTimeLabel::areStrictlyCompatibleForMul(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
...
bool
MEDCouplingNoTimeLabel::areStrictlyCompatibleForDiv(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
...
bool
MEDCouplingNoTimeLabel::areCompatibleForMeld(const MEDCouplingTimeDiscretization *other) const
{
...
bool
MEDCouplingNoTimeLabel::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec, std::string &reason
) const
{
    const MEDCouplingNoTimeLabel *otherC(dynamic_cast<const MEDCouplingNoTimeLabel *>(other));
...
bool
MEDCouplingNoTimeLabel::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec
) const
{
    const MEDCouplingNoTimeLabel *otherC(dynamic_cast<const MEDCouplingNoTimeLabel *>(other));
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::aggregate(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC(dynamic_cast<const MEDCouplingNoTimeLabel *>(other));
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::aggregate(const std::vector<const MEDCouplingTimeDiscretization *> &other) const
{
    std::vector<const DataArrayDouble *> a(other.size());
    int i = 0;
    for (std::vector<const MEDCouplingTimeDiscretization *>::const_iterator it = other.begin(); it != other.end();
         it++, i++)
    {
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::meld(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::dot(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::crossProduct(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::max(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::min(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("NoTimeLabel::max on mismatched time discretization !");
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::add(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
void
MEDCouplingNoTimeLabel::addEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::substract(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
void
MEDCouplingNoTimeLabel::substractEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::multiply(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
void
MEDCouplingNoTimeLabel::multiplyEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::divide(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
void
MEDCouplingNoTimeLabel::divideEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::pow(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
void
MEDCouplingNoTimeLabel::powEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingNoTimeLabel *otherC = dynamic_cast<const MEDCouplingNoTimeLabel *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingNoTimeLabel::performCopyOrIncrRef(bool deepCopy) const
{
    return new MEDCouplingNoTimeLabel(*this, deepCopy);
}

void
MEDCouplingNoTimeLabel::checkTimePresence(double time) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

std::vector<const DataArrayDouble *>
MEDCouplingNoTimeLabel::getArraysForTime(double time) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::getValueForTime(double time, const std::vector<double> &vals, double *res) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

bool
MEDCouplingNoTimeLabel::isBefore(const MEDCouplingTimeDiscretization *other) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

bool
MEDCouplingNoTimeLabel::isStrictlyBefore(const MEDCouplingTimeDiscretization *other) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

double
MEDCouplingNoTimeLabel::getStartTime(int &iteration, int &order) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

double
MEDCouplingNoTimeLabel::getEndTime(int &iteration, int &order) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setStartIteration(int it)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setEndIteration(int it)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setStartOrder(int order)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setEndOrder(int order)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setStartTimeValue(double time)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setEndTimeValue(double time)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setStartTime(double time, int iteration, int order)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::setEndTime(double time, int iteration, int order)
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::getValueOnTime(mcIdType eltId, double time, double *value) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}

void
MEDCouplingNoTimeLabel::getValueOnDiscTime(mcIdType eltId, int iteration, int order, double *value) const
{
    throw INTERP_KERNEL::Exception(EXCEPTION_MSG);
}
 ...
 */
void
MEDCouplingNoTimeLabel::getTinySerializationIntInformation2(std::vector<mcIdType> &tinyInfo) const
{
    tinyInfo.clear();
}
 ...
 */
void
MEDCouplingNoTimeLabel::getTinySerializationDbleInformation2(std::vector<double> &tinyInfo) const
{
    tinyInfo.resize(1);
 ...
 */
void
MEDCouplingNoTimeLabel::finishUnserialization2(
    const std::vector<mcIdType> &tinyInfoI, const std::vector<double> &tinyInfoD
)
{
    _time_tolerance = tinyInfoD[0];
}

MEDCouplingWithTimeStep::MEDCouplingWithTimeStep(const MEDCouplingWithTimeStep &other, bool deepCopy)
    : MEDCouplingTimeDiscretization(other, deepCopy), _tk(other._tk)
{
}
...
std::string
MEDCouplingWithTimeStep::getStringRepr() const
{
    std::ostringstream stream;
    stream << REPR << " Time is defined by iteration=" << _tk.getIteration() << " order=" << _tk.getOrder()
           << " and time=" << _tk.getTimeValue() << ".";
    stream << "\nTime unit is : \"" << getTimeUnit() << "\"";
    return stream.str();
}

void
MEDCouplingWithTimeStep::synchronizeTimeWith(const MEDCouplingMesh *mesh)
{
    if (!mesh)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingWithTimeStep::synchronizeTimeWith : mesh instance is NULL ! Impossible to synchronize time !"
        );
    int it = -1, order = -1;
...
void
MEDCouplingWithTimeStep::getTinySerializationIntInformation(std::vector<mcIdType> &tinyInfo) const
{
...
void
MEDCouplingWithTimeStep::getTinySerializationDbleInformation(std::vector<double> &tinyInfo) const
{
...
void
MEDCouplingWithTimeStep::finishUnserialization(
 ...
 */
void
MEDCouplingWithTimeStep::getTinySerializationIntInformation2(std::vector<mcIdType> &tinyInfo) const
{
    tinyInfo.resize(2);
 ...
 */
void
MEDCouplingWithTimeStep::getTinySerializationDbleInformation2(std::vector<double> &tinyInfo) const
{
    tinyInfo.resize(2);
    tinyInfo[0] = _time_tolerance;
 ...
 */
void
MEDCouplingWithTimeStep::finishUnserialization2(
    const std::vector<mcIdType> &tinyInfoI, const std::vector<double> &tinyInfoD
)
{
...
bool
MEDCouplingWithTimeStep::areCompatible(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatible(other))
        return false;
...
bool
MEDCouplingWithTimeStep::areStrictlyCompatible(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, std::string &reason
) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatible(other, reason))
...
bool
MEDCouplingWithTimeStep::areStrictlyCompatibleForMul(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForMul(other))
        return false;
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
...
bool
MEDCouplingWithTimeStep::areStrictlyCompatibleForDiv(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForDiv(other))
        return false;
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
...
bool
MEDCouplingWithTimeStep::areCompatibleForMeld(const MEDCouplingTimeDiscretization *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatibleForMeld(other))
        return false;
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
...
bool
MEDCouplingWithTimeStep::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec, std::string &reason
) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
...
bool
MEDCouplingWithTimeStep::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec
) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
...
void
MEDCouplingWithTimeStep::copyTinyAttrFrom(const MEDCouplingTimeDiscretizationTemplate<double> &other)
{
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::aggregate(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::aggregate(const std::vector<const MEDCouplingTimeDiscretization *> &other) const
{
    std::vector<const DataArrayDouble *> a(other.size());
    int i = 0;
    for (std::vector<const MEDCouplingTimeDiscretization *>::const_iterator it = other.begin(); it != other.end();
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::meld(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::dot(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::crossProduct(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::max(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::min(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::add(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
void
MEDCouplingWithTimeStep::addEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::substract(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
void
MEDCouplingWithTimeStep::substractEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::multiply(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
void
MEDCouplingWithTimeStep::multiplyEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::divide(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
void
MEDCouplingWithTimeStep::divideEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::pow(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
void
MEDCouplingWithTimeStep::powEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingWithTimeStep *otherC = dynamic_cast<const MEDCouplingWithTimeStep *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingWithTimeStep::performCopyOrIncrRef(bool deepCopy) const
{
    return new MEDCouplingWithTimeStep(*this, deepCopy);
}

void
MEDCouplingWithTimeStep::checkNoTimePresence() const
{
    throw INTERP_KERNEL::Exception("No time specified on a field defined on one time");
}

void
MEDCouplingWithTimeStep::checkTimePresence(double time) const
{
    _tk.checkTimePresence(time, _time_tolerance);
}

std::vector<const DataArrayDouble *>
MEDCouplingWithTimeStep::getArraysForTime(double time) const
{
...
void
MEDCouplingWithTimeStep::getValueForTime(double time, const std::vector<double> &vals, double *res) const
{
    std::copy(vals.begin(), vals.end(), res);
}

void
MEDCouplingWithTimeStep::getValueOnTime(mcIdType eltId, double time, double *value) const
{
    if (std::fabs(time - _tk.getTimeValue()) <= _time_tolerance)
        if (_array)
...
void
MEDCouplingWithTimeStep::getValueOnDiscTime(mcIdType eltId, int iteration, int order, double *value) const
{
...
void
MEDCouplingConstOnTimeInterval::copyTinyAttrFrom(const MEDCouplingTimeDiscretizationTemplate<double> &other)
{
    MEDCouplingTimeDiscretization::copyTinyAttrFrom(other);
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(&other);
    if (!otherC)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingConstOnTimeInterval::copyTinyAttrFrom : mismatch of time discretization !"
        );
...
void
MEDCouplingConstOnTimeInterval::getTinySerializationIntInformation(std::vector<mcIdType> &tinyInfo) const
{
    MEDCouplingTimeDiscretization::getTinySerializationIntInformation(tinyInfo);
...
void
MEDCouplingConstOnTimeInterval::getTinySerializationDbleInformation(std::vector<double> &tinyInfo) const
{
    MEDCouplingTimeDiscretization::getTinySerializationDbleInformation(tinyInfo);
...
void
MEDCouplingConstOnTimeInterval::finishUnserialization(
    const std::vector<mcIdType> &tinyInfoI,
    const std::vector<double> &tinyInfoD,
    const std::vector<std::string> &tinyInfoS
)
 ...
 */
void
MEDCouplingConstOnTimeInterval::getTinySerializationIntInformation2(std::vector<mcIdType> &tinyInfo) const
{
    tinyInfo.resize(4);
 ...
 */
void
MEDCouplingConstOnTimeInterval::getTinySerializationDbleInformation2(std::vector<double> &tinyInfo) const
{
    tinyInfo.resize(3);
    tinyInfo[0] = _time_tolerance;
 ...
 */
void
MEDCouplingConstOnTimeInterval::finishUnserialization2(
    const std::vector<mcIdType> &tinyInfoI, const std::vector<double> &tinyInfoD
)
{
...
MEDCouplingConstOnTimeInterval::MEDCouplingConstOnTimeInterval(
    const MEDCouplingConstOnTimeInterval &other, bool deepCopy
)
...
std::string
MEDCouplingConstOnTimeInterval::getStringRepr() const
{
    std::ostringstream stream;
    stream << REPR << " Time interval is defined by :\niteration_start=" << _start.getIteration()
           << " order_start=" << _start.getOrder() << " and time_start=" << _start.getTimeValue() << "\n";
    stream << "iteration_end=" << _end.getIteration() << " order_end=" << _end.getOrder()
           << " and end_time=" << _end.getTimeValue() << "\n";
    stream << "\nTime unit is : \"" << getTimeUnit() << "\"";
    return stream.str();
}

void
MEDCouplingConstOnTimeInterval::synchronizeTimeWith(const MEDCouplingMesh *mesh)
{
    if (!mesh)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingWithTimeStep::synchronizeTimeWith : mesh instance is NULL ! Impossible to synchronize time !"
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::performCopyOrIncrRef(bool deepCopy) const
{
    return new MEDCouplingConstOnTimeInterval(*this, deepCopy);
}

std::vector<const DataArrayDouble *>
MEDCouplingConstOnTimeInterval::getArraysForTime(double time) const
{
...
void
MEDCouplingConstOnTimeInterval::getValueForTime(double time, const std::vector<double> &vals, double *res) const
{
    std::copy(vals.begin(), vals.end(), res);
}

bool
MEDCouplingConstOnTimeInterval::areCompatible(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatible(other))
        return false;
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
...
bool
MEDCouplingConstOnTimeInterval::areStrictlyCompatible(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, std::string &reason
) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatible(other, reason))
    ...
    if (!ret)
        reason.insert(
            0, "time discretization of this is CONST_ON_TIME_INTERVAL, other has a different time discretization."
        );
    return ret;
}
...
MEDCouplingConstOnTimeInterval::areStrictlyCompatibleForMul(
    const MEDCouplingTimeDiscretizationTemplate<double> *other
) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForMul(other))
        return false;
...
bool
MEDCouplingConstOnTimeInterval::areStrictlyCompatibleForDiv(
    const MEDCouplingTimeDiscretizationTemplate<double> *other
) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForDiv(other))
...
bool
MEDCouplingConstOnTimeInterval::areCompatibleForMeld(const MEDCouplingTimeDiscretization *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatibleForMeld(other))
        return false;
    const MEDCouplingConstOnTimeInterval *otherC(dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other));
...
bool
MEDCouplingConstOnTimeInterval::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec, std::string &reason
) const
{
    const MEDCouplingConstOnTimeInterval *otherC(dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other));
...
void
MEDCouplingConstOnTimeInterval::getValueOnTime(mcIdType eltId, double time, double *value) const
{
    if (time > _start.getTimeValue() - _time_tolerance && time < _end.getTimeValue() + _time_tolerance)
        if (_array)
            _array->getTuple(eltId, value);
...
void
MEDCouplingConstOnTimeInterval::getValueOnDiscTime(mcIdType eltId, int iteration, int order, double *value) const
{
...
void
MEDCouplingConstOnTimeInterval::checkNoTimePresence() const
{
    throw INTERP_KERNEL::Exception("No time specified on a field defined as constant on one time interval");
}

void
MEDCouplingConstOnTimeInterval::checkTimePresence(double time) const
{
    if (time < _start.getTimeValue() - _time_tolerance || time > _end.getTimeValue() + _time_tolerance)
    {
        std::ostringstream stream;
        stream << "The field is defined between times " << _start.getTimeValue() << " and " << _end.getTimeValue()
               << " worderh tolerance ";
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::aggregate(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::aggregate(const std::vector<const MEDCouplingTimeDiscretization *> &other) const
{
    std::vector<const DataArrayDouble *> a(other.size());
    int i = 0;
    for (std::vector<const MEDCouplingTimeDiscretization *>::const_iterator it = other.begin(); it != other.end();
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::meld(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::dot(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::crossProduct(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::max(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::min(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::add(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
void
MEDCouplingConstOnTimeInterval::addEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::substract(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
void
MEDCouplingConstOnTimeInterval::substractEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::multiply(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
void
MEDCouplingConstOnTimeInterval::multiplyEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::divide(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("divide on mismatched time discretization !");
...
void
MEDCouplingConstOnTimeInterval::divideEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingConstOnTimeInterval::pow(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("pow on mismatched time discretization !");
...
void
MEDCouplingConstOnTimeInterval::powEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingConstOnTimeInterval *otherC = dynamic_cast<const MEDCouplingConstOnTimeInterval *>(other);
    if (!otherC)
...
MEDCouplingTwoTimeSteps::MEDCouplingTwoTimeSteps(const MEDCouplingTwoTimeSteps &other, bool deepCopy)
    : MEDCouplingTimeDiscretization(other, deepCopy), _start(other._start), _end(other._end)
{
    if (other._end_array)
...
void
MEDCouplingTwoTimeSteps::updateTime() const
{
...
void
MEDCouplingTwoTimeSteps::synchronizeTimeWith(const MEDCouplingMesh *mesh)
{
    if (!mesh)
        throw INTERP_KERNEL::Exception(
            "MEDCouplingTwoTimeSteps::synchronizeTimeWith : mesh instance is NULL ! Impossible to synchronize time !"
        );
    int it = -1, order = -1;
    double val = mesh->getTime(it, order);
    _start.setAllInfo(val, it, order);
...
std::size_t
MEDCouplingTwoTimeSteps::getHeapMemorySizeWithoutChildren() const
{
    return MEDCouplingTimeDiscretization::getHeapMemorySizeWithoutChildren();
}

std::vector<const BigMemoryObject *>
MEDCouplingTwoTimeSteps::getDirectChildrenWithNull() const
{
...
void
MEDCouplingTwoTimeSteps::copyTinyAttrFrom(const MEDCouplingTimeDiscretizationTemplate<double> &other)
{
    MEDCouplingTimeDiscretization::copyTinyAttrFrom(other);
...
void
MEDCouplingTwoTimeSteps::copyTinyStringsFrom(const MEDCouplingTimeDiscretizationTemplate<double> &other)
{
    MEDCouplingTimeDiscretization::copyTinyStringsFrom(other);
    const MEDCouplingTwoTimeSteps *otherC = dynamic_cast<const MEDCouplingTwoTimeSteps *>(&other);
    if (!otherC)
        throw INTERP_KERNEL::Exception(
            "Trying to operate copyTinyStringsFrom on different field type (two times//one time) !"
        );
...
MEDCouplingTwoTimeSteps::getEndArray() const
{
    return _end_array;
}

DataArrayDouble *
MEDCouplingTwoTimeSteps::getEndArray()
{
    return _end_array;
}

void
MEDCouplingTwoTimeSteps::checkConsistencyLight() const
{
...
bool
MEDCouplingTwoTimeSteps::isEqualIfNotWhy(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec, std::string &reason
) const
{
    std::ostringstream oss;
...
bool
MEDCouplingTwoTimeSteps::isEqualWithoutConsideringStr(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, double prec
) const
{
    const MEDCouplingTwoTimeSteps *otherC(dynamic_cast<const MEDCouplingTwoTimeSteps *>(other));
...
void
MEDCouplingTwoTimeSteps::checkNoTimePresence() const
{
    throw INTERP_KERNEL::Exception("The field presents a time to be specified in every access !");
}

void
MEDCouplingTwoTimeSteps::checkTimePresence(double time) const
{
    if (time < _start.getTimeValue() - _time_tolerance || time > _end.getTimeValue() + _time_tolerance)
    {
        std::ostringstream stream;
...
void
MEDCouplingTwoTimeSteps::getArrays(std::vector<DataArrayDouble *> &arrays) const
{
    arrays.resize(2);
    arrays[0] = _array;
    arrays[1] = _end_array;
...
void
MEDCouplingTwoTimeSteps::setEndArray(DataArrayDouble *array, TimeLabel *owner)
{
    if (array != _end_array)
    {
        if (_end_array)
...
void
MEDCouplingTwoTimeSteps::getTinySerializationIntInformation(std::vector<mcIdType> &tinyInfo) const
{
    MEDCouplingTimeDiscretization::getTinySerializationIntInformation(tinyInfo);
    tinyInfo.push_back(_start.getIteration());
    tinyInfo.push_back(_start.getOrder());
...
void
MEDCouplingTwoTimeSteps::getTinySerializationDbleInformation(std::vector<double> &tinyInfo) const
{
    MEDCouplingTimeDiscretization::getTinySerializationDbleInformation(tinyInfo);
    tinyInfo.push_back(_start.getTimeValue());
    tinyInfo.push_back(_end.getTimeValue());
...
void
MEDCouplingTwoTimeSteps::getTinySerializationStrInformation(std::vector<std::string> &tinyInfo) const
{
    std::size_t nbOfCompo = _array->getNumberOfComponents();
    for (std::size_t i = 0; i < nbOfCompo; i++) tinyInfo.push_back(_array->getInfoOnComponent(i));
    for (std::size_t i = 0; i < nbOfCompo; i++) tinyInfo.push_back(_end_array->getInfoOnComponent(i));
}

void
MEDCouplingTwoTimeSteps::resizeForUnserialization(
    const std::vector<mcIdType> &tinyInfoI, std::vector<DataArrayDouble *> &arrays
)
{
    arrays.resize(2);
    if (_array != 0)
...
void
MEDCouplingTwoTimeSteps::checkForUnserialization(
    const std::vector<mcIdType> &tinyInfoI, const std::vector<DataArrayDouble *> &arrays
)
{
    static const char MSG[] =
        "MEDCouplingTimeDiscretization::checkForUnserialization : arrays in input is expected to have size two !";
    if (arrays.size() != 2)
...
void
MEDCouplingTwoTimeSteps::finishUnserialization(
    const std::vector<mcIdType> &tinyInfoI,
    const std::vector<double> &tinyInfoD,
    const std::vector<std::string> &tinyInfoS
)
 ...
 */
void
MEDCouplingTwoTimeSteps::getTinySerializationIntInformation2(std::vector<mcIdType> &tinyInfo) const
{
    tinyInfo.resize(4);
    tinyInfo[0] = _start.getIteration();
    tinyInfo[1] = _start.getOrder();
 ...
 */
void
MEDCouplingTwoTimeSteps::getTinySerializationDbleInformation2(std::vector<double> &tinyInfo) const
{
    tinyInfo.resize(3);
    tinyInfo[0] = _time_tolerance;
    tinyInfo[1] = _start.getTimeValue();
 ...
 */
void
MEDCouplingTwoTimeSteps::finishUnserialization2(
    const std::vector<mcIdType> &tinyInfoI, const std::vector<double> &tinyInfoD
)
{
    _start.setIteration(FromIdType<int>(tinyInfoI[0]));
...
std::vector<const DataArrayDouble *>
MEDCouplingTwoTimeSteps::getArraysForTime(double time) const
{
    if (time > _start.getTimeValue() - _time_tolerance && time < _end.getTimeValue() + _time_tolerance)
    {
...
void
MEDCouplingTwoTimeSteps::setArrays(const std::vector<DataArrayDouble *> &arrays, TimeLabel *owner)
{
    if (arrays.size() != 2)
...
MEDCouplingLinearTime::MEDCouplingLinearTime(const MEDCouplingLinearTime &other, bool deepCopy)
    : MEDCouplingTwoTimeSteps(other, deepCopy)
{
}
...
std::string
MEDCouplingLinearTime::getStringRepr() const
{
    std::ostringstream stream;
    stream << REPR << " Time interval is defined by :\niteration_start=" << _start.getIteration()
           << " order_start=" << _start.getOrder() << " and time_start=" << _start.getTimeValue() << "\n";
...
void
MEDCouplingLinearTime::checkConsistencyLight() const
{
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::performCopyOrIncrRef(bool deepCopy) const
{
    return new MEDCouplingLinearTime(*this, deepCopy);
}

bool
MEDCouplingLinearTime::areCompatible(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatible(other))
        return false;
...
bool
MEDCouplingLinearTime::areStrictlyCompatible(
    const MEDCouplingTimeDiscretizationTemplate<double> *other, std::string &reason
) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatible(other, reason))
...
bool
MEDCouplingLinearTime::areStrictlyCompatibleForMul(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForMul(other))
        return false;
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
...
bool
MEDCouplingLinearTime::areStrictlyCompatibleForDiv(const MEDCouplingTimeDiscretizationTemplate<double> *other) const
{
    if (!MEDCouplingTimeDiscretization::areStrictlyCompatibleForDiv(other))
        return false;
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
...
bool
MEDCouplingLinearTime::areCompatibleForMeld(const MEDCouplingTimeDiscretization *other) const
{
    if (!MEDCouplingTimeDiscretization::areCompatibleForMeld(other))
        return false;
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
...
/*!
 * vals is expected to be of size
 * 2*_array->getNumberOfTuples()==_array->getNumberOfTuples()+_end_array->getNumberOfTuples()
 */
void
MEDCouplingLinearTime::getValueForTime(double time, const std::vector<double> &vals, double *res) const
{
    double alpha = (_end.getTimeValue() - time) / (_end.getTimeValue() - _start.getTimeValue());
    std::size_t nbComp = vals.size() / 2;
    std::transform(
        vals.begin(), vals.begin() + nbComp, res, std::bind(std::multiplies<double>(), std::placeholders::_1, alpha)
    );
    ...
    std::transform(
        ...
        vals.end(),
        tmp.begin(),
        std::bind(std::multiplies<double>(), std::placeholders::_1, 1 - alpha)
    );
    std::transform(tmp.begin(), tmp.end(), res, res, std::plus<double>());
}

void
MEDCouplingLinearTime::getValueOnTime(mcIdType eltId, double time, double *value) const
{
    double alpha = (_end.getTimeValue() - time) / (_end.getTimeValue() - _start.getTimeValue());
    if (_array)
        _array->getTuple(eltId, value);
    ...
    std::transform(
        tmp.begin(), tmp.end(), tmp.begin(), std::bind(std::multiplies<double>(), std::placeholders::_1, 1 - alpha)
    );
    std::transform(tmp.begin(), tmp.end(), value, value, std::plus<double>());
}

void
MEDCouplingLinearTime::getValueOnDiscTime(mcIdType eltId, int iteration, int order, double *value) const
{
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::aggregate(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::aggregate(const std::vector<const MEDCouplingTimeDiscretization *> &other) const
{
    std::vector<const DataArrayDouble *> a(other.size());
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::meld(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::Meld(getArray(), other->getArray())),
        arr2(DataArrayDouble::Meld(getEndArray(), other->getEndArray()));
    MEDCouplingLinearTime *ret(new MEDCouplingLinearTime);
    ret->setTimeTolerance(getTimeTolerance());
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::dot(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::Dot(getArray(), other->getArray())),
        arr2(DataArrayDouble::Dot(getEndArray(), other->getEndArray()));
    MEDCouplingLinearTime *ret(new MEDCouplingLinearTime);
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
    return ret;
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::crossProduct(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::CrossProduct(getArray(), other->getArray())),
        arr2(DataArrayDouble::CrossProduct(getEndArray(), other->getEndArray()));
    MEDCouplingLinearTime *ret(new MEDCouplingLinearTime);
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
    return ret;
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::max(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::Max(getArray(), other->getArray())),
        arr2(DataArrayDouble::Max(getEndArray(), other->getEndArray()));
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
    return ret;
}
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::min(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::Min(getArray(), other->getArray())),
        arr2(DataArrayDouble::Min(getEndArray(), other->getEndArray()));
    MEDCouplingLinearTime *ret(new MEDCouplingLinearTime);
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
    return ret;
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::add(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
    ...
    MCAuto<DataArrayDouble> arr1(DataArrayDouble::Add(getArray(), other->getArray())),
        arr2(DataArrayDouble::Add(getEndArray(), other->getEndArray()));
    MEDCouplingLinearTime *ret(new MEDCouplingLinearTime);
    ret->setArray(arr1, 0);
    ret->setEndArray(arr2, 0);
    return ret;
...
void
MEDCouplingLinearTime::addEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::substract(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
void
MEDCouplingLinearTime::substractEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("LinearTime::addEqual on mismatched time discretization !");
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::multiply(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
void
MEDCouplingLinearTime::multiplyEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("LinearTime::addEqual on mismatched time discretization !");
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::divide(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
void
MEDCouplingLinearTime::divideEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("LinearTime::addEqual on mismatched time discretization !");
...
MEDCouplingTimeDiscretization *
MEDCouplingLinearTime::pow(const MEDCouplingTimeDiscretization *other) const
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
...
void
MEDCouplingLinearTime::powEqual(const MEDCouplingTimeDiscretization *other)
{
    const MEDCouplingLinearTime *otherC = dynamic_cast<const MEDCouplingLinearTime *>(other);
    if (!otherC)
        throw INTERP_KERNEL::Exception("LinearTime::addEqual on mismatched time discretization !");
