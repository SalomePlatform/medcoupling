...
class MEDCouplingPointSet : public MEDCouplingMesh
{
   ...
   public:
    ...
    MEDCOUPLING_EXPORT void checkDeepEquivalWith(
        const MEDCouplingMesh *other, int cellCompPol, double prec, DataArrayIdType *&cellCor, DataArrayIdType *&nodeCor
    ) const;
    MEDCOUPLING_EXPORT void checkDeepEquivalOnSameNodesWith(
        const MEDCouplingMesh *other, int cellCompPol, double prec, DataArrayIdType *&cellCor
    ) const;
    MEDCOUPLING_EXPORT bool areCoordsEqualIfNotWhy(
        const MEDCouplingPointSet &other, double prec, std::string &reason
    ) const;
    ...
    MEDCOUPLING_EXPORT virtual DataArrayIdType *mergeNodes(
        double precision, bool &areNodesMerged, mcIdType &newNbOfNodes
    );
    MEDCOUPLING_EXPORT virtual DataArrayIdType *mergeNodesCenter(
        double precision, bool &areNodesMerged, mcIdType &newNbOfNodes
    );
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *mergeMyselfWithOnSameCoords(
        const MEDCouplingPointSet *other
    ) const = 0;
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *buildPermArrayForMergeNode(
    ...
    MEDCOUPLING_EXPORT void duplicateNodesInCoords(
        const mcIdType *nodeIdsToDuplicateBg, const mcIdType *nodeIdsToDuplicateEnd
    );
    MEDCOUPLING_EXPORT virtual void tryToShareSameCoordsPermute(const MEDCouplingPointSet &other, double epsilon);
    MEDCOUPLING_EXPORT void findNodesOnPlane(
        const double *pt, const double *vec, double eps, std::vector<mcIdType> &nodes
    ) const;
    MEDCOUPLING_EXPORT void findNodesOnLine(
        const double *pt, const double *vec, double eps, std::vector<mcIdType> &nodes
    ) const;
    MEDCOUPLING_EXPORT static DataArrayDouble *MergeNodesArray(
        const MEDCouplingPointSet *m1, const MEDCouplingPointSet *m2
    );
    ...
    MEDCOUPLING_EXPORT static DataArrayIdType *ComputeNbOfInteractionsWithSrcCells(
    ...
    MEDCOUPLING_EXPORT MEDCouplingMesh *buildPartAndReduceNodes(
        const mcIdType *start, const mcIdType *end, DataArrayIdType *&arr
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingMesh *buildPartRange(
        mcIdType beginCellIds, mcIdType endCellIds, mcIdType stepCellIds
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingMesh *buildPartRangeAndReduceNodes(
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *getCellIdsFullyIncludedInNodeIds(
        const mcIdType *partBg, const mcIdType *partEnd
    ) const;
    MEDCOUPLING_EXPORT DataArrayIdType *getCellIdsLyingOnNodes(
        const mcIdType *begin, const mcIdType *end, bool fullyIn
    ) const;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildPartOfMySelf(
        const mcIdType *start, const mcIdType *end, bool keepCoords = true
    ) const;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildPartOfMySelfSlice(
        mcIdType start, mcIdType end, mcIdType step, bool keepCoords = true
    ) const;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildPartOfMySelfKeepCoords(
        const mcIdType *begin, const mcIdType *end
    ) const = 0;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildPartOfMySelfKeepCoordsSlice(
        mcIdType start, mcIdType end, mcIdType step
    ) const = 0;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildPartOfMySelfNode(
        const mcIdType *start, const mcIdType *end, bool fullyIn
    ) const;
    MEDCOUPLING_EXPORT virtual MEDCouplingPointSet *buildFacePartOfMySelfNode(
        const mcIdType *start, const mcIdType *end, bool fullyIn
    ) const = 0;
    ...
    MEDCOUPLING_EXPORT virtual void fillCellIdsToKeepFromNodeIds(
    ...
    MEDCOUPLING_EXPORT virtual void renumberNodesInConn(
        const INTERP_KERNEL::HashMap<mcIdType, mcIdType> &newNodeNumbersO2N
    ) = 0;
    ...
    MEDCOUPLING_EXPORT virtual DataArrayIdType *getCellsInBoundingBox(
    ...
    // tools
   public:
    MEDCOUPLING_EXPORT bool areCellsFrom2MeshEqual(
        const MEDCouplingPointSet *other, mcIdType cellId, double prec
    ) const;
   ...
   protected:
    ...
    MEDCOUPLING_EXPORT void project2DCellOnXY(
