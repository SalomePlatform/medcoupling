...
class MEDCouplingUMesh : public MEDCouplingPointSet
{
   public:
    ...
    MEDCOUPLING_EXPORT void insertNextCell(
        INTERP_KERNEL::NormalizedCellType type, mcIdType size, const mcIdType *nodalConnOfCell
    );
    ...
    MEDCOUPLING_EXPORT std::set<INTERP_KERNEL::NormalizedCellType> getTypesOfPart(
        const mcIdType *begin, const mcIdType *end
    ) const;
    MEDCOUPLING_EXPORT void setConnectivity(
        DataArrayIdType *conn, DataArrayIdType *connIndex, bool isComputingTypes = true
    );
    ...
    MEDCOUPLING_EXPORT void resizeForUnserialization(
    ...
    MEDCOUPLING_EXPORT void unserialization(
    ...
    MEDCOUPLING_EXPORT void writeVTKLL(
        std::ostream &ofs, const std::string &cellData, const std::string &pointData, DataArrayByte *byteData
    ) const;
    MEDCOUPLING_EXPORT void reprQuickOverview(std::ostream &stream) const;
    // tools
    MEDCOUPLING_EXPORT static int AreCellsEqual(
        const mcIdType *conn, const mcIdType *connI, mcIdType cell1, mcIdType cell2, int compType
    );
    MEDCOUPLING_EXPORT static int AreCellsEqualPolicy0(
        const mcIdType *conn, const mcIdType *connI, mcIdType cell1, mcIdType cell2
    );
    MEDCOUPLING_EXPORT static int AreCellsEqualPolicy1(
        const mcIdType *conn, const mcIdType *connI, mcIdType cell1, mcIdType cell2
    );
    MEDCOUPLING_EXPORT static int AreCellsEqualPolicy2(
        const mcIdType *conn, const mcIdType *connI, mcIdType cell1, mcIdType cell2
    );
    MEDCOUPLING_EXPORT static int AreCellsEqualPolicy2NoType(
        const mcIdType *conn, const mcIdType *connI, mcIdType cell1, mcIdType cell2
    );
    ...
    MEDCOUPLING_EXPORT bool areCellsIncludedIn(
        const MEDCouplingUMesh *other, int compType, DataArrayIdType *&arr
    ) const;
    ...
    MEDCOUPLING_EXPORT MCAuto<MEDCouplingUMesh> explodeIntoEdges(
    ...
    MEDCOUPLING_EXPORT MCAuto<MEDCouplingUMesh> explodeMeshTo(
    ...
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildDescendingConnectivity(
        DataArrayIdType *desc, DataArrayIdType *descIndx, DataArrayIdType *revDesc, DataArrayIdType *revDescIndx
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildDescendingConnectivity2(
        DataArrayIdType *desc, DataArrayIdType *descIndx, DataArrayIdType *revDesc, DataArrayIdType *revDescIndx
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingUMesh *explodeMeshIntoMicroEdges(
        DataArrayIdType *desc, DataArrayIdType *descIndx, DataArrayIdType *revDesc, DataArrayIdType *revDescIndx
    ) const;
    MEDCOUPLING_EXPORT void computeNeighborsOfCells(DataArrayIdType *&neighbors, DataArrayIdType *&neighborsIdx) const;
    MEDCOUPLING_EXPORT void computeCellNeighborhoodFromNodesOne(
    ...
    MEDCOUPLING_EXPORT static void ComputeNeighborsOfCellsAdv(
        const DataArrayIdType *desc,
        const DataArrayIdType *descI,
        const DataArrayIdType *revDesc,
        const DataArrayIdType *revDescI,
    ...
    MEDCOUPLING_EXPORT void computeEnlargedNeighborsOfNodes(
    ...
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildPartOfMySelf(
        const mcIdType *begin, const mcIdType *end, bool keepCoords = true
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildPartOfMySelfSlice(
        mcIdType start, mcIdType end, mcIdType step, bool keepCoords = true
    ) const;
    MEDCOUPLING_EXPORT void setPartOfMySelf(
        const mcIdType *cellIdsBg, const mcIdType *cellIdsEnd, const MEDCouplingUMesh &otherOnSameCoordsThanThis
    );
    MEDCOUPLING_EXPORT void setPartOfMySelfSlice(
        mcIdType start, mcIdType end, mcIdType step, const MEDCouplingUMesh &otherOnSameCoordsThanThis
    );
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildFacePartOfMySelfNode(
        const mcIdType *begin, const mcIdType *end, bool fullyIn
    ) const;
    ...
    MEDCOUPLING_EXPORT void findCellIdsLyingOn(
    ...
    MEDCOUPLING_EXPORT void findCellsToRenumber(
    ...
    MEDCOUPLING_EXPORT void duplicateNodesInConn(
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *getCellsInBoundingBox(
        const INTERP_KERNEL::DirectedBoundingBox &bbox, double eps
    );
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *getMeasureField(bool isAbs) const;
    MEDCOUPLING_EXPORT DataArrayDouble *getPartMeasureField(
        bool isAbs, const mcIdType *begin, const mcIdType *end
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *getMeasureFieldOnNode(bool isAbs) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildOrthogonalField() const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildPartOrthogonalField(
        const mcIdType *begin, const mcIdType *end
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingFieldDouble *buildDirectionVectorField() const;
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildSlice3D(
        const double *origin, const double *vec, double eps, DataArrayIdType *&cellIds
    ) const;
    MEDCOUPLING_EXPORT MEDCouplingUMesh *buildSlice3DSurf(
        const double *origin, const double *vec, double eps, DataArrayIdType *&cellIds
    ) const;
    MEDCOUPLING_EXPORT MCAuto<MEDCouplingUMesh> clipSingle3DCellByPlane(
        const double origin[3], const double vec[3], double eps
    ) const;
    MEDCOUPLING_EXPORT DataArrayIdType *getCellIdsCrossingPlane(
        const double *origin, const double *vec, double eps
    ) const;
    ...
    MEDCOUPLING_EXPORT void getCellsContainingPoints(
        const double *pos,
        mcIdType nbOfPoints,
        double eps,
    ...
    MEDCOUPLING_EXPORT void getCellsContainingPointsLinearPartOnlyOnNonDynType(
        const double *pos,
        mcIdType nbOfPoints,
        double eps,
        MCAuto<DataArrayIdType> &elts,
    ...
    MEDCOUPLING_EXPORT MEDCoupling1SGTUMesh *tetrahedrize(
        int policy, DataArrayIdType *&n2oCells, mcIdType &nbOfAdditionalPoints
    ) const;
    ...
    MEDCOUPLING_EXPORT void are2DCellsNotCorrectlyOriented(
        const double *vec, bool polyOnly, std::vector<mcIdType> &cells
    ) const;
    ...
    MEDCOUPLING_EXPORT void attractSeg3MidPtsAroundNodes(
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *checkTypeConsistencyAndContig(
        const std::vector<mcIdType> &code, const std::vector<const DataArrayIdType *> &idsPerType
    ) const;
    MEDCOUPLING_EXPORT void splitProfilePerType(
    ...
    MEDCOUPLING_EXPORT MEDCouplingUMesh *emulateMEDMEMBDC(
    ...
    MEDCOUPLING_EXPORT bool checkConsecutiveCellTypesAndOrder(
        const INTERP_KERNEL::NormalizedCellType *orderBg, const INTERP_KERNEL::NormalizedCellType *orderEnd
    ) const;
    MEDCOUPLING_EXPORT DataArrayIdType *getLevArrPerCellTypes(
    ...
    MEDCOUPLING_EXPORT DataArrayIdType *getRenumArrForConsecutiveCellTypesSpec(
        const INTERP_KERNEL::NormalizedCellType *orderBg, const INTERP_KERNEL::NormalizedCellType *orderEnd
    ) const;
    ...
    MEDCOUPLING_EXPORT void convertNodalConnectivityToDynamicGeoTypeMesh(
        DataArrayIdType *&nodalConn, DataArrayIdType *&nodalConnIndex
    ) const;
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *AggregateSortedByTypeMeshesOnSameCoords(
        const std::vector<const MEDCouplingUMesh *> &ms,
        DataArrayIdType *&szOfCellGrpOfSameType,
        DataArrayIdType *&idInMsOfCellGrpOfSameType
    );
    MEDCOUPLING_EXPORT DataArrayIdType *keepCellIdsByType(
    ...
    MEDCOUPLING_EXPORT MEDCouplingUMesh *keepSpecifiedCells(
    ...
    MEDCOUPLING_EXPORT mcIdType split2DCells(
        const DataArrayIdType *desc,
        const DataArrayIdType *descI,
    ...
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *MergeUMeshes(
        const MEDCouplingUMesh *mesh1, const MEDCouplingUMesh *mesh2
    );
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *MergeUMeshes(const std::vector<const MEDCouplingUMesh *> &a);
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *MergeUMeshesOnSameCoords(
        const MEDCouplingUMesh *mesh1, const MEDCouplingUMesh *mesh2
    );
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *MergeUMeshesOnSameCoords(
        const std::vector<const MEDCouplingUMesh *> &meshes
    );
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *FuseUMeshesOnSameCoords(
    ...
    MEDCOUPLING_EXPORT static void MergeNodesOnUMeshesSharingSameCoords(
        const std::vector<MEDCouplingUMesh *> &meshes, double eps
    );
    MEDCOUPLING_EXPORT static bool IsPolygonWellOriented(
        bool isQuadratic, const double *vec, const mcIdType *begin, const mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static bool IsPolyhedronWellOriented(
        const mcIdType *begin, const mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static bool Is3DExtrudedStaticCellWellOriented(
        const mcIdType *begin, const mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static void CorrectExtrudedStaticCell(mcIdType *begin, mcIdType *end);
    MEDCOUPLING_EXPORT static bool IsTetra4WellOriented(
        const mcIdType *begin, const mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static bool IsPyra5WellOriented(
        const mcIdType *begin, const mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static void SimplifyPolyhedronCell(
        double eps,
    ...
    MEDCOUPLING_EXPORT static void ComputeVecAndPtOfFace(
        double eps, const double *coords, const mcIdType *begin, const mcIdType *end, double *v, double *p
    );
    MEDCOUPLING_EXPORT static void TryToCorrectPolyhedronOrientation(
        mcIdType *begin, mcIdType *end, const double *coords
    );
    MEDCOUPLING_EXPORT static MEDCouplingUMesh *Intersect2DMeshes(
    ...
    MEDCOUPLING_EXPORT static void Intersect2DMeshWith1DLine(
    ...
    MEDCOUPLING_EXPORT static bool BuildConvexEnvelopOf2DCellJarvis(
        const double *coords, const mcIdType *nodalConnBg, const mcIdType *nodalConnEnd, DataArrayIdType *nodalConnecOut
    );
    MEDCOUPLING_EXPORT static std::vector<DataArrayIdType *> PartitionBySpreadZone(
        const DataArrayIdType *arrIn, const DataArrayIdType *arrIndxIn
    );
    MEDCOUPLING_EXPORT static DataArrayIdType *ComputeSpreadZoneGradually(
        const DataArrayIdType *arrIn, const DataArrayIdType *arrIndxIn
    );
    MEDCOUPLING_EXPORT static DataArrayIdType *ComputeSpreadZoneGraduallyFromSeed(
    ...
    MEDCOUPLING_EXPORT static void FindCommonCellsAlg(
        int compType,
   ...
   private:  // all private methods are impl in MEDCouplingUMesh_internal.cxx
    ...
    static bool AreCellsEqualInPool(
    ...
    DataArrayIdType *convertLinearCellsToQuadratic2DAnd3D0(
    ...
    DataArrayIdType *convertLinearCellsToQuadratic2D0(
        DataArrayIdType *&conn,
        DataArrayIdType *&connI,
        DataArrayDouble *&coords,
        std::set<INTERP_KERNEL::NormalizedCellType> &types
    ) const;
    DataArrayIdType *convertLinearCellsToQuadratic2D1(
        DataArrayIdType *&conn,
        DataArrayIdType *&connI,
        DataArrayDouble *&coords,
        std::set<INTERP_KERNEL::NormalizedCellType> &types
    ) const;
    DataArrayIdType *convertLinearCellsToQuadratic3D0(
        DataArrayIdType *&conn,
        DataArrayIdType *&connI,
        DataArrayDouble *&coords,
        std::set<INTERP_KERNEL::NormalizedCellType> &types
    ) const;
    DataArrayIdType *convertLinearCellsToQuadratic3D1(
        DataArrayIdType *&conn,
        DataArrayIdType *&connI,
        DataArrayDouble *&coords,
        std::set<INTERP_KERNEL::NormalizedCellType> &types
    ...
    void getCellsContainingPointsAlg(
        const double *coords,
        const double *pos,
        mcIdType nbOfPoints,
        double eps,
    ...
    void getCellsContainingPointsZeAlg(
        const double *pos,
        mcIdType nbOfPoints,
        double eps,
        MCAuto<DataArrayIdType> &elts,
    ...
    /// @cond INTERNAL
    static void DeleteCellTypeInIndexedArray(
        const DataArrayIdType *arrIn,
        const DataArrayIdType *arrIndxIn,
    ...
    typedef mcIdType (*DimM1DescNbrer)(
        mcIdType id,
        mcIdType nb,
    ...
    static void DistanceToPoint3DSurfAlg(
        const double *pt,
    ...
    static void DistanceToPoint2DCurveAlg(
        const double *pt,
        const mcIdType *cellIdsBg,
        const mcIdType *cellIdsEnd,
        const double *coords,
    ...
    static DataArrayIdType *ComputeSpreadZoneGraduallyFromSeedAlg(
    ...
    static void IntersectDescending2DMeshes(
        const MEDCouplingUMesh *m1,
        const MEDCouplingUMesh *m2,
        double eps,
        std::vector<std::vector<mcIdType> > &intersectEdge1,
    ...
    static void BuildIntersectEdges(
        const MEDCouplingUMesh *m1,
        const MEDCouplingUMesh *m2,
    ...
    static void AssemblyForSplitFrom3DCurve(
    ...
    void assemblyForSplitFrom3DSurf(
    ...
    void split2DCellsLinear(
        const DataArrayIdType *desc,
        const DataArrayIdType *descI,
        const DataArrayIdType *subNodesInSeg,
        const DataArrayIdType *subNodesInSegI
    );
    mcIdType split2DCellsQuadratic(
        const DataArrayIdType *desc,
        const DataArrayIdType *descI,
        const DataArrayIdType *subNodesInSeg,
        const DataArrayIdType *subNodesInSegI,
...
{
    const DataArrayIdType *operator()(const MEDCouplingUMesh *um) { return um->getNodalConnectivityIndex(); }
};
...
{
    const DataArrayIdType *operator()(const MEDCouplingUMesh *um) { return um->getNodalConnectivity(); }
};
...
{
    const DataArrayDouble *operator()(const MEDCouplingUMesh *um) { return um->getCoords(); }
};
