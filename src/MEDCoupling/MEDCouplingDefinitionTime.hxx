...
{
   public:
    MEDCOUPLING_EXPORT static MEDCouplingDefinitionTimeSlice *New(
    ...
    MEDCOUPLING_EXPORT virtual void getIdsOnTime(
...
class MEDCouplingDefinitionTime
{
   public:
    ...
    MEDCOUPLING_EXPORT void getIdsOnTimeRight(
        double tm, int &meshId, int &arrId, int &arrIdInField, int &fieldId
    ) const;
    MEDCOUPLING_EXPORT void getIdsOnTimeLeft(double tm, int &meshId, int &arrId, int &arrIdInField, int &fieldId) const;
    MEDCOUPLING_EXPORT void getIdsOnTime(
        double tm,
