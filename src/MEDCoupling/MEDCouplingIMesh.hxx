...
class MEDCouplingIMesh : public MEDCouplingStructuredMesh
{
   public:
    ...
    MEDCOUPLING_EXPORT static void CondenseFineToCoarse(
    ...
    MEDCOUPLING_EXPORT static void CondenseFineToCoarseGhost(
        const std::vector<mcIdType> &coarseSt,
        const DataArrayDouble *fineDA,
        const std::vector<std::pair<mcIdType, mcIdType> > &fineLocInCoarse,
        const std::vector<mcIdType> &facts,
    ...
    MEDCOUPLING_EXPORT static void SpreadCoarseToFine(
    ...
    MEDCOUPLING_EXPORT static void SpreadCoarseToFineGhost(
        const DataArrayDouble *coarseDA,
        const std::vector<mcIdType> &coarseSt,
        DataArrayDouble *fineDA,
        const std::vector<std::pair<mcIdType, mcIdType> > &fineLocInCoarse,
    ...
    MEDCOUPLING_EXPORT static void SpreadCoarseToFineGhostZone(
        const DataArrayDouble *coarseDA,
        const std::vector<mcIdType> &coarseSt,
        DataArrayDouble *fineDA,
        const std::vector<std::pair<mcIdType, mcIdType> > &fineLocInCoarse,
   ...
   private:
    ...
    static void SpreadCoarseToFineGhost2D(
        const double *inPtr,
        double *outPtr,
        std::size_t nbCompo,
        const std::vector<mcIdType> &coarseSt,
    ...
    static void SpreadCoarseToFineGhostZone2D(
        const double *inPtr,
        double *outPtr,
        std::size_t nbCompo,
        const std::vector<mcIdType> &coarseSt,
