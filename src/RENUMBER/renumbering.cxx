...
main(int argc, char **argv)
{
    ...
    if (argc < 5)
    {
        cerr << "Usage : " << argv[0] << " filename_in meshname method[BOOST/METIS] filename_out" << endl << endl;
        return -1;
    }
    ...
    if (!mc)
    {
        ...
        oss << "In file \"" << filename_in << "\" the mesh name \"" << meshname
            << "\" exists but is not unstructured !";
