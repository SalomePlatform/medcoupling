...
class RenumberingTest(unittest.TestCase):
    def testBoost2D(self):
        ...
        Boost2D = (
            m.getNodalConnectivity().getValues() == connectivite
            and m.getNodalConnectivityIndex().getValues() == connectivite_index
            and field
        )
    ...
    def testBoost2DPolygon(self):
        ...
        PolyBoost2D = (
            conn2dpolyboost and conn_index2dpolyboost and (nbcell2dpolyboost == 9)
        )
    ...
    def tessMetis2DPolygon(self):  # not activated yet
        ...
        PolyMetis2D = (
            conn2dpolymetis and conn_index2dpolymetis and (nbcell2dpolymetis == 9)
        )
    ...
    def testBoost3DPoly(self):
        ...
        PolyBoost3D = (
            conn3dpolyboost and conn_index3dpolyboost and (nbcell3dpolyboost == 8)
        )
    ...
    def tessBoost3DPoly(self):  # not activated yet
        ...
        PolyMetis3D = (
            conn3dpolymetis and conn_index3dpolymetis and (nbcell3dpolymetis == 8)
        )
