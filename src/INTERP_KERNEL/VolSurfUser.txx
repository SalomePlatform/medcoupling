...
computeVolSurfOfCell(NormalizedCellType type, const ConnType *connec, mcIdType lgth, const double *coords)
{
    switch (type)
    {
        ...
        case INTERP_KERNEL::NORM_SEG3:
        {
            ...
            return INTERP_KERNEL::calculateLgthForSeg3(
                coords + (SPACEDIM * beginNode),
                coords + (SPACEDIM * endNode),
                coords + (SPACEDIM * middleNode),
                SPACEDIM
            );
        }
        case INTERP_KERNEL::NORM_TRI3:
        {
            ...
            return INTERP_KERNEL::calculateAreaForTria(
                coords + (SPACEDIM * N1), coords + (SPACEDIM * N2), coords + (SPACEDIM * N3), SPACEDIM
            );
        }
        break;
        ...
        case INTERP_KERNEL::NORM_QUAD4:
        {
            ...
            return INTERP_KERNEL::calculateAreaForQuad(
                coords + SPACEDIM * N1, coords + SPACEDIM * N2, coords + SPACEDIM * N3, coords + SPACEDIM * N4, SPACEDIM
            );
        }
        break;
        ...
        case INTERP_KERNEL::NORM_TETRA10:
        {
            ...
            return INTERP_KERNEL::calculateVolumeForTetra(
                coords + SPACEDIM * N1, coords + SPACEDIM * N2, coords + SPACEDIM * N3, coords + SPACEDIM * N4
            );
        }
        break;
        ...
        case INTERP_KERNEL::NORM_PYRA13:
        {
            ...
            return INTERP_KERNEL::calculateVolumeForPyra(
                coords + SPACEDIM * N1,
                coords + SPACEDIM * N2,
                coords + SPACEDIM * N3,
                coords + SPACEDIM * N4,
        ...
        case INTERP_KERNEL::NORM_PENTA18:
        {
            ...
            return INTERP_KERNEL::calculateVolumeForPenta(
                coords + SPACEDIM * N1,
                coords + SPACEDIM * N2,
                coords + SPACEDIM * N3,
                coords + SPACEDIM * N4,
        ...
        case INTERP_KERNEL::NORM_HEXA27:
        {
            ...
            return INTERP_KERNEL::calculateVolumeForHexa(
                coords + SPACEDIM * N1,
                coords + SPACEDIM * N2,
                coords + SPACEDIM * N3,
                coords + SPACEDIM * N4,
        ...
        case INTERP_KERNEL::NORM_HEXGP12:
        {
            const ConnType connecHexa12[43] = {
                OTT<ConnType, numPol>::coo2C(connec[0]),
                OTT<ConnType, numPol>::coo2C(connec[1]),
                OTT<ConnType, numPol>::coo2C(connec[2]),
                OTT<ConnType, numPol>::coo2C(connec[3]),
                OTT<ConnType, numPol>::coo2C(connec[4]),
                OTT<ConnType, numPol>::coo2C(connec[5]),
                -1,
                OTT<ConnType, numPol>::coo2C(connec[6]),
                OTT<ConnType, numPol>::coo2C(connec[11]),
                OTT<ConnType, numPol>::coo2C(connec[10]),
                OTT<ConnType, numPol>::coo2C(connec[9]),
                OTT<ConnType, numPol>::coo2C(connec[8]),
                OTT<ConnType, numPol>::coo2C(connec[7]),
                -1,
                OTT<ConnType, numPol>::coo2C(connec[0]),
                OTT<ConnType, numPol>::coo2C(connec[6]),
                OTT<ConnType, numPol>::coo2C(connec[7]),
...
computeBarycenter(NormalizedCellType type, const ConnType *connec, mcIdType lgth, const double *coords, double *res)
{
    switch (type)
    {
        ...
        {
            std::copy(
                coords + SPACEDIM * OTT<ConnType, numPol>::coo2C(connec[0]),
                coords + SPACEDIM * OTT<ConnType, numPol>::coo2C(connec[0] + 1),
                res
            );
            std::transform(
                res,
                res + SPACEDIM,
                coords + SPACEDIM * OTT<ConnType, numPol>::coo2C(connec[1]),
                res,
                std::plus<double>()
            );
        ...
        case NORM_SEG3:
        {
            if (SPACEDIM == 2)
            {
                Edge *ed = Edge::BuildEdgeFrom3Points(
                    coords + 2 * OTT<ConnType, numPol>::coo2C(connec[0]),
                    coords + 2 * OTT<ConnType, numPol>::coo2C(connec[2]),
                    coords + 2 * OTT<ConnType, numPol>::coo2C(connec[1])
                );
            ...
            {
                *res = (coords[OTT<ConnType, numPol>::coo2C(connec[0])] +
                        coords[OTT<ConnType, numPol>::coo2C(connec[1])]) /
                       2.;
            }
            else if (SPACEDIM == 3)
            {
                ...
                std::transform(
                    res, res + SPACEDIM, res, std::bind(std::multiplies<double>(), std::placeholders::_1, 0.5)
                );
            }
            else
        ...
        case NORM_TRI7:
        {
            ...
            std::transform(
                res,
                res + SPACEDIM,
                coords + SPACEDIM * OTT<ConnType, numPol>::coo2C(connec[2]),
                res,
                std::plus<double>()
            );
            std::transform(
                res, res + SPACEDIM, res, std::bind(std::multiplies<double>(), std::placeholders::_1, 1. / 3.)
            );
            break;
        }
        case NORM_TRI6:
