...
template <class RealPlanar>
InterpolationPlanar<RealPlanar>::InterpolationPlanar(const InterpolationOptions &io)
    : Interpolation<InterpolationPlanar<RealPlanar> >(io), _dim_caracteristic(1)
...
template <class RealPlanar>
void
InterpolationPlanar<RealPlanar>::setOptions(
    double precision, int printLevel, IntersectionType intersectionType, int orientation
)
{
...
/** \brief Main function to interpolate triangular or quadrangular meshes.
    \details  The algorithm proceeds in two steps: first a filtering process reduces the number of pairs of elements for
   which the
    * calculation must be carried out by eliminating pairs that do not intersect based on their bounding boxes. Then,
   the
    * volume of intersection is calculated by an object of type IntersectorPlanar for the remaining pairs, and entered
   into the
    * intersection matrix.
    *
   ...
   regardless
    * of whether the element intersects any source elements or not. But in the maps there are only entries for those
   source elements
    * which have a non-zero intersection volume with the target element. The vector has indices running from
    * 0 to (#target elements - 1), meaning that the map for target element i is stored at index i - 1. In the maps,
   however,
...
InterpolationPlanar<RealPlanar>::interpolateMeshes(
    const MyMeshType &myMeshS, const MyMeshType &myMeshT, MatrixType &result, const std::string &method
)
{
    ...
    double BoxS[2 * SPACEDIM];
    myMeshS.getBoundingBox(BoxS);
    double BoxT[2 * SPACEDIM];
    myMeshT.getBoundingBox(BoxT);
    ...
    if (meth == "P0P0")
    {
        switch (InterpolationOptions::getIntersectionType())
        {
            case Triangulation:
                ...
                break;
            case Convex:
                intersector = new ConvexIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Geometric2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case PointLocator:
                intersector = new PointLocator2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "For P0P0 planar interpolation possibities are : Triangulation, Convex, Geometric2D, PointLocator !"
                );
        }
    }
    else if (meth == "P0P1")
    {
        ...
        {
            case Triangulation:
                intersector = new TriangulationIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Convex:
                intersector = new ConvexIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Geometric2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case PointLocator:
                intersector = new PlanarIntersectorP0P1PL<MyMeshType, MatrixType>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case Barycentric:
                intersector = new TriangulationIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P1Bary>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
            ...
            case BarycentricGeo2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP0P1Bary>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "For P0P1 planar interpolation possibities are : Triangulation, Convex, Geometric2D, PointLocator, "
                    "Barycentric, BarycentricGeo2D !"
                );
        }
    }
    else if (meth == "P1P0")
    {
        ...
        {
            case Triangulation:
                intersector = new TriangulationIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Convex:
                intersector = new ConvexIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Geometric2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P0>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case PointLocator:
                intersector = new PlanarIntersectorP1P0PL<MyMeshType, MatrixType>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case Barycentric:
                intersector = new TriangulationIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P0Bary>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case BarycentricGeo2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P0Bary>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "For P1P0 planar interpolation possibities are : Triangulation, Convex, Geometric2D, PointLocator, "
    ...
    else if (meth == "P1P1")
    {
        ...
        {
            case Triangulation:
                intersector = new TriangulationIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Convex:
                intersector = new ConvexIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getPrecision(),
                ...
                break;
            case Geometric2D:
                intersector = new Geometric2DIntersector<MyMeshType, MatrixType, PlanarIntersectorP1P1>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
                ...
                break;
            case PointLocator:
                intersector = new PlanarIntersectorP1P1PL<MyMeshType, MatrixType>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
            ...
            case MappedBarycentric:
                intersector = new MappedBarycentric2DIntersectorP1P1<MyMeshType, MatrixType>(
                    myMeshT,
                    myMeshS,
                    _dim_caracteristic,
                    InterpolationOptions::getMaxDistance3DSurfIntersect(),
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "For P1P1 planar interpolation possibities are : Triangulation, Convex, Geometric2D, PointLocator, "
                    "MappedBarycentric !"
                );
        }
    }
        ...
        throw INTERP_KERNEL::Exception(
            "Invalid method specified or intersection type ! Must be in : \"P0P0\" \"P0P1\" \"P1P0\" or \"P1P1\""
        );
    /****************************************************************/
