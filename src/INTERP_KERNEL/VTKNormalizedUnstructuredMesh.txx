...
VTKNormalizedUnstructuredMesh<MESHDIM>::VTKNormalizedUnstructuredMesh(vtkUnstructuredGrid *mesh)
    : _mesh_in_vtk_mode(mesh), _tmp_index_array(0)
{
}
...
template <int MESHDIM>
void
VTKNormalizedUnstructuredMesh<MESHDIM>::getBoundingBox(double *boundingBox) const
{
    double tmp[6];
...
template <int MESHDIM>
NormalizedCellType
VTKNormalizedUnstructuredMesh<MESHDIM>::getTypeOfElement(vtkIdType eltId) const
{
...
template <int MESHDIM>
unsigned long
VTKNormalizedUnstructuredMesh<MESHDIM>::getNumberOfElements() const
{
...
template <int MESHDIM>
unsigned long
VTKNormalizedUnstructuredMesh<MESHDIM>::getNumberOfNodes() const
{
...
template <int MESHDIM>
const vtkIdType *
VTKNormalizedUnstructuredMesh<MESHDIM>::getConnectivityPtr() const
{
...
template <int MESHDIM>
const double *
VTKNormalizedUnstructuredMesh<MESHDIM>::getCoordinatesPtr() const
{
...
template <int MESHDIM>
const vtkIdType *
VTKNormalizedUnstructuredMesh<MESHDIM>::getConnectivityIndexPtr() const
{
    if (_tmp_index_array)
...
template <int MESHDIM>
void
VTKNormalizedUnstructuredMesh<MESHDIM>::putinMEDFormat() const
{
    ...
    for (long i = 0; i < nbOfElem; i++)
    {
        ...
        for (vtkIdType j = 0; j < cellLgth; j++) *finalConn++ = coarseConn[ptInCC + j + 1];
...
template <int MESHDIM>
void
VTKNormalizedUnstructuredMesh<MESHDIM>::releaseTempArrays()
{
