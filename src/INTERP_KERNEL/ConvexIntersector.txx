...
namespace INTERP_KERNEL
{
  ...
  ConvexIntersector<SPACEDIM,MESHDIM,ConnType,numPol,MyMeshType>::ConvexIntersector(const NormalizedUnstructuredMesh<SPACEDIM,MESHDIM,ConnType,numPol,MyMeshType>& mesh_A,
    ...
    :PlanarIntersector<SPACEDIM,MESHDIM,ConnType,numPol,MyMeshType>(dimCaracteristic, precision, medianPlane, doRotate, printLevel),
  ...
  template<int SPACEDIM, int MESHDIM, class ConnType, NumberingPolicy numPol, class MyMeshType>
  double ConvexIntersector<SPACEDIM,MESHDIM,ConnType,numPol,MyMeshType>::intersectCells(ConnType icell_A, ConnType icell_B, 
