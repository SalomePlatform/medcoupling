...
PolyhedronIntersectorP0P1<MyMeshType, MyMatrix>::PolyhedronIntersectorP0P1(
    ...
    : Intersector3DP0P1<MyMeshType, MyMatrix>(targetMesh, srcMesh), _split(targetMesh, srcMesh, policy)
{
}
...
template <class MyMeshType, class MyMatrix>
void
PolyhedronIntersectorP0P1<MyMeshType, MyMatrix>::releaseArrays()
{
...
template <class MyMeshType, class MyMatrix>
void
PolyhedronIntersectorP0P1<MyMeshType, MyMatrix>::intersectCells(
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                if (volume != 0.)
                {
                    ...
                    if (targetNodeId < 0)
                    {
                        ...
                        oss << "PolyhedronIntersectorP0P1::intersectCells : On target cell #" << targetCell
                            << " the splitting into tetra4 leads to the creation of an additional point that interacts "
                               "with source cell Id #"
                            << *iterCellS << " !";
