...
GEO2D_INTERSECTOR::Geometric2DIntersector(
    ...
    : InterpType<MyMeshType, MyMatrix, GEO2D_INTERSECTOR>(
...
INTERSECTOR_TEMPLATE
double
GEO2D_INTERSECTOR::intersectGeometry(ConnType icellT, ConnType icellS, ConnType nbNodesT, ConnType nbNodesS)
{
    int orientation = 1;
...
INTERSECTOR_TEMPLATE
double
GEO2D_INTERSECTOR::intersectGeometry1D(
...
INTERSECTOR_TEMPLATE
double
GEO2D_INTERSECTOR::intersectGeometryWithQuadrangle(
...
INTERSECTOR_TEMPLATE
double
GEO2D_INTERSECTOR::intersectGeometryGeneral(
...
INTERSECTOR_TEMPLATE
double
GEO2D_INTERSECTOR::intersectGeoBary(
...
INTERSECTOR_TEMPLATE
QuadraticPolygon *
GEO2D_INTERSECTOR::buildPolygonFrom(const std::vector<double> &coords, NormalizedCellType type)
{
...
INTERSECTOR_TEMPLATE
QuadraticPolygon *
GEO2D_INTERSECTOR::buildPolygonOfOneEdgeFrom(const std::vector<double> &coords, NormalizedCellType type)
{
    if (type == NORM_SEG2)
    {
    ...
    else if (type == NORM_SEG3)
    {
        ...
        throw INTERP_KERNEL::Exception(
            "buildPolygonOfOneEdgeFrom : trying to build such non close QuadraticPolygon with 1D type !"
        );
}

INTERSECTOR_TEMPLATE
QuadraticPolygon *
GEO2D_INTERSECTOR::buildPolygonAFrom(ConnType cell, int nbOfPoints, NormalizedCellType type)
{
...
INTERSECTOR_TEMPLATE
QuadraticPolygon *
GEO2D_INTERSECTOR::buildPolygonBFrom(ConnType cell, int nbOfPoints, NormalizedCellType type)
{
    const ConnType *startOfCellNodeConn =
