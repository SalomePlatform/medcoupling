...
#define _INTERSECTOR_CU \
    IntersectorCU<MyCMeshType, MyUMeshType, MyMatrix, IntersectorCU3D<MyCMeshType, MyUMeshType, MyMatrix> >
...
INTERSECTOR_CU3D::IntersectorCU3D(const MyCMeshType &meshS, const MyUMeshType &meshT, SplittingPolicy splitting_policy)
    : _INTERSECTOR_CU(meshS, meshT)
{
    if (MyCMeshType::MY_SPACEDIM != 3 || MyCMeshType::MY_MESHDIM != 3 || MyUMeshType::MY_SPACEDIM != 3 ||
        MyUMeshType::MY_MESHDIM != 3)
...
IntersectorCU3D_TEMPLATE INTERSECTOR_CU3D::~IntersectorCU3D()
{
    delete _uHexMesh;
    _uHexMesh = 0;
    delete _split;
...
IntersectorCU3D_TEMPLATE double
INTERSECTOR_CU3D::intersectGeometry(UConnType icellT, const std::vector<CConnType> &icellS)
{
    // split an unstructured cell into tetra
    std::vector<TTetra *> tetra;
    UConnType nb_nodes = _INTERSECTOR_CU::_connIndexU[icellT + 1] - _INTERSECTOR_CU::_connIndexU[icellT];
