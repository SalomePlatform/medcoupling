...
constexpr NormalizedCellType LIST_OF_SIMPLY_QUADRATIC_CELLS[SIZE_OF_SIMPLY_QUADRATIC_CELLS] = {
    NORM_TRI6, NORM_QUAD8, NORM_TETRA10, NORM_PENTA15, NORM_PYRA13, NORM_HEXA20
};

const char *CellModel::CELL_TYPES_REPR[] = {
    "NORM_POINT1",
    "NORM_SEG2",
    "NORM_SEG3",
    "NORM_TRI3",
...
const CellModel &
CellModel::GetCellModel(NormalizedCellType type)
{
    ...
    if (iter == map_unique.end())
    {
        ...
        stream << "no cellmodel for normalized type " << type;
        throw Exception(stream.str().c_str());
    }
    return (*iter).second;
}

const std::map<NormalizedCellType, CellModel> &
CellModel::GetMapOfUniqueInstance()
{
 ...
 */
bool
CellModel::isCompatibleWith(NormalizedCellType type) const
{
    if (_type == type)
        return true;
...
/*!
 * Simply quadratic stands for element where ALL additionnal points to the associated linear cell are in the middle of
 * edges.
 */
bool
CellModel::isSimplyQuadratic() const
{
    return std::find(
               LIST_OF_SIMPLY_QUADRATIC_CELLS, LIST_OF_SIMPLY_QUADRATIC_CELLS + SIZE_OF_SIMPLY_QUADRATIC_CELLS, _type
           ) != LIST_OF_SIMPLY_QUADRATIC_CELLS + SIZE_OF_SIMPLY_QUADRATIC_CELLS;
}

void
CellModel::BuildUniqueInstance(std::map<NormalizedCellType, CellModel> &map_unique)
{
...
CellModel::CellModel(NormalizedCellType type) : _type(type)
{
    ...
    switch (type)
    {
        ...
        case NORM_SEG2:
        {
            ...
            _nb_of_sons = 2;
            _dim = 1;
            _extruded_type = NORM_QUAD4;
            _quadratic_type = NORM_SEG3;
            _quadratic_type2 = NORM_SEG3;
            _is_simplex = true;
            _is_extruded = true;
            _reverse_extruded_type = NORM_POINT1;
            _sons_type[0] = NORM_POINT1;
            _sons_type[1] = NORM_POINT1;
            _sons_con[0][0] = 0;
            _nb_of_sons_con[0] = 1;
            _sons_con[1][0] = 1;
            _nb_of_sons_con[1] = 1;
        ...
        case NORM_SEG3:
        {
            ...
            _nb_of_sons = 3;
            _dim = 1;
            _extruded_type = NORM_QUAD8;
            _linear_type = NORM_SEG2;
            _quadratic = true;
            _is_simplex = false;
            _sons_type[0] = NORM_POINT1;
            _sons_type[1] = NORM_POINT1;
            _sons_type[2] = NORM_POINT1;
            _sons_con[0][0] = 0;
            _nb_of_sons_con[0] = 1;
            _sons_con[1][0] = 1;
            _nb_of_sons_con[1] = 1;
        ...
        case NORM_SEG4:
        {
            ...
            _linear_type = NORM_SEG2;
            _quadratic = true;
            _is_simplex = false;  // no _extruded_type because no cubic 2D cell
            _sons_type[0] = NORM_POINT1;
            _sons_type[1] = NORM_POINT1;
            _sons_type[2] = NORM_POINT1;
            _sons_type[3] = NORM_POINT1;
            _sons_con[0][0] = 0;
            _nb_of_sons_con[0] = 1;
            _sons_con[1][0] = 1;
            _nb_of_sons_con[1] = 1;
        ...
        case NORM_TETRA4:
        {
            ...
            _nb_of_sons = 4;
            _dim = 3;
            _quadratic_type = NORM_TETRA10;
            _is_simplex = true;
            _sons_type[0] = NORM_TRI3;
            _sons_type[1] = NORM_TRI3;
            _sons_type[2] = NORM_TRI3;
            _sons_type[3] = NORM_TRI3;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _nb_of_sons_con[0] = 3;
            ...
            _nb_of_little_sons = 6;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 0;
            _little_sons_con[3][0] = 0;
            _little_sons_con[3][1] = 3;
            _little_sons_con[4][0] = 1;
            _little_sons_con[4][1] = 3;
            _little_sons_con[5][0] = 2;
            _little_sons_con[5][1] = 3;
        }
        break;
        case NORM_HEXA8:
        {
            ...
            _nb_of_sons = 6;
            _dim = 3;
            _quadratic_type = NORM_HEXA20;
            _quadratic_type2 = NORM_HEXA27;
            _is_simplex = false;
            _is_extruded = true;
            _reverse_extruded_type = NORM_QUAD4;
            _sons_type[0] = NORM_QUAD4;
            _sons_type[1] = NORM_QUAD4;
            _sons_type[2] = NORM_QUAD4;
            _sons_type[3] = NORM_QUAD4;
            _sons_type[4] = NORM_QUAD4;
            _sons_type[5] = NORM_QUAD4;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
            ...
            _little_sons_con[0][0] = 0;
            _little_sons_con[0][1] = 1;
            _nb_of_little_sons = 12;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 3;
            _little_sons_con[3][0] = 3;
            _little_sons_con[3][1] = 0;
            _little_sons_con[4][0] = 4;
            _little_sons_con[4][1] = 5;
            _little_sons_con[5][0] = 5;
            _little_sons_con[5][1] = 6;
            _little_sons_con[6][0] = 6;
            _little_sons_con[6][1] = 7;
            _little_sons_con[7][0] = 7;
            _little_sons_con[7][1] = 4;
            _little_sons_con[8][0] = 0;
            _little_sons_con[8][1] = 4;
            _little_sons_con[9][0] = 1;
            _little_sons_con[9][1] = 5;
            _little_sons_con[10][0] = 2;
            _little_sons_con[10][1] = 6;
            _little_sons_con[11][0] = 3;
            _little_sons_con[11][1] = 7;
        }
        break;
        case NORM_QUAD4:
        {
            ...
            _nb_of_sons = 4;
            _dim = 2;
            _quadratic_type = NORM_QUAD8;
            _quadratic_type2 = NORM_QUAD9;
            _is_simplex = false;
            _is_extruded = true;
            _sons_type[0] = NORM_SEG2;
            _sons_type[1] = NORM_SEG2;
            _sons_type[2] = NORM_SEG2;
            _sons_type[3] = NORM_SEG2;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _nb_of_sons_con[0] = 2;
            _sons_con[1][0] = 1;
            ...
            _sons_con[3][1] = 0;
            _nb_of_sons_con[3] = 2;
            _extruded_type = NORM_HEXA8;
            _extrude_con[0] = 0;
            _extrude_con[1] = 1;
            _extrude_con[2] = 2;
            _extrude_con[3] = 3;
            _extrude_con[4] = MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[5] = MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[6] = MAX_NB_OF_NODES_PER_ELEM + 2;
            _extrude_con[7] = MAX_NB_OF_NODES_PER_ELEM + 3;
        }
        break;
        case NORM_TRI3:
        {
            ...
            _nb_of_sons = 3;
            _dim = 2;
            _quadratic_type = NORM_TRI6;
            _quadratic_type2 = NORM_TRI7;
            _is_simplex = true;
            _sons_type[0] = NORM_SEG2;
            _sons_type[1] = NORM_SEG2;
            _sons_type[2] = NORM_SEG2;
            ...
            _sons_con[2][1] = 0;
            _nb_of_sons_con[2] = 2;
            _extruded_type = NORM_PENTA6;
            _extrude_con[0] = 0;
            _extrude_con[1] = 1;
            _extrude_con[2] = 2;
            _extrude_con[3] = MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[4] = MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[5] = MAX_NB_OF_NODES_PER_ELEM + 2;
        }
        break;
        case NORM_TRI6:
        {
            ...
            _nb_of_sons = 3;
            _dim = 2;
            _linear_type = NORM_TRI3;
            _is_simplex = false;
            _sons_type[0] = NORM_SEG3;
            _sons_type[1] = NORM_SEG3;
            _sons_type[2] = NORM_SEG3;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 3;
            _nb_of_sons_con[0] = 3;
            ...
            _nb_of_sons_con[2] = 3;
            _quadratic = true;
            _extruded_type = NORM_PENTA15;
            _extrude_con[0] = 0;
            _extrude_con[1] = 1;
            _extrude_con[2] = 2;
            _extrude_con[3] = 2 * MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[4] = 2 * MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[5] = 2 * MAX_NB_OF_NODES_PER_ELEM + 2;
            _extrude_con[6] = 3;
            _extrude_con[7] = 4;
            _extrude_con[8] = 5;
            _extrude_con[9] = 2 * MAX_NB_OF_NODES_PER_ELEM + 3;
            _extrude_con[10] = 2 * MAX_NB_OF_NODES_PER_ELEM + 4;
            _extrude_con[11] = 2 * MAX_NB_OF_NODES_PER_ELEM + 5;
            _extrude_con[12] = MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[13] = MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[14] = MAX_NB_OF_NODES_PER_ELEM + 2;
        }
        break;
        case NORM_TRI7:
        {
            ...
            _nb_of_sons_con[2] = 3;
            _quadratic = true;
            _extruded_type = NORM_PENTA18;  // no penta20 -> so use penta18
            _extrude_con[0] = 0;
            _extrude_con[1] = 1;
            _extrude_con[2] = 2;
            _extrude_con[3] = 2 * MAX_NB_OF_NODES_PER_ELEM + 0;
            ...
            _extrude_con[13] = MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[14] = MAX_NB_OF_NODES_PER_ELEM + 2;
            _extrude_con[15] = MAX_NB_OF_NODES_PER_ELEM + 3;
            _extrude_con[16] = MAX_NB_OF_NODES_PER_ELEM + 4;
            _extrude_con[17] = MAX_NB_OF_NODES_PER_ELEM + 5;
        }
        break;
        case NORM_QUAD8:
        {
            ...
            _nb_of_sons = 4;
            _dim = 2;
            _linear_type = NORM_QUAD4;
            _is_simplex = false;
            _sons_type[0] = NORM_SEG3;
            _sons_type[1] = NORM_SEG3;
            _sons_type[2] = NORM_SEG3;
            _sons_type[3] = NORM_SEG3;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 4;
            _nb_of_sons_con[0] = 3;
            ...
            _nb_of_sons_con[3] = 3;
            _quadratic = true;
            _extruded_type = NORM_HEXA20;
            _extrude_con[0] = 0;
            _extrude_con[1] = 1;
            _extrude_con[2] = 2;
            _extrude_con[3] = 3;
            _extrude_con[4] = 2 * MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[5] = 2 * MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[6] = 2 * MAX_NB_OF_NODES_PER_ELEM + 2;
            _extrude_con[7] = 2 * MAX_NB_OF_NODES_PER_ELEM + 3;
            _extrude_con[8] = 4;
            _extrude_con[9] = 5;
            _extrude_con[10] = 6;
            _extrude_con[11] = 7;
            _extrude_con[12] = 2 * MAX_NB_OF_NODES_PER_ELEM + 4;
            _extrude_con[13] = 2 * MAX_NB_OF_NODES_PER_ELEM + 5;
            _extrude_con[14] = 2 * MAX_NB_OF_NODES_PER_ELEM + 6;
            _extrude_con[15] = 2 * MAX_NB_OF_NODES_PER_ELEM + 7;
            _extrude_con[16] = MAX_NB_OF_NODES_PER_ELEM + 0;
            _extrude_con[17] = MAX_NB_OF_NODES_PER_ELEM + 1;
            _extrude_con[18] = MAX_NB_OF_NODES_PER_ELEM + 2;
            _extrude_con[19] = MAX_NB_OF_NODES_PER_ELEM + 3;
        }
        break;
        case NORM_QUAD9:
        {
            ...
            _extrude_con[19] = MAX_NB_OF_NODES_PER_ELEM + 3;
            _extrude_con[20] = 8;
            _extrude_con[21] = MAX_NB_OF_NODES_PER_ELEM + 4;
            _extrude_con[22] = MAX_NB_OF_NODES_PER_ELEM + 5;
            _extrude_con[23] = MAX_NB_OF_NODES_PER_ELEM + 6;
            _extrude_con[24] = MAX_NB_OF_NODES_PER_ELEM + 7;
        ...
        case NORM_PYRA5:
        {
            ...
            _nb_of_sons = 5;
            _dim = 3;
            _quadratic_type = NORM_PYRA13;
            _is_simplex = false;
            _sons_type[0] = NORM_QUAD4;
            _sons_type[1] = NORM_TRI3;
            _sons_type[2] = NORM_TRI3;
            _sons_type[3] = NORM_TRI3;
            _sons_type[4] = NORM_TRI3;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
            ...
            _little_sons_con[3][0] = 3;
            _little_sons_con[3][1] = 0;
            _little_sons_con[4][0] = 0;
            _little_sons_con[4][1] = 4;
            _little_sons_con[5][0] = 1;
            _little_sons_con[5][1] = 4;
            _little_sons_con[6][0] = 2;
            _little_sons_con[6][1] = 4;
            _little_sons_con[7][0] = 3;
            _little_sons_con[7][1] = 4;
        }
        break;
        case NORM_PENTA6:
        {
            ...
            _nb_of_sons = 5;
            _dim = 3;
            _quadratic_type = NORM_PENTA15;
            _is_simplex = false;
            _is_extruded = true;
            _reverse_extruded_type = NORM_TRI3;
            _sons_type[0] = NORM_TRI3;
            _sons_type[1] = NORM_TRI3;
            _sons_type[2] = NORM_QUAD4;
            _sons_type[3] = NORM_QUAD4;
            ...
            _little_sons_con[5][0] = 5;
            _little_sons_con[5][1] = 3;
            _little_sons_con[6][0] = 0;
            _little_sons_con[6][1] = 3;
            _little_sons_con[7][0] = 1;
            _little_sons_con[7][1] = 4;
            _little_sons_con[8][0] = 2;
            _little_sons_con[8][1] = 5;
        }
        break;
        case NORM_TETRA10:
        {
            ...
            _nb_of_sons = 4;
            _dim = 3;
            _linear_type = NORM_TETRA4;
            _is_simplex = false;
            _sons_type[0] = NORM_TRI6;
            _sons_type[1] = NORM_TRI6;
            _sons_type[2] = NORM_TRI6;
            _sons_type[3] = NORM_TRI6;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 4;
            ...
            _little_sons_con[0][0] = 0;
            _little_sons_con[0][1] = 1;
            _little_sons_con[0][2] = 4;
            _nb_of_little_sons = 6;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[1][2] = 5;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 0;
            _little_sons_con[2][2] = 6;
            _little_sons_con[3][0] = 0;
            _little_sons_con[3][1] = 3;
            _little_sons_con[3][2] = 7;
            _little_sons_con[4][0] = 1;
            _little_sons_con[4][1] = 3;
            _little_sons_con[4][2] = 8;
            _little_sons_con[5][0] = 2;
            _little_sons_con[5][1] = 3;
            _little_sons_con[5][2] = 9;
        }
        break;
        case NORM_HEXGP12:
        {
            ...
            _is_simplex = false;
            _is_extruded = true;
            _sons_type[0] = NORM_POLYGON;
            _sons_type[1] = NORM_POLYGON;
            _sons_type[2] = NORM_QUAD4;
            _sons_type[3] = NORM_QUAD4;
            _sons_type[4] = NORM_QUAD4;
            _sons_type[5] = NORM_QUAD4;
            _sons_type[6] = NORM_QUAD4;
            _sons_type[7] = NORM_QUAD4;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
        ...
        case NORM_PYRA13:
        {
            ...
            _nb_of_sons = 5;
            _dim = 3;
            _linear_type = NORM_PYRA5;
            _is_simplex = false;
            _sons_type[0] = NORM_QUAD8;
            _sons_type[1] = NORM_TRI6;
            _sons_type[2] = NORM_TRI6;
            _sons_type[3] = NORM_TRI6;
            _sons_type[4] = NORM_TRI6;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
            ...
            _little_sons_con[0][0] = 0;
            _little_sons_con[0][1] = 1;
            _little_sons_con[0][2] = 5;
            _nb_of_little_sons = 8;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[1][2] = 6;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 3;
            _little_sons_con[2][2] = 7;
            _little_sons_con[3][0] = 3;
            _little_sons_con[3][1] = 0;
            _little_sons_con[3][2] = 8;
            _little_sons_con[4][0] = 0;
            _little_sons_con[4][1] = 4;
            _little_sons_con[4][2] = 9;
            _little_sons_con[5][0] = 1;
            _little_sons_con[5][1] = 4;
            _little_sons_con[5][2] = 10;
            _little_sons_con[6][0] = 2;
            _little_sons_con[6][1] = 4;
            _little_sons_con[6][2] = 11;
            _little_sons_con[7][0] = 3;
            _little_sons_con[7][1] = 4;
            _little_sons_con[7][2] = 12;
        }
        break;
        case NORM_PENTA15:
        {
            ...
            _nb_of_sons = 5;
            _dim = 3;
            _linear_type = NORM_PENTA6;
            _is_simplex = false;
            _sons_type[0] = NORM_TRI6;
            _sons_type[1] = NORM_TRI6;
            _sons_type[2] = NORM_QUAD8;
            _sons_type[3] = NORM_QUAD8;
            _sons_type[4] = NORM_QUAD8;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 6;
            ...
            _little_sons_con[0][0] = 0;
            _little_sons_con[0][1] = 1;
            _little_sons_con[0][2] = 6;
            _nb_of_little_sons = 9;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[1][2] = 7;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 0;
            _little_sons_con[2][2] = 8;
            _little_sons_con[3][0] = 3;
            _little_sons_con[3][1] = 4;
            _little_sons_con[3][2] = 9;
            _little_sons_con[4][0] = 4;
            _little_sons_con[4][1] = 5;
            _little_sons_con[4][2] = 10;
            _little_sons_con[5][0] = 5;
            _little_sons_con[5][1] = 3;
            _little_sons_con[5][2] = 11;
            _little_sons_con[6][0] = 0;
            _little_sons_con[6][1] = 3;
            _little_sons_con[6][2] = 12;
            _little_sons_con[7][0] = 1;
            _little_sons_con[7][1] = 4;
            _little_sons_con[7][2] = 13;
            _little_sons_con[8][0] = 2;
            _little_sons_con[8][1] = 5;
            _little_sons_con[8][2] = 14;
        }
        break;
        case NORM_PENTA18:
        {
            ...
            _sons_type[0] = NORM_TRI6;
            _sons_type[1] = NORM_TRI6;
            _sons_type[2] = NORM_QUAD9;
            _sons_type[3] = NORM_QUAD9;
            _sons_type[4] = NORM_QUAD9;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 6;
        ...
        case NORM_HEXA20:
        {
            ...
            _nb_of_sons = 6;
            _dim = 3;
            _linear_type = NORM_HEXA8;
            _is_simplex = false;
            _sons_type[0] = NORM_QUAD8;
            _sons_type[1] = NORM_QUAD8;
            _sons_type[2] = NORM_QUAD8;
            _sons_type[3] = NORM_QUAD8;
            _sons_type[4] = NORM_QUAD8;
            _sons_type[5] = NORM_QUAD8;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
            ...
            _little_sons_con[0][0] = 0;
            _little_sons_con[0][1] = 1;
            _little_sons_con[0][2] = 8;
            _nb_of_little_sons = 12;
            _little_sons_con[1][0] = 1;
            _little_sons_con[1][1] = 2;
            _little_sons_con[1][2] = 9;
            _little_sons_con[2][0] = 2;
            _little_sons_con[2][1] = 3;
            _little_sons_con[2][2] = 10;
            _little_sons_con[3][0] = 3;
            _little_sons_con[3][1] = 0;
            _little_sons_con[3][2] = 11;
            _little_sons_con[4][0] = 4;
            _little_sons_con[4][1] = 5;
            _little_sons_con[4][2] = 12;
            _little_sons_con[5][0] = 5;
            _little_sons_con[5][1] = 6;
            _little_sons_con[5][2] = 13;
            _little_sons_con[6][0] = 6;
            _little_sons_con[6][1] = 7;
            _little_sons_con[6][2] = 14;
            _little_sons_con[7][0] = 7;
            _little_sons_con[7][1] = 4;
            _little_sons_con[7][2] = 15;
            _little_sons_con[8][0] = 0;
            _little_sons_con[8][1] = 4;
            _little_sons_con[8][2] = 16;
            _little_sons_con[9][0] = 1;
            _little_sons_con[9][1] = 5;
            _little_sons_con[9][2] = 17;
            _little_sons_con[10][0] = 2;
            _little_sons_con[10][1] = 6;
            _little_sons_con[10][2] = 18;
            _little_sons_con[11][0] = 3;
            _little_sons_con[11][1] = 7;
            _little_sons_con[11][2] = 19;
        }
        break;
        case NORM_HEXA27:
        {
            ...
            _linear_type = NORM_HEXA8;
            _is_simplex = false;
            _sons_type[0] = NORM_QUAD9;
            _sons_type[1] = NORM_QUAD9;
            _sons_type[2] = NORM_QUAD9;
            _sons_type[3] = NORM_QUAD9;
            _sons_type[4] = NORM_QUAD9;
            _sons_type[5] = NORM_QUAD9;
            _sons_con[0][0] = 0;
            _sons_con[0][1] = 1;
            _sons_con[0][2] = 2;
            _sons_con[0][3] = 3;
        ...
        case NORM_POLYGON:
        {
            ...
            _dim = 2;
            _dyn = true;
            _extruded_type = NORM_POLYHED;
            _is_simplex = false;
            _quadratic_type = NORM_QPOLYG;
        }
        break;
        case NORM_POLYHED:
        {
 ...
 */
unsigned
CellModel::getNumberOfSons2(const mcIdType *conn, mcIdType lgth) const
{
    if (!isDynamic())
...
unsigned
CellModel::getNumberOfEdges() const
{
    if (!isDynamic())
    {
        switch (getDimension())
...
unsigned
CellModel::getNumberOfEdgesIn3D(const mcIdType *conn, mcIdType lgth) const
{
    if (!isDynamic())
 ...
 */
unsigned
CellModel::getNumberOfMicroEdges() const
{
        ...
        switch (getDimension())
        {
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "CellModel::getNumberOfMacroEdges : only 2D and 3D cells support this !"
                );
        }
    }
    else
...
NormalizedCellType
CellModel::getCorrespondingPolyType() const
{
    switch (getDimension())
    {
        case 0:
...
void
CellModel::buildExtruded(const mcIdType *nodalConn, mcIdType offset, mcIdType *nodalConnExtruded) const
{
 ...
 */
NormalizedCellType
CellModel::getSonType2(unsigned sonId) const
{
    if (!isDynamic())
...
/*!
 * \b WARNING this method do not manage correctly types that return true at the call of isDynamic. Use
 * fillSonCellNodalConnectivity2 instead.
 */
unsigned
CellModel::fillSonCellNodalConnectivity(int sonId, const mcIdType *nodalConn, mcIdType *sonNodalConn) const
{
    unsigned nbOfTurnLoop = _nb_of_sons_con[sonId];
    const unsigned *sonConn = _sons_con[sonId];
    for (unsigned i = 0; i < nbOfTurnLoop; i++) sonNodalConn[i] = nodalConn[sonConn[i]];
    return nbOfTurnLoop;
}

unsigned
CellModel::fillSonCellNodalConnectivity2(
...
/*!
 * Equivalent to CellModel::fillSonCellNodalConnectivity2 except for HEXA8 where the order of sub faces is not has MED
 * file numbering for transformation HEXA8->HEXA27
 */
unsigned
CellModel::fillSonCellNodalConnectivity4(
    int sonId, const mcIdType *nodalConn, mcIdType lgth, mcIdType *sonNodalConn, NormalizedCellType &typeOfSon
) const
{
    if (_type == NORM_HEXA8)
...
unsigned
CellModel::fillSonEdgesNodalConnectivity3D(
    int sonId, const mcIdType *nodalConn, mcIdType lgth, mcIdType *sonNodalConn, NormalizedCellType &typeOfSon
) const
{
    if (!isDynamic())
    {
        ...
        throw INTERP_KERNEL::Exception(
            "CellModel::fillSonEdgesNodalConnectivity3D : not implemented yet for NORM_POLYHED !"
        );
}
 ...
 */
unsigned
CellModel::fillMicroEdgeNodalConnectivity(
...
) const
{
    if (isQuadratic())
    {
        ...
        switch (getDimension())
        {
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "CellModel::fillMicroEdgeNodalConnectivity : only 2D and 3D cells support this !"
                );
        }
    ...
    else
    {
        switch (getDimension())
        {
            ...
            default:
                throw INTERP_KERNEL::Exception(
                    "CellModel::fillMicroEdgeNodalConnectivity : only 2D and 3D cells support this #2 !"
                );
        }
    }
}
...
void
CellModel::changeOrientationOf2D(mcIdType *nodalConn, unsigned int sz) const
{
    if (sz < 1)
        return;
    if (!isQuadratic())
...
void
CellModel::changeOrientationOf1D(mcIdType *nodalConn, unsigned int sz) const
{
    if (!isDynamic())
    {
        if (sz == 2 || sz == 3)
...
unsigned
CellModel::getNumberOfNodesConstituentTheSon2(unsigned sonId, const mcIdType *nodalConn, mcIdType lgth) const
{
    if (!isDynamic())
 ...
 * are equivalent by a permutation or not. This method expects to work on 1D or 2D (only mesh dimension where it is
 * possible to have a spaceDim) strictly higher than meshDim. If not an exception will be thrown.
 * @return True if two cells have same orientation, false if not.
 */
bool
CellModel::getOrientationStatus(mcIdType lgth, const mcIdType *conn1, const mcIdType *conn2) const
{
    if (_dim != 1 && _dim != 2)
    ...
    if (!_quadratic)
    {
        ...
        if (it2 != tmp.rend())
            return false;
        throw INTERP_KERNEL::Exception(
            "CellModel::getOrientationStatus : Request of orientation status of non equal connectively cells !"
        );
    }
    else
    {
...
DiameterCalculator *
CellModel::buildInstanceOfDiameterCalulator(int spaceDim) const
{
    switch (_type)
    {
        case NORM_TRI3:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For TRI3 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_QUAD4:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For QUAD4 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_TRI6:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For TRI6 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_TRI7:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For TRI7 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_QUAD8:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For QUAD8 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_QUAD9:
        {
            switch (spaceDim)
            {
                ...
                default:
                    throw Exception(
                        "CellModel::buildInstanceOfDiameterCalulator : For QUAD9 only space dimension 2 and 3 "
                        "implemented !"
                    );
            }
            break;
        ...
        case NORM_TETRA4:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For TETRA4 space dimension 3 expected !"
                );
        }
        case NORM_TETRA10:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For TETRA10 space dimension 3 expected !"
                );
        }
        case NORM_HEXA8:
        {
        ...
        case NORM_HEXA20:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For HEXA20 space dimension 3 expected !"
                );
        }
        case NORM_HEXA27:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For HEXA27 space dimension 3 expected !"
                );
        }
        case NORM_PENTA6:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For PENTA6 space dimension 3 expected !"
                );
        }
        case NORM_PENTA15:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For PENTA15 space dimension 3 expected !"
                );
        }
        case NORM_PYRA5:
        {
        ...
        case NORM_PYRA13:
        {
            if (spaceDim == 3)
                ...
                throw Exception(
                    "CellModel::buildInstanceOfDiameterCalulator : For PYRA13 space dimension 3 expected !"
                );
        }
        default:
            throw Exception(
                "CellModel::buildInstanceOfDiameterCalulator : implemented only for TRI3, QUAD4, TETRA4, HEXA8, "
                "PENTA6, PYRA5 !"
            );
    }
}
...
OrientationInverter *
CellModel::buildOrientationInverter() const
{
    switch (_type)
    {
        case NORM_SEG2:
        ...
        default:
        {
            ...
            oss << "CellModel::buildOrientationInverter : not managed geometric type " << getRepr() << " yet !";
