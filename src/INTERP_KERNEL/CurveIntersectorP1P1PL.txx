...
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::CurveIntersectorP1P1PL(
    ...
    : CurveIntersector<MyMeshType, MyMatrix>(meshT, meshS, precision, tolerance, medianLine, printLevel)
{
}

template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::getNumberOfRowsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::getNumberOfColsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix>
void
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::AppendValueInMatrix2(
    typename MyMatrix::value_type &resRow, ConnType nodeIdS0, double val0
)
{
...
template <class MyMeshType, class MyMatrix>
void
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::AppendValueInMatrix(
...
template <class MyMeshType, class MyMatrix>
void
CurveIntersectorP1P1PL<MyMeshType, MyMatrix>::intersectCells(
