...
template <class MyMeshType, class MyMatrix>
void
MappedBarycentric3DIntersectorP1P1<MyMeshType, MyMatrix>::intersectCells(
    ...
    for (std::size_t nodeIdT = 0; nodeIdT < nbOfNodesT; nodeIdT++)
    {
             ...
             iterCellS++)
        {
                ...
                ))
            {
                ...
                coo[0] = &localCoordsS[0];
                coo[1] = &localCoordsS[3];
                coo[2] = &localCoordsS[6];
                coo[3] = &localCoordsS[9];
                coo[4] = &localCoordsS[12];
                coo[5] = &localCoordsS[15];
                coo[6] = &localCoordsS[18];
                coo[7] = &localCoordsS[21];
