...
const char *INTERP_KERNEL::AsmX86::OPS[NB_OF_OPS] = {
    "mov",
    "push",
    "pop",
    "fld",
...
std::vector<char>
INTERP_KERNEL::AsmX86::convertIntoMachineLangage(const std::vector<std::string> &asmb) const
{
    std::vector<char> ret;
...
char *
INTERP_KERNEL::AsmX86::copyToExecMemZone(const std::vector<char> &ml, unsigned &offset) const
{
    char *ret = 0;
...
void
INTERP_KERNEL::AsmX86::convertOneInstructionInML(const std::string &inst, std::vector<char> &ml) const
{
    ...
    switch (id)
    {
        ...
        default:
        {
            ...
            oss << "Unrecognized op : " << op << " in assembly line : " << inst;
...
void
INTERP_KERNEL::AsmX86::convertMov(const std::string &inst, std::vector<char> &ml)
{
    ...
    {
        std::ostringstream oss;
        oss << "not recognized instruction mov : " << inst;
        throw INTERP_KERNEL::Exception(oss.str().c_str());
    }
...
void
INTERP_KERNEL::AsmX86::convertMovToEsp(const std::string &inst1, const std::string &inst2, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertPush(const std::string &inst, std::vector<char> &ml)
{
    std::string::size_type pos = inst.find_first_of(' ');
    std::string inst2 = inst.substr(pos + 1);
    const char ASM1[] = "ebp";
...
void
INTERP_KERNEL::AsmX86::convertPop(const std::string &inst, std::vector<char> &ml)
{
    std::string::size_type pos = inst.find_first_of(' ');
    std::string inst2 = inst.substr(pos + 1);
    const char ASM1[] = "ebp";
...
void
INTERP_KERNEL::AsmX86::convertFld(const std::string &inst, std::vector<char> &ml)
{
    std::string::size_type pos = inst.find_first_of(' ');
...
void
INTERP_KERNEL::AsmX86::convertFaddp(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFsubp(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFmulp(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFdivp(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFcos(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFsin(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFabs(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFchs(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertFsqrt(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertSub(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertAdd(const std::string &inst, std::vector<char> &ml)
{
    if (inst.substr(0, 4) == "esp,")
    {
...
void
INTERP_KERNEL::AsmX86::convertRet(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertLeave(const std::string &inst, std::vector<char> &ml)
{
...
void
INTERP_KERNEL::AsmX86::convertMovsd(const std::string &inst, std::vector<char> &ml)
{
    ...
    std::ostringstream oss;
    oss << "not recognized instruction movsd : " << inst;
    throw INTERP_KERNEL::Exception(oss.str().c_str());
}

void
INTERP_KERNEL::AsmX86::convertFst(const std::string &inst, std::vector<char> &ml)
{
    ...
    std::ostringstream oss;
    oss << "not recognized instruction fst : " << inst;
    throw INTERP_KERNEL::Exception(oss.str().c_str());
    // tony
}

void
INTERP_KERNEL::AsmX86::appendAddress(const std::string &addr, int nbOfByte, std::vector<char> &ml)
{
    int i, j;
    char v;
