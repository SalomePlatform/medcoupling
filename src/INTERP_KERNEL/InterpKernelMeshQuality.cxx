...
double
INTERP_KERNEL::quadSkew(const double *coo)
{
    double pa0[3] = {
        coo[3] + coo[6] - coo[0] - coo[9], coo[4] + coo[7] - coo[1] - coo[10], coo[5] + coo[8] - coo[2] - coo[11]
    };
    double pa1[3] = {
...
double
INTERP_KERNEL::quadEdgeRatio(const double *coo)
{
    double a2 = (coo[3] - coo[0]) * (coo[3] - coo[0]) + (coo[4] - coo[1]) * (coo[4] - coo[1]) +
                (coo[5] - coo[2]) * (coo[5] - coo[2]);
    double b2 = (coo[6] - coo[3]) * (coo[6] - coo[3]) + (coo[7] - coo[4]) * (coo[7] - coo[4]) +
                (coo[8] - coo[5]) * (coo[8] - coo[5]);
    double c2 = (coo[9] - coo[6]) * (coo[9] - coo[6]) + (coo[10] - coo[7]) * (coo[10] - coo[7]) +
                (coo[11] - coo[8]) * (coo[11] - coo[8]);
    double d2 = (coo[0] - coo[9]) * (coo[0] - coo[9]) + (coo[1] - coo[10]) * (coo[1] - coo[10]) +
                (coo[2] - coo[11]) * (coo[2] - coo[11]);
...
double
INTERP_KERNEL::quadAspectRatio(const double *coo)
{
    double a = sqrt(
        (coo[3] - coo[0]) * (coo[3] - coo[0]) + (coo[4] - coo[1]) * (coo[4] - coo[1]) +
        (coo[5] - coo[2]) * (coo[5] - coo[2])
    );
    double b = sqrt(
        (coo[6] - coo[3]) * (coo[6] - coo[3]) + (coo[7] - coo[4]) * (coo[7] - coo[4]) +
        (coo[8] - coo[5]) * (coo[8] - coo[5])
    );
    double c = sqrt(
        (coo[9] - coo[6]) * (coo[9] - coo[6]) + (coo[10] - coo[7]) * (coo[10] - coo[7]) +
        (coo[11] - coo[8]) * (coo[11] - coo[8])
    );
    double d = sqrt(
        (coo[0] - coo[9]) * (coo[0] - coo[9]) + (coo[1] - coo[10]) * (coo[1] - coo[10]) +
        (coo[2] - coo[11]) * (coo[2] - coo[11])
    );
    double ma = a > b ? a : b;
    double mb = c > d ? c : d;
    ...
    double ab[3] = {
        (coo[4] - coo[1]) * (coo[8] - coo[5]) - (coo[7] - coo[4]) * (coo[5] - coo[2]),
        (coo[5] - coo[2]) * (coo[6] - coo[3]) - (coo[3] - coo[0]) * (coo[8] - coo[5]),
        (coo[3] - coo[0]) * (coo[7] - coo[4]) - (coo[4] - coo[1]) * (coo[6] - coo[3])
    };
    double cd[3] = {
        (coo[10] - coo[7]) * (coo[2] - coo[11]) - (coo[1] - coo[10]) * (coo[11] - coo[8]),
...
double
INTERP_KERNEL::quadWarp(const double *coo)
{
    ...
    double warp = std::min(
        n0[0] / l0 * n2[0] / l2 + n0[1] / l0 * n2[1] / l2 + n0[2] / l0 * n2[2] / l2,
        n1[0] / l1 * n3[0] / l3 + n1[1] / l1 * n3[1] / l3 + n1[2] / l1 * n3[2] / l3
    );
    return warp * warp * warp;
}

double
INTERP_KERNEL::triEdgeRatio(const double *coo)
{
    double a2 = (coo[3] - coo[0]) * (coo[3] - coo[0]) + (coo[4] - coo[1]) * (coo[4] - coo[1]) +
                (coo[5] - coo[2]) * (coo[5] - coo[2]);
    double b2 = (coo[6] - coo[3]) * (coo[6] - coo[3]) + (coo[7] - coo[4]) * (coo[7] - coo[4]) +
                (coo[8] - coo[5]) * (coo[8] - coo[5]);
    double c2 = (coo[0] - coo[6]) * (coo[0] - coo[6]) + (coo[1] - coo[7]) * (coo[1] - coo[7]) +
                (coo[2] - coo[8]) * (coo[2] - coo[8]);
    double mab = a2 < b2 ? a2 : b2;
    double Mab = a2 < b2 ? b2 : a2;
...
double
INTERP_KERNEL::triAspectRatio(const double *coo)
{
    double a = sqrt(
        (coo[3] - coo[0]) * (coo[3] - coo[0]) + (coo[4] - coo[1]) * (coo[4] - coo[1]) +
        (coo[5] - coo[2]) * (coo[5] - coo[2])
    ...
    double c = sqrt(
        (coo[0] - coo[6]) * (coo[0] - coo[6]) + (coo[1] - coo[7]) * (coo[1] - coo[7]) +
        (coo[2] - coo[8]) * (coo[2] - coo[8])
    );
...
double
INTERP_KERNEL::tetraEdgeRatio(const double *coo)
{
...
double
INTERP_KERNEL::tetraAspectRatio(const double *coo)
{
    ...
    double detTet = (ab[0] * (ac[1] * ad[2] - ac[2] * ad[1])) + (ab[1] * (ac[2] * ad[0] - ac[0] * ad[2])) +
    ...
    bd[0] = ab[1] * bc[2] - ab[2] * bc[1];
    bd[1] = ab[2] * bc[0] - ab[0] * bc[2];
    bd[2] = ab[0] * bc[1] - ab[1] * bc[0];
    A = sqrt(bd[0] * bd[0] + bd[1] * bd[1] + bd[2] * bd[2]);
    bd[0] = ab[1] * ad[2] - ab[2] * ad[1];
    bd[1] = ab[2] * ad[0] - ab[0] * ad[2];
    bd[2] = ab[0] * ad[1] - ab[1] * ad[0];
    B = sqrt(bd[0] * bd[0] + bd[1] * bd[1] + bd[2] * bd[2]);
    bd[0] = ac[1] * ad[2] - ac[2] * ad[1];
    bd[1] = ac[2] * ad[0] - ac[0] * ad[2];
    bd[2] = ac[0] * ad[1] - ac[1] * ad[0];
    C = sqrt(bd[0] * bd[0] + bd[1] * bd[1] + bd[2] * bd[2]);
    bd[0] = bc[1] * cd[2] - bc[2] * cd[1];
    bd[1] = bc[2] * cd[0] - bc[0] * cd[2];
    bd[2] = bc[0] * cd[1] - bc[1] * cd[0];
