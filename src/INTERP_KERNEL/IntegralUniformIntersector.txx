...
IntegralUniformIntersector<MyMeshType, MyMatrix>::IntegralUniformIntersector(const MyMeshType &mesh, bool isAbs)
    : _mesh(mesh), _from_to(false), _is_abs(isAbs)
{
}

template <class MyMeshType, class MyMatrix>
void
IntegralUniformIntersector<MyMeshType, MyMatrix>::putValueIn(ConnType iInCMode, double val1, MyMatrix &res) const
{
...
template <class MyMeshType, class MyMatrix>
IntegralUniformIntersectorP0<MyMeshType, MyMatrix>::IntegralUniformIntersectorP0(const MyMeshType &mesh, bool isAbs)
    : IntegralUniformIntersector<MyMeshType, MyMatrix>(mesh, isAbs)
{
}

template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
IntegralUniformIntersectorP0<MyMeshType, MyMatrix>::getNumberOfRowsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
IntegralUniformIntersectorP0<MyMeshType, MyMatrix>::getNumberOfColsOfResMatrix() const
{
    if (IntegralUniformIntersector<MyMeshType, MyMatrix>::_from_to)
        return IntegralUniformIntersector<MyMeshType, MyMatrix>::_mesh.getNumberOfElements();
    else
...
template <class MyMeshType, class MyMatrix>
void
IntegralUniformIntersectorP0<MyMeshType, MyMatrix>::intersectCells(
...
)
{
    ...
    for (ConnType i = 0; i < nbelem; i++)
    {
        INTERP_KERNEL::NormalizedCellType t =
            IntegralUniformIntersector<MyMeshType, MyMatrix>::_mesh.getTypeOfElement(OTT<ConnType, numPol>::indFC(i));
        double val = computeVolSurfOfCell<ConnType, numPol, MyMeshType::MY_SPACEDIM>(
            t, conn + OTT<ConnType, numPol>::ind2C(connIndx[i]), connIndx[i + 1] - connIndx[i], coords
        );
...
template <class MyMeshType, class MyMatrix>
IntegralUniformIntersectorP1<MyMeshType, MyMatrix>::IntegralUniformIntersectorP1(const MyMeshType &mesh, bool isAbs)
    : IntegralUniformIntersector<MyMeshType, MyMatrix>(mesh, isAbs)
{
}
...
template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
IntegralUniformIntersectorP1<MyMeshType, MyMatrix>::getNumberOfRowsOfResMatrix() const
{
    if (IntegralUniformIntersector<MyMeshType, MyMatrix>::_from_to)
        return 1;
    else
...
template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
IntegralUniformIntersectorP1<MyMeshType, MyMatrix>::getNumberOfColsOfResMatrix() const
{
    if (IntegralUniformIntersector<MyMeshType, MyMatrix>::_from_to)
        return IntegralUniformIntersector<MyMeshType, MyMatrix>::_mesh.getNumberOfNodes();
    else
...
template <class MyMeshType, class MyMatrix>
void
IntegralUniformIntersectorP1<MyMeshType, MyMatrix>::intersectCells(
    ConnType targetCell, const std::vector<ConnType> &srcCells, MyMatrix &res
)
{
    static const NumberingPolicy numPol = MyMeshType::My_numPol;
    ...
    for (ConnType i = 0; i < nbelem; i++)
    {
        ...
        for (ConnType j = 0; j < lgth; j++)
            IntegralUniformIntersector<MyMeshType, MyMatrix>::putValueIn(
                OTT<ConnType, numPol>::coo2C(locConn[j]), val, res
            );
    }
}
}  // namespace INTERP_KERNEL
