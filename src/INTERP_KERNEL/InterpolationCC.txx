...
void
fillMatrix(
    const std::list<Interference> inter_of_axis[dim],
    MatrixType &result,
...
InterpolationCC::interpolateMeshes(
    const MyMeshType &src_mesh, const MyMeshType &tgt_mesh, MatrixType &result, const char *method
)
{
