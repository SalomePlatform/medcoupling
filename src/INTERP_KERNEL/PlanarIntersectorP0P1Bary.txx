...
PlanarIntersectorP0P1Bary<MyMeshType, MyMatrix, ConcreteP0P1Intersector>::PlanarIntersectorP0P1Bary(
...
PlanarIntersectorP0P1Bary<MyMeshType, MyMatrix, ConcreteP0P1Intersector>::getNumberOfRowsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix, class ConcreteP0P1Intersector>
typename MyMeshType::MyConnType
PlanarIntersectorP0P1Bary<MyMeshType, MyMatrix, ConcreteP0P1Intersector>::getNumberOfColsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix, class ConcreteP0P1Intersector>
void
PlanarIntersectorP0P1Bary<MyMeshType, MyMatrix, ConcreteP0P1Intersector>::intersectCells(
...
)
{
    ...
    PlanarIntersector<MyMeshType, MyMatrix>::getRealTargetCoordinates(
        OTT<ConnType, numPol>::indFC(icellT), trgTriaCoords
    );
    ...
    for (typename std::vector<ConnType>::const_iterator iter = icellsS.begin(); iter != icellsS.end(); iter++)
    {
        ...
        PlanarIntersector<MyMeshType, MyMatrix>::getRealSourceCoordinates(
            OTT<ConnType, numPol>::indFC(iS), srcCellCoords
        );
        ...
        if (SPACEDIM == 3)
        {
            ...
            orientation = PlanarIntersector<MyMeshType, MyMatrix>::projectionThis(
                &trgTriaCoordsTmp[0], &srcCellCoordsTmp[0], 3, srcNbNodes
            );
        }
