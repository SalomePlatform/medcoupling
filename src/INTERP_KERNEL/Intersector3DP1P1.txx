...
Intersector3DP1P1<MyMeshType, MyMatrix>::Intersector3DP1P1(const MyMeshType &targetMesh, const MyMeshType &srcMesh)
...
Intersector3DP1P1<MyMeshType, MyMatrix>::getNumberOfRowsOfResMatrix() const
{
...
template <class MyMeshType, class MyMatrix>
typename MyMeshType::MyConnType
Intersector3DP1P1<MyMeshType, MyMatrix>::getNumberOfColsOfResMatrix() const
{
