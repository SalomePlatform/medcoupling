...
inline double
SqNormV2(const double tab[2])
{
    return tab[0] * tab[0] + tab[1] * tab[1];
}

inline void
DiffV2(const double a[2], const double b[2], double c[2])
{
    c[0] = a[0] - b[0];
    c[1] = a[1] - b[1];
}
...
inline double
SqNormV3(const double tab[3])
{
    return tab[0] * tab[0] + tab[1] * tab[1] + tab[2] * tab[2];
}

inline void
DiffV3(const double a[3], const double b[3], double c[3])
{
    c[0] = a[0] - b[0];
    c[1] = a[1] - b[1];
    c[2] = a[2] - b[2];
...
void
ComputeForListOfCellIdsUMeshFrmt(
...
)
{
    ...
    for (const mcIdType *it = bgIds; it != endIds; it++)
    {
        ...
        else
        {
            ...
            oss << "DiameterCalculator::computeForListOfCellIdsUMeshFrmt : invalid nodal connectivity format at cell # "
                << *it << " !";
...
template <class Evaluator>
void
ComputeFor1SGTUMeshFrmt(mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr)
{
    Evaluator evtor;
    NormalizedCellType ct(Evaluator::TYPE);
...
double
DiameterCalulatorTRI3S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorTRI3S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI3S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI3S2::computeFor1SGTUMeshFrmt(
...
double
DiameterCalulatorTRI3S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 3)
    {
...
void
DiameterCalulatorTRI3S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI3S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI3S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTRI6S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorTRI6S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI6S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI6S2::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTRI6S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 6)
...
void
DiameterCalulatorTRI6S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI6S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI6S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTRI7S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorTRI7S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI7S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI7S2::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTRI7S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 7)
        return DiameterCalulatorTRI3S3::ComputeForOneCellInternal(bg, bg + 3, coordsPtr);
    else
...
void
DiameterCalulatorTRI7S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI7S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTRI7S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD4S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorQUAD4S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD4S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD4S2::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD4S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 4)
    {
        const double *a(coordsPtr + 3 * bg[0]), *b(coordsPtr + 3 * bg[1]), *c(coordsPtr + 3 * bg[2]),
...
void
DiameterCalulatorQUAD4S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD4S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD4S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD8S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorQUAD8S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD8S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD8S2::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD8S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 8)
...
void
DiameterCalulatorQUAD8S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD8S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD8S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD9S2::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorQUAD9S2::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD9S2::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD9S2::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorQUAD9S3::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 9)
        return DiameterCalulatorQUAD4S3::ComputeForOneCellInternal(bg, bg + 4, coordsPtr);
    else
...
void
DiameterCalulatorQUAD9S3::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD9S3::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorQUAD9S3::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTETRA4::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 4)
    {
        const double *a(coordsPtr + 3 * bg[0]), *b(coordsPtr + 3 * bg[1]), *c(coordsPtr + 3 * bg[2]),
...
void
DiameterCalulatorTETRA4::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTETRA4::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTETRA4::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorTETRA10::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 10)
        return DiameterCalulatorTETRA4::ComputeForOneCellInternal(bg, bg + 4, coordsPtr);
    else
        throw Exception(
            "DiameterCalulatorTETRA10::ComputeForOneCellInternal : input connectivity must be of size 10 !"
        );
}

void
DiameterCalulatorTETRA10::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTETRA10::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorTETRA10::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorHEXA8::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 8)
    {
        const double *p0(coordsPtr + 3 * bg[0]), *p1(coordsPtr + 3 * bg[1]), *p2(coordsPtr + 3 * bg[2]),
            *p3(coordsPtr + 3 * bg[3]), *p4(coordsPtr + 3 * bg[4]), *p5(coordsPtr + 3 * bg[5]),
            *p6(coordsPtr + 3 * bg[6]), *p7(coordsPtr + 3 * bg[7]);
...
void
DiameterCalulatorHEXA8::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA8::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA8::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorHEXA20::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorHEXA20::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA20::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA20::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorHEXA27::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorHEXA27::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA27::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorHEXA27::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorPENTA6::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 6)
    {
        const double *p0(coordsPtr + 3 * bg[0]), *p1(coordsPtr + 3 * bg[1]), *p2(coordsPtr + 3 * bg[2]),
...
void
DiameterCalulatorPENTA6::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPENTA6::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPENTA6::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorPENTA15::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 15)
        return DiameterCalulatorPENTA6::ComputeForOneCellInternal(bg, bg + 6, coordsPtr);
    else
        throw Exception(
            "DiameterCalulatorPENTA15::ComputeForOneCellInternal : input connectivity must be of size 15 !"
        );
}

void
DiameterCalulatorPENTA15::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPENTA15::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPENTA15::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorPYRA5::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
    if (std::distance(bg, endd) == 5)
    {
        const double *p0(coordsPtr + 3 * bg[0]), *p1(coordsPtr + 3 * bg[1]), *p2(coordsPtr + 3 * bg[2]),
            *p3(coordsPtr + 3 * bg[3]), *p4(coordsPtr + 3 * bg[4]);
        double l0[3], l1[3], l2[3], l3[3], l4[3], l5[3];
        DiffV3(p0, p2, l0);
        DiffV3(p1, p3, l1);
        DiffV3(p0, p4, l2);
...
void
DiameterCalulatorPYRA5::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPYRA5::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPYRA5::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
...
double
DiameterCalulatorPYRA13::ComputeForOneCellInternal(const mcIdType *bg, const mcIdType *endd, const double *coordsPtr)
{
...
void
DiameterCalulatorPYRA13::computeForListOfCellIdsUMeshFrmt(
    const mcIdType *bgIds,
    const mcIdType *endIds,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPYRA13::computeForRangeOfCellIdsUMeshFrmt(
    mcIdType bgId,
    mcIdType endId,
    const mcIdType *indPtr,
    const mcIdType *connPtr,
...
void
DiameterCalulatorPYRA13::computeFor1SGTUMeshFrmt(
    mcIdType nbOfCells, const mcIdType *connPtr, const double *coordsPtr, double *resPtr
) const
{
