...
MPI_Comm
MPI2Connector::remoteMPI2Connect(const std::string &service)
{
    int i;
    ...
    if (_num_proc == 0)
    {
        ...
        {
            std::cerr << "[" << _num_proc << "] I get the connection with " << service << " at " << port_name_clt
                      << std::endl;
...
void
MPI2Connector::remoteMPI2Disconnect(const std::string &service)
{
    std::ostringstream msg;
