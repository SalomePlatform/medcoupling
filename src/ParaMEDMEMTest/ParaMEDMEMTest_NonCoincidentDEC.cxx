...
void
ParaMEDMEMTest::testNonCoincidentDEC_2D()
{
    int size;
    ...
    testNonCoincidentDEC("square1_split", "Mesh_2", "square2_split", "Mesh_3", 3, 1e-6);
}

void
ParaMEDMEMTest::testNonCoincidentDEC_3D()
{
    int size;
    MPI_Comm_size(MPI_COMM_WORLD, &size);
    ...
    testNonCoincidentDEC("blade_12000_split2", "Mesh_1", "blade_3000_split2", "Mesh_1", 2, 1e4);
}

void
ParaMEDMEMTest::testNonCoincidentDEC(
