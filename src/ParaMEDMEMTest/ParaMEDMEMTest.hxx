...
#endif
    void testAsynchronousInterpKernelDEC_2D(
        double dtA,
        double tmaxA,
        double dtB,
        double tmaxB,
...
template <class T>
void
ParaMEDMEMTest_DumpArray(std::ostream &stream, const T *array, const int length, const std::string text)
{
    stream << text << ": {";
    if (length > 0)
    {
