...
/*!
 * Idem testFabienAPI1 except that procs are shuffled. Test of the good management of group translation in newly created
 * communicator.
 */
void
ParaMEDMEMTest::testFabienAPI2()
{
    int size;
    int rank;
    MPI_Comm_size(MPI_COMM_WORLD, &size);
