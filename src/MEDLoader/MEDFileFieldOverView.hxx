...
class MEDMeshMultiLev : public RefCountObject
{
   ...
   public:
    ...
    MEDLOADER_EXPORT DataArray *buildDataArray(
...
class MEDUMeshMultiLev : public MEDMeshMultiLev
{
   public:
    ...
    MEDLOADER_EXPORT bool buildVTUArrays(
    ...
    MEDLOADER_EXPORT bool buildVTUArrays94(
   ...
   private:
    ...
    //! this attribute is used only for mesh with no cells but having coordinates. For classical umeshes those pointer
    //! is equal to pointer of coordinates of instances in this->_parts.
...
class MEDCurveLinearMeshMultiLev : public MEDStructuredMeshMultiLev
{
   public:
    ...
    static MEDCurveLinearMeshMultiLev *New(
    ...
    std::vector<mcIdType> getNodeGridStructure() const;
    MEDMeshMultiLev *prepare() const;
    MEDLOADER_EXPORT void buildVTUArrays(
...
class MEDFileField1TSStructItem2 : public BigMemoryObject
{
   public:
    ...
    static MEDFileField1TSStructItem2 BuildAggregationOf(
...
class MEDFileField1TSStructItem : public BigMemoryObject
{
   public:
    ...
    bool isCompatibleWithNodesDiscr(
    ...
    MEDLOADER_EXPORT MEDMeshMultiLev *buildFromScratchDataSetSupportOnCells(
        const MEDFileMeshStruct *mst, const MEDFileFieldGlobsReal *globs
    ) const;
    MEDLOADER_EXPORT static MEDFileField1TSStructItem BuildItemFrom(
        const MEDFileAnyTypeField1TS *ref, const MEDFileMeshStruct *meshSt
    );
...
class MEDFileField1TSStruct : public RefCountObject
{
   public:
    ...
    MEDLOADER_EXPORT MEDMeshMultiLev *buildFromScratchDataSetSupport(
        const MEDFileMeshStruct *mst, const MEDFileFieldGlobsReal *globs
    ) const;
...
{
   public:
    MEDLOADER_EXPORT static MEDFileFastCellSupportComparator *New(
        const MEDFileMeshStruct *m, const MEDFileAnyTypeFieldMultiTS *ref
    );
    MEDLOADER_EXPORT std::string getClassName() const override
    {
        return std::string("MEDFileFastCellSupportComparator");
    }
    MEDLOADER_EXPORT MEDMeshMultiLev *buildFromScratchDataSetSupport(
        int timeStepId, const MEDFileFieldGlobsReal *globs
    ) const;
    MEDLOADER_EXPORT bool isDataSetSupportEqualToThePreviousOne(
        int timeStepId, const MEDFileFieldGlobsReal *globs
    ) const;
    MEDLOADER_EXPORT int getNumberOfTS() const;
    MEDLOADER_EXPORT std::vector<INTERP_KERNEL::NormalizedCellType> getGeoTypesAt(
        int timeStepId, const MEDFileMesh *m
    ) const;
