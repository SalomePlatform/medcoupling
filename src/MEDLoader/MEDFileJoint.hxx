...
class MEDFileJointCorrespondence : public RefCountObject, public MEDFileWritable
{
   public:
    ...
    MEDLOADER_EXPORT static MEDFileJointCorrespondence *New(
        DataArrayIdType *correspondence,  // cells
...
class MEDFileJointOneStep : public RefCountObject, public MEDFileWritable
{
   public:
    ...
    MEDLOADER_EXPORT static MEDFileJointOneStep *New(
        const std::string &fileName, const std::string &mName, const std::string &jointName, int number = 1
    );
    MEDLOADER_EXPORT static MEDFileJointOneStep *New(
        med_idt fid, const std::string &mName, const std::string &jointName, int number = 1
    );
...
class MEDFileJoint : public RefCountObject, public MEDFileWritableStandAlone
{
   public:
    ...
    MEDLOADER_EXPORT static MEDFileJoint *New(
        const std::string &jointName,
        const std::string &locMeshName,
        const std::string &remoteMeshName,
        int remoteMeshNum
    );
