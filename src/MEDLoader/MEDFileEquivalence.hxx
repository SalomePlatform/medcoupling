...
{
   public:
    static MEDFileEquivalencePair *Load(
        MEDFileEquivalences *father, med_idt fid, const std::string &name, const std::string &desc
    );
   ...
   private:
    MEDFileEquivalencePair(MEDFileEquivalences *father, const std::string &name, const std::string &desc)
        : _father(father), _name(name), _description(desc)
    {
    }
...
class MEDFileEquivalenceCellType : public MEDFileEquivalenceData
{
   public:
    MEDFileEquivalenceCellType(
        MEDFileEquivalencePair *owner, INTERP_KERNEL::NormalizedCellType type, DataArrayInt *data
    )
        : MEDFileEquivalenceData(owner, data), _type(type)
    {
    }
