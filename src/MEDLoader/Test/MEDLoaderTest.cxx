...
void
MEDLoaderTest::testMesh2DCurveRW()
{
...
void
MEDLoaderTest::testMesh3DSurfRW()
{
 ...
 */
void
MEDLoaderTest::testFieldRW1()
{
    MEDCouplingFieldDouble *f1 = buildVecFieldOnCells_1();
    WriteField("file6.med", f1, true);
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldCell("file6.med", f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 0, 1)
    );
    ...
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode("file7.med", f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 3)
    );
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
    // testing kind message on error of field type.
    CPPUNIT_ASSERT_THROW(
        ReadFieldCell("file7.med", f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 3),
...
MEDLoaderTest::testFieldRW2()
{
    ...
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 8, 9)
    );
    f1->setTime(10., 8, 9);
    tmp[0] = VAL1;
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
    f2->decrRef();
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 0, 1)
    );
    ...
    f2->decrRef();
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 18, 19)
    );
    f1->setTime(10.14, 18, 19);
    tmp[0] = VAL2;
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
    ...
    CPPUNIT_ASSERT_THROW(
        ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 28, 19),
        INTERP_KERNEL::Exception
    );
    f2->decrRef();
    f1->decrRef();
    // Reading Int and Float fields:
    MEDCouplingFieldInt *f2_int = dynamic_cast<MEDCouplingFieldInt *>(
        ReadFieldCell(fileName, f1_int->getMesh()->getName().c_str(), 0, f1_int->getName().c_str(), 8, 9)
    );
    CPPUNIT_ASSERT(f1_int->isEqual(f2_int, 1e-12, 0));  // exact equality for int values
    f2_int->decrRef();
    f1_int->decrRef();
    MEDCouplingFieldInt64 *f2_int64 = dynamic_cast<MEDCouplingFieldInt64 *>(
        ReadFieldCell(fileName, f1_int64->getMesh()->getName().c_str(), 0, f1_int64->getName().c_str(), 8, 9)
    );
    CPPUNIT_ASSERT(f1_int64->isEqual(f2_int64, 1e-12, 0));  // exact equality for int values
    f2_int64->decrRef();
    f1_int64->decrRef();
    MEDCouplingFieldFloat *f2_fl = dynamic_cast<MEDCouplingFieldFloat *>(
        ReadFieldCell(fileName, f1_fl->getMesh()->getName().c_str(), 0, f1_fl->getName().c_str(), 8, 9)
    );
    ...
    WriteFieldUsingAlreadyWrittenMesh(fileName2, f1);
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName2, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 108, 109)
    );
    f1->setTime(110., 108, 109);
    tmp[3] = VAL1;
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
    f2->decrRef();
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName2, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 3)
    );
    ...
    f2->decrRef();
    f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName2, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 208, 209)
    );
    f1->setTime(210., 208, 209);
    tmp[3] = VAL2;
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
...
MEDLoaderTest::testFieldRW3()
{
    ...
    CPPUNIT_ASSERT_EQUAL(8, it1[0].first);
    CPPUNIT_ASSERT_EQUAL(9, it1[0].second);
    CPPUNIT_ASSERT_EQUAL(18, it1[1].first);
    CPPUNIT_ASSERT_EQUAL(19, it1[1].second);
    CPPUNIT_ASSERT_EQUAL(28, it1[2].first);
    CPPUNIT_ASSERT_EQUAL(29, it1[2].second);
    CPPUNIT_ASSERT_EQUAL(38, it1[3].first);
    CPPUNIT_ASSERT_EQUAL(39, it1[3].second);
    CPPUNIT_ASSERT_EQUAL(48, it1[4].first);
    CPPUNIT_ASSERT_EQUAL(49, it1[4].second);
    std::vector<std::pair<int, int> > it3 = GetNodeFieldIterations(fileName, name3, name1);
    CPPUNIT_ASSERT_EQUAL(3, (int)it3.size());
    CPPUNIT_ASSERT_EQUAL(8, it3[0].first);
    CPPUNIT_ASSERT_EQUAL(9, it3[0].second);
    CPPUNIT_ASSERT_EQUAL(108, it3[1].first);
    CPPUNIT_ASSERT_EQUAL(109, it3[1].second);
    CPPUNIT_ASSERT_EQUAL(208, it3[2].first);
    CPPUNIT_ASSERT_EQUAL(209, it3[2].second);
    //
    f1->decrRef();
    //
...
void
MEDLoaderTest::testMultiMeshRW1()
{
...
void
MEDLoaderTest::testFieldProfilRW1()
{
    ...
    //
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 7)
    );
    std::vector<MEDCoupling::TypeOfField> types =
        GetTypesOfField(fileName, f1->getMesh()->getName().c_str(), f1->getName().c_str());
 ...
 */
void
MEDLoaderTest::testFieldNodeProfilRW1()
{
    ...
    f1->setMesh(m);
    DataArrayDouble *array = DataArrayDouble::New();
    const double arr1[24] = {1., 101., 2., 102., 3., 103., 4.,  104., 5.,  105., 6.,  106.,
    ...
    //
    MEDCouplingFieldDouble *f3 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName, f2->getMesh()->getName().c_str(), 0, f2->getName().c_str(), 2, 7)
    );
    ...
    f3 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName2, f2->getMesh()->getName().c_str(), 0, f2->getName().c_str(), 2, 7)
    );
    f3->checkConsistencyLight();
    CPPUNIT_ASSERT(f3->isEqual(f2, 1e-12, 1e-12));
    f3->decrRef();
...
void
MEDLoaderTest::testFieldNodeProfilRW2()
{
    ...
    f1->setName("FieldMix");
    f1->setMesh(mesh);
    const double arr2[24] = {1071., 1171., 1010., 1110., 1020., 1120., 1030., 1130., 1040., 1140., 1050., 1150.,
    ...
    WriteField(fileName, f1, false);  // <- false important for the test
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        ReadFieldNode(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 7)
    );
...
void
MEDLoaderTest::testFieldGaussRW1()
{
    const char fileName[] = "file13.med";
    MEDCouplingFieldDouble *f1 = buildVecFieldOnGauss_1();
    WriteField(fileName, f1, true);
    MCAuto<MEDCouplingField> f2Tmp(
        ReadField(ON_GAUSS_PT, fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 1, 5)
    );
...
void
MEDLoaderTest::testFieldGaussNERW1()
{
    ...
    MCAuto<MEDCouplingField> f2Tmp(
        ReadField(ON_GAUSS_NE, fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 1, 5)
    );
    MCAuto<MEDCouplingFieldDouble> f2(MEDCoupling::DynamicCast<MEDCouplingField, MEDCouplingFieldDouble>(f2Tmp));
    CPPUNIT_ASSERT(f1->isEqual(f2, 1e-12, 1e-12));
    f1->decrRef();
...
void
MEDLoaderTest::testLittleStrings1()
{
...
void
MEDLoaderTest::testSplitIntoNameAndUnit1()
{
    std::string s(" []");
    std::string c, u;
...
void
MEDLoaderTest::testMesh3DSurfShuffleRW()
{
...
void
MEDLoaderTest::testFieldShuffleRW1()
{
    ...
    WriteField(fileName, f1, true);
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        (MEDCouplingField *)ReadFieldCell(fileName, mesh->getName().c_str(), 0, f1->getName().c_str(), 2, 7)
    );
    CPPUNIT_ASSERT(f2->isEqual(f1, 1e-12, 1e-12));
    f2->decrRef();
    //
 ...
 */
void
MEDLoaderTest::testMultiFieldShuffleRW1()
{
    ...
    std::vector<MEDCouplingFieldDouble *> fs =
        ReadFieldsOnSameMesh(ON_CELLS, fileName, f_1->getMesh()->getName().c_str(), 0, f_1->getName().c_str(), its);
...
void
MEDLoaderTest::testWriteUMeshesRW1()
{
    ...
    MEDCouplingUMesh *m2d =
        (MEDCouplingUMesh *)m3d->buildFacePartOfMySelfNode(&nodes[0], &nodes[0] + nodes.size(), true);
    ...
    WriteFieldUsingAlreadyWrittenMesh(fileName, f1);
    MEDCouplingFieldDouble *f2 = dynamic_cast<MEDCouplingFieldDouble *>(
        (MEDCouplingField *)ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), -1, f1->getName().c_str(), 2, 7)
    );
    CPPUNIT_ASSERT(f2->isEqual(f1, 1e-12, 1e-12));
    f1->decrRef();
    f2->decrRef();
...
void
MEDLoaderTest::testMixCellAndNodesFieldRW1()
{
    ...
    //
    WriteField(fileName, f1, true);
    std::vector<MEDCoupling::TypeOfField> ts =
        GetTypesOfField(fileName, f1->getMesh()->getName().c_str(), f1->getName().c_str());
    ...
    //
    MEDCouplingFieldDouble *f3 = dynamic_cast<MEDCouplingFieldDouble *>(
        (MEDCouplingField *)ReadFieldNode(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 7)
    );
    CPPUNIT_ASSERT(f3->isEqual(f2, 1e-12, 1e-12));
    f3->decrRef();
    f3 = dynamic_cast<MEDCouplingFieldDouble *>(
        (MEDCouplingField *)ReadFieldCell(fileName, f1->getMesh()->getName().c_str(), 0, f1->getName().c_str(), 2, 7)
    );
...
void
MEDLoaderTest::testGetAllFieldNamesRW1()
{
...
void
MEDLoaderTest::testMEDLoaderRead1()
{
    using namespace std;
    ...
    for (int i = 0; i < 12; i++) CPPUNIT_ASSERT_EQUAL(NORM_TETRA4, mesh->getTypeOfCell(i));
    ...
    CPPUNIT_ASSERT_EQUAL(
        701,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 90, 0)
    );
    CPPUNIT_ASSERT_EQUAL(
        705,
        std::accumulate(
            mesh->getNodalConnectivityIndex()->getPointer(), mesh->getNodalConnectivityIndex()->getPointer() + 17, 0
        )
    );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        46., std::accumulate(mesh->getCoords()->getPointer(), mesh->getCoords()->getPointer() + 57, 0), 1e-12
    );
    mesh->decrRef();
    //
    ...
    CPPUNIT_ASSERT_EQUAL(
        132,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 11, 0)
    );
    CPPUNIT_ASSERT_EQUAL(
        16,
        std::accumulate(
            mesh->getNodalConnectivityIndex()->getPointer(), mesh->getNodalConnectivityIndex()->getPointer() + 3, 0
        )
    );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        46., std::accumulate(mesh->getCoords()->getPointer(), mesh->getCoords()->getPointer() + 57, 0), 1e-12
    ...
    CPPUNIT_ASSERT_EQUAL(ToIdType(19), mesh->getNumberOfNodes());
    CPPUNIT_ASSERT_EQUAL(2, (int)mesh->getAllGeoTypes().size());
    for (int i = 0; i < 6; i++) CPPUNIT_ASSERT_EQUAL(NORM_TETRA4, mesh->getTypeOfCell(i));
    ...
    CPPUNIT_ASSERT_EQUAL(
        254,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 36, 0)
    );
    CPPUNIT_ASSERT_EQUAL(
        141,
        std::accumulate(
            mesh->getNodalConnectivityIndex()->getPointer(), mesh->getNodalConnectivityIndex()->getPointer() + 8, 0
        )
    );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        46., std::accumulate(mesh->getCoords()->getPointer(), mesh->getCoords()->getPointer() + 57, 0), 1e-12
    ...
    std::vector<std::pair<int, int> > its0 =
        GetCellFieldIterations(fileName.c_str(), meshNames[0].c_str(), fieldsName[0].c_str());
    CPPUNIT_ASSERT_EQUAL(1, (int)its0.size());
    CPPUNIT_ASSERT_EQUAL(-1, its0[0].first);
    CPPUNIT_ASSERT_EQUAL(-1, its0[0].second);
    std::vector<std::pair<int, int> > its1 =
        GetCellFieldIterations(fileName.c_str(), meshNames[0].c_str(), fieldsName[1].c_str());
    CPPUNIT_ASSERT_EQUAL(1, (int)its1.size());
    CPPUNIT_ASSERT_EQUAL(-1, its1[0].first);
    CPPUNIT_ASSERT_EQUAL(-1, its1[0].second);
    //
    MEDCouplingFieldDouble *field0 = dynamic_cast<MEDCouplingFieldDouble *>((MEDCouplingField *)ReadFieldCell(
        fileName.c_str(), meshNames[0].c_str(), 0, fieldsName[0].c_str(), its0[0].first, its0[0].second
    ));
    ...
    double diffValue[16];
    std::transform(
        field0->getArray()->getPointer(),
        field0->getArray()->getPointer() + 16,
        expectedValues,
        diffValue,
        std::minus<double>()
    );
    ...
    for (int i = 0; i < 12; i++) CPPUNIT_ASSERT_EQUAL(NORM_TETRA4, constMesh->getTypeOfCell(i));
    ...
    CPPUNIT_ASSERT_EQUAL(
        701,
        std::accumulate(
            constMesh->getNodalConnectivity()->getConstPointer(),
            constMesh->getNodalConnectivity()->getConstPointer() + 90,
            0
        )
    );
    CPPUNIT_ASSERT_EQUAL(
        705,
        std::accumulate(
            constMesh->getNodalConnectivityIndex()->getConstPointer(),
            constMesh->getNodalConnectivityIndex()->getConstPointer() + 17,
            0
        )
    );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        46.,
        std::accumulate(constMesh->getCoords()->getConstPointer(), constMesh->getCoords()->getConstPointer() + 57, 0),
        1e-12
    );
    field0->decrRef();
    //
    MEDCouplingFieldDouble *field1 = dynamic_cast<MEDCouplingFieldDouble *>((MEDCouplingField *)ReadFieldCell(
        fileName.c_str(), meshNames[0].c_str(), 0, fieldsName[1].c_str(), its1[0].first, its1[0].second
    ));
    ...
    const double expectedValues2[48] = {1., 0., 1., 1., 0., 1., 1., 0., 1., 2., 1., 0., 2., 1., 0., 2.,
                                        1., 0., 3., 0., 1., 3., 0., 1., 3., 0., 1., 4., 1., 0., 4., 1.,
                                        0., 4., 1., 0., 5., 0., 0., 6., 1., 1., 6., 0., 0., 5., 1., 1.};
    double diffValue2[48];
    std::transform(
        field1->getArray()->getPointer(),
        field1->getArray()->getPointer() + 48,
        expectedValues2,
        diffValue2,
        std::minus<double>()
    );
    ...
    std::vector<std::pair<int, int> > its0Node =
        GetNodeFieldIterations(fileName.c_str(), meshNames[0].c_str(), fieldsNameNode[0].c_str());
    ...
    MEDCouplingFieldDouble *field0Nodes = dynamic_cast<MEDCouplingFieldDouble *>((MEDCouplingField *)ReadFieldNode(
        fileName.c_str(), meshNames[0].c_str(), 0, fieldsNameNode[0].c_str(), its0Node[0].first, its0Node[0].second
    ));
    ...
    std::transform(
        field0Nodes->getArray()->getPointer(),
        field0Nodes->getArray()->getPointer() + 19,
        expectedValues3,
        diffValue3,
        std::minus<double>()
    );
    ...
    field0Nodes->decrRef();
    //
    field0Nodes = dynamic_cast<MEDCouplingFieldDouble *>((MEDCouplingField *)ReadFieldNode(
        fileName.c_str(), meshNames[0].c_str(), 0, fieldsNameNode[0].c_str(), its0Node[2].first, its0Node[2].second
    ));
    field0Nodes->checkConsistencyLight();
    CPPUNIT_ASSERT(field0Nodes->getName() == fieldsNameNode[0]);
    CPPUNIT_ASSERT_EQUAL(1, (int)field0Nodes->getNumberOfComponents());
...
void
MEDLoaderTest::testMEDLoaderPolygonRead()
{
    using namespace std;
    using namespace INTERP_KERNEL;
    ...
    CPPUNIT_ASSERT_EQUAL(2, (int)mesh->getAllGeoTypes().size());
    for (int i = 0; i < 514; i++) CPPUNIT_ASSERT_EQUAL(NORM_QUAD4, mesh->getTypeOfCell(i));
    for (int i = 514; i < 538; i++) CPPUNIT_ASSERT_EQUAL(NORM_POLYGON, mesh->getTypeOfCell(i));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        0., std::accumulate(mesh->getCoords()->getPointer(), mesh->getCoords()->getPointer() + 1737, 0), 1e-12
    );
    const double expectedVals1[12] = {
        1.4851585216522212,
        -0.5,
        0.,
        1.4851585216522212,
    ...
    std::transform(
        mesh->getCoords()->getPointer(),
        mesh->getCoords()->getPointer() + 12,
        expectedVals1,
        diffValue1,
        std::minus<double>()
    );
    ...
    CPPUNIT_ASSERT_EQUAL(
        651050,
        std::accumulate(
            mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 2768, 0
        )
    );
    CPPUNIT_ASSERT_EQUAL(
        725943,
        std::accumulate(
            mesh->getNodalConnectivityIndex()->getPointer(), mesh->getNodalConnectivityIndex()->getPointer() + 539, 0
        )
    );
    mesh->decrRef();
    //
    ...
    std::vector<std::pair<int, int> > its0 =
        GetCellFieldIterations(fileName.c_str(), meshNames[0].c_str(), fieldsName[0].c_str());
    CPPUNIT_ASSERT_EQUAL(1, (int)its0.size());
    MEDCouplingFieldDouble *field = dynamic_cast<MEDCouplingFieldDouble *>((MEDCouplingField *)ReadFieldCell(
        fileName.c_str(), meshNames[0].c_str(), 0, fieldsName[0].c_str(), its0[0].first, its0[0].second
    ));
    ...
    for (int i = 0; i < 514; i++) CPPUNIT_ASSERT_EQUAL(NORM_QUAD4, constMesh->getTypeOfCell(i));
    for (int i = 514; i < 538; i++) CPPUNIT_ASSERT_EQUAL(NORM_POLYGON, constMesh->getTypeOfCell(i));
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        0.,
        std::accumulate(constMesh->getCoords()->getConstPointer(), constMesh->getCoords()->getConstPointer() + 1737, 0),
        1e-12
    );
    std::transform(
        constMesh->getCoords()->getConstPointer(),
        constMesh->getCoords()->getConstPointer() + 12,
        expectedVals1,
        diffValue1,
        std::minus<double>()
    );
    ...
    CPPUNIT_ASSERT_EQUAL(
        ...
        std::accumulate(
            constMesh->getNodalConnectivity()->getConstPointer(),
            constMesh->getNodalConnectivity()->getConstPointer() + 2768,
            0
        )
    );
    CPPUNIT_ASSERT_EQUAL(
        ...
        std::accumulate(
            constMesh->getNodalConnectivityIndex()->getConstPointer(),
            constMesh->getNodalConnectivityIndex()->getConstPointer() + 539,
            0
        )
    );
...
void
MEDLoaderTest::testMEDLoaderPolyhedronRead()
{
    using namespace std;
    using namespace INTERP_KERNEL;
    ...
    CPPUNIT_ASSERT_EQUAL(
        725,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 98, 0)
    );
    CPPUNIT_ASSERT_DOUBLES_EQUAL(
        110., std::accumulate(mesh->getCoords()->getPointer(), mesh->getCoords()->getPointer() + 57, 0), 1e-12
    );
    CPPUNIT_ASSERT_EQUAL(
        155,
        std::accumulate(
            mesh->getNodalConnectivityIndex()->getPointer(), mesh->getNodalConnectivityIndex()->getPointer() + 4, 0
        )
    );
    mesh->decrRef();
    //
    ...
    CPPUNIT_ASSERT_EQUAL(
        619,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 83, 0)
    );
    mesh->decrRef();
    //
    vector<string> families = GetMeshFamiliesNames(fileName.c_str(), meshNames[0].c_str());
    ...
    for (int i = 0; i < 3; i++) CPPUNIT_ASSERT_EQUAL(NORM_POLYGON, mesh->getTypeOfCell(i));
    CPPUNIT_ASSERT_EQUAL(ToIdType(19), mesh->getNodalConnectivity()->getNbOfElems());
    CPPUNIT_ASSERT_EQUAL(
        117,
        std::accumulate(mesh->getNodalConnectivity()->getPointer(), mesh->getNodalConnectivity()->getPointer() + 19, 0)
    );
    mesh->decrRef();
    //
    mesh = ReadUMeshFromFamilies(fileName.c_str(), meshNames[0].c_str(), 0, families2);
...
MEDCouplingUMesh *
MEDLoaderTest::build2DCurveMesh_1()
{
...
MEDCouplingUMesh *
MEDLoaderTest::build2DMesh_1()
{
    double targetCoords[24] = {-0.3, -0.3, 0.2, -0.3, 0.7, -0.3, -0.3,  0.2,  0.2, 0.2, 0.7,  0.2,
                               -0.3, 0.7,  0.2, 0.7,  0.7, 0.7,  -0.05, 0.95, 0.2, 1.2, 0.45, 0.95};
...
MEDCouplingUMesh *
MEDLoaderTest::build3DSurfMesh_1()
{
    double targetCoords[36] = {-0.3, -0.3, -0.3, 0.2,   -0.3, -0.3, 0.7,  -0.3, -0.3, -0.3, 0.2,  -0.3,
                               0.2,  0.2,  -0.3, 0.7,   0.2,  -0.3, -0.3, 0.7,  -0.3, 0.2,  0.7,  -0.3,
                               0.7,  0.7,  -0.3, -0.05, 0.95, -0.3, 0.2,  1.2,  -0.3, 0.45, 0.95, -0.3};
    mcIdType targetConn[24] = {1, 4, 2, 4, 5, 2, 6, 10, 8, 9, 11, 7, 0, 3, 4, 1, 6, 7, 4, 3, 7, 8, 5, 4};
    MEDCouplingUMesh *targetMesh = MEDCouplingUMesh::New();
    targetMesh->setMeshDimension(2);
    targetMesh->allocateCells(6);
...
MEDCouplingUMesh *
MEDLoaderTest::build3DMesh_1()
{
    double coords[180] = {0., 0., 0.,   1.,  1., 0., 1., 1.25, 0.,  0., 1., 0., 1.,   1.5, 0., 2., 0., 0.,   2.,  1.,
                          0., 1., 2.,   0.,  0., 2., 0., 3.,   1.,  0., 3., 2., 0.,   0.,  1., 0., 1., 3.,   0.,  2.,
                          2., 0., 2.,   3.,  0., 0., 0., 1.,   1.,  1., 1., 1., 1.25, 1.,  0., 1., 1., 1.,   1.5, 1.,
                          2., 0., 1.,   2.,  1., 1., 1., 2.,   1.,  0., 2., 1., 3.,   1.,  1., 3., 2., 1.,   0.,  1.,
                          1., 1., 3.,   1.,  2., 2., 1., 2.,   3.,  1., 0., 0., 2.,   1.,  1., 2., 1., 1.25, 2.,  0.,
                          1., 2., 1.,   1.5, 2., 2., 0., 2.,   2.,  1., 2., 1., 2.,   2.,  0., 2., 2., 3.,   1.,  2.,
                          3., 2., 2.,   0.,  1., 2., 1., 3.,   2.,  2., 2., 2., 2.,   3.,  2., 0., 0., 3.,   1.,  1.,
                          3., 1., 1.25, 3.,  0., 1., 3., 1.,   1.5, 3., 2., 0., 3.,   2.,  1., 3., 1., 2.,   3.,  0.,
...
MEDLoaderTest::buildVecFieldOnCells_1()
{
    MEDCouplingUMesh *mesh = build3DSurfMesh_1();
...
MEDLoaderTest::buildInt64VecFieldOnCells_1()
{
    MEDCouplingUMesh *mesh = build3DSurfMesh_1();
    mcIdType nbOfCells = mesh->getNumberOfCells();
...
MEDLoaderTest::buildFloatVecFieldOnCells_1()
{
    MEDCouplingUMesh *mesh = build3DSurfMesh_1();
    mcIdType nbOfCells = mesh->getNumberOfCells();
...
MEDCouplingFieldDouble *
MEDLoaderTest::buildVecFieldOnNodes_1()
{
    MEDCouplingUMesh *mesh = build3DSurfMesh_1();
    ...
    const double arr1[36] = {
        70.,   80.,    90.,    71.,   81.,    91.,    72.,   82.,    92.,    73.,   83.,    93.,
        74.,   84.,    94.,    75.,   85.,    95.,    1000., 10010., 10020., 1001., 10011., 10021.,
        1002., 10012., 10022., 1003., 10013., 10023., 1004., 10014., 10024., 1005., 10015., 10025.,
    };
...
MEDCouplingFieldDouble *
MEDLoaderTest::buildVecFieldOnGauss_1()
{
    ...
    for (int i = 0; i < 19 * 2; i++) ptr[i] = (double)(i + 7);
    f->setArray(array);
...
MEDLoaderTest::buildVecFieldOnGaussNE_1()
{
    ...
    array->alloc(20, 2);
    double *ptr = array->getPointer();
    for (int i = 0; i < 20 * 2; i++) ptr[i] = (double)(i + 8);
    f->setArray(array);
