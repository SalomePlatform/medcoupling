...
void
SauvLoaderTest::testMed2SauvOnAMeshWithVoidFamily()
{
...
void
SauvLoaderTest::testSauv2MedOnA3SubsField()
{
    // read SAUV
...
SauvLoaderTest::testMed2Sauv()
{
    ...
    mcIdType conn[] = {0, 1, 2, 0, 1, 3, 10, 11, 12, 13};
    ...
    double vals[2 * (3 + 4)] = {311, 312, 321, 322, 331, 332, 411, 412, 421, 422, 431, 432, 441, 442};
    ...
    MCAuto<MEDCouplingUMesh> pointeUM0 = static_cast<MEDCouplingUMesh *>(pointeMedMesh->getMeshAtLevel(0));
...
void
SauvLoaderTest::testCellsWithLingNames()
{
...
void
SauvLoaderTest::tearDown()
{
    const int nbFilesToRemove = 3;
#if defined(WIN32) && defined(UNICODE)
    const wchar_t *fileToRemove[nbFilesToRemove] = {
        L"allPillesTest.med", L"pointe.sauv", L"mesh_with_void_family.sauv"
    };
#else
