...
class MEDFileAnyTypeFieldMultiTSWithoutSDA : public RefCountObject, public MEDFileFieldNameScope
{
   ...
   public:
    ...
    {
        return std::string("MEDFileAnyTypeFieldMultiTSWithoutSDA");
    }
    ...
    MEDLOADER_EXPORT virtual std::vector<MCAuto<MEDFileAnyTypeFieldMultiTSWithoutSDA> >
    ...
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *buildFromTimeStepIds(
        const int *startIds, const int *endIds
    ) const;
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *buildFromTimeStepIds2(int bg, int end, int step) const;
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *partOfThisLyingOnSpecifiedTimeSteps(
        const std::vector<std::pair<int, int> > &timeSteps
    ) const;
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *partOfThisNotLyingOnSpecifiedTimeSteps(
        const std::vector<std::pair<int, int> > &timeSteps
    ) const;
    ...
    MEDLOADER_EXPORT void loadStructureOrStructureAndBigArraysRecursively(
        med_idt fid,
        int nbPdt,
        med_field_type fieldTyp,
        bool loadAll,
...
class MEDFileTemplateFieldMultiTSWithoutSDA : public MEDFileAnyTypeFieldMultiTSWithoutSDA
{
   public:
    ...
    MEDLOADER_EXPORT std::string getClassName() const override
    {
        return std::string("MEDFileTemplateFieldMultiTSWithoutSDA");
    }
   ...
   protected:
    ...
    MEDFileTemplateFieldMultiTSWithoutSDA(
        ...
        : MEDFileAnyTypeFieldMultiTSWithoutSDA(fid, fieldId, loadAll, ms, entities)
    {
    }
    MEDFileTemplateFieldMultiTSWithoutSDA(
        med_idt fid,
...
class MEDFileFieldMultiTSWithoutSDA : public MEDFileTemplateFieldMultiTSWithoutSDA<double>
{
   ...
   public:
    MEDLOADER_EXPORT MEDFileFieldMultiTSWithoutSDA(
        ...
        : MEDFileTemplateFieldMultiTSWithoutSDA<double>(fid, fieldId, loadAll, ms, entities)
    {
    }
...
class MEDFileInt32FieldMultiTSWithoutSDA : public MEDFileNDTemplateFieldMultiTSWithoutSDA<Int32>
{
   ...
   public:
    MEDLOADER_EXPORT MEDFileInt32FieldMultiTSWithoutSDA(
        ...
        : MEDFileNDTemplateFieldMultiTSWithoutSDA<Int32>(fid, fieldId, loadAll, ms, entities)
    {
    }
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *shallowCpy() const
    {
        return new MEDFileInt32FieldMultiTSWithoutSDA(*this);
    }
    MEDLOADER_EXPORT std::string getClassName() const override
    {
        return std::string("MEDFileInt32FieldMultiTSWithoutSDA");
    }
    MEDLOADER_EXPORT MCAuto<MEDFileAnyTypeFieldMultiTS> createNewWithSDA() const override;
...
class MEDFileInt64FieldMultiTSWithoutSDA : public MEDFileNDTemplateFieldMultiTSWithoutSDA<Int64>
{
   ...
   public:
    MEDLOADER_EXPORT MEDFileInt64FieldMultiTSWithoutSDA(
        ...
        : MEDFileNDTemplateFieldMultiTSWithoutSDA<Int64>(fid, fieldId, loadAll, ms, entities)
    {
    }
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *shallowCpy() const
    {
        return new MEDFileInt64FieldMultiTSWithoutSDA(*this);
    }
    MEDLOADER_EXPORT std::string getClassName() const override
    {
        return std::string("MEDFileInt64FieldMultiTSWithoutSDA");
    }
    MEDLOADER_EXPORT MCAuto<MEDFileAnyTypeFieldMultiTS> createNewWithSDA() const override;
...
class MEDFileFloatFieldMultiTSWithoutSDA : public MEDFileNDTemplateFieldMultiTSWithoutSDA<float>
{
   ...
   public:
    MEDLOADER_EXPORT MEDFileFloatFieldMultiTSWithoutSDA(
        ...
        : MEDFileNDTemplateFieldMultiTSWithoutSDA<float>(fid, fieldId, loadAll, ms, entities)
    {
    }
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTSWithoutSDA *shallowCpy() const
    {
        return new MEDFileFloatFieldMultiTSWithoutSDA(*this);
    }
    MEDLOADER_EXPORT std::string getClassName() const override
    {
        return std::string("MEDFileFloatFieldMultiTSWithoutSDA");
    }
    MEDLOADER_EXPORT MCAuto<MEDFileAnyTypeFieldMultiTS> createNewWithSDA() const override;
...
class MEDFileAnyTypeFieldMultiTS : public RefCountObject, public MEDFileWritableStandAlone, public MEDFileFieldGlobsReal
{
   protected:
    ...
    static MEDFileAnyTypeFieldMultiTS *BuildNewInstanceFromContent(
        MEDFileAnyTypeFieldMultiTSWithoutSDA *c, med_idt fid
    );
    static MEDFileAnyTypeFieldMultiTSWithoutSDA *BuildContentFrom(med_idt fid, bool loadAll, const MEDFileMeshes *ms);
    static MEDFileAnyTypeFieldMultiTSWithoutSDA *BuildContentFrom(
        med_idt fid,
        const std::string &fieldName,
        bool loadAll,
        const MEDFileMeshes *ms,
   ...
   public:
    ...
    MEDLOADER_EXPORT static MEDFileAnyTypeFieldMultiTS *New(
    ...
    MEDLOADER_EXPORT static MEDFileAnyTypeFieldMultiTS *BuildNewInstanceFromContent(
        MEDFileAnyTypeFieldMultiTSWithoutSDA *c
    );
    ...
    MEDLOADER_EXPORT static std::vector<std::vector<MEDFileAnyTypeFieldMultiTS *> > SplitIntoCommonTimeSeries(
        const std::vector<MEDFileAnyTypeFieldMultiTS *> &vectFMTS
    );
    MEDLOADER_EXPORT static std::vector<std::vector<MEDFileAnyTypeFieldMultiTS *> > SplitPerCommonSupport(
        const std::vector<MEDFileAnyTypeFieldMultiTS *> &vectFMTS,
        const MEDFileMesh *mesh,
        std::vector<MCAuto<MEDFileFastCellSupportComparator> > &fsc
    );
    MEDLOADER_EXPORT static int CheckSupportAcrossTime(
   ...
   public:
    ...
    MEDLOADER_EXPORT virtual MEDFileAnyTypeFieldMultiTS *extractPart(
        const std::map<int, MCAuto<DataArrayIdType> > &extractDef, MEDFileMesh *mm
    ) const = 0;
    MEDLOADER_EXPORT static MCAuto<MEDFileAnyTypeFieldMultiTS> Aggregate(
   ...
   private:
    static std::vector<std::vector<MEDFileAnyTypeFieldMultiTS *> > SplitPerCommonSupportNotNodesAlg(
        const std::vector<MEDFileAnyTypeFieldMultiTS *> &vectFMTS,
        const MEDFileMesh *mesh,
...
class MEDFileTemplateFieldMultiTS : public MEDFileAnyTypeFieldMultiTS
{
   public:
    ...
    MEDLOADER_EXPORT static typename MLFieldTraits<T>::FMTSType *New(DataArrayByte *db)
    {
        return BuildFromMemoryChunk<typename MLFieldTraits<T>::FMTSType>(db);
    }
    MEDLOADER_EXPORT static typename MLFieldTraits<T>::FMTSType *New(
        const std::string &fileName, const std::string &fieldName, bool loadAll = true
    );
    ...
    MEDLOADER_EXPORT static typename MLFieldTraits<T>::FMTSType *LoadSpecificEntities(
        const std::string &fileName,
        const std::string &fieldName,
        const std::vector<std::pair<TypeOfField, INTERP_KERNEL::NormalizedCellType> > &entities,
        bool loadAll = true
    );
    MEDLOADER_EXPORT typename MLFieldTraits<T>::FMTSType *extractPartImpl(
        const std::map<int, MCAuto<DataArrayIdType> > &extractDef, MEDFileMesh *mm
    ) const;
    MEDLOADER_EXPORT MEDFileAnyTypeFieldMultiTS *extractPart(
        const std::map<int, MCAuto<DataArrayIdType> > &extractDef, MEDFileMesh *mm
    ) const
    {
    ...
    MEDLOADER_EXPORT typename Traits<T>::FieldType *getFieldAtLevel(
        TypeOfField type, int iteration, int order, int meshDimRelToMax, int renumPol = 0
    ) const;
    MEDLOADER_EXPORT typename Traits<T>::FieldType *getFieldAtTopLevel(
        TypeOfField type, int iteration, int order, int renumPol = 0
    ) const;
    MEDLOADER_EXPORT typename Traits<T>::FieldType *getFieldOnMeshAtLevel(
        TypeOfField type, int iteration, int order, int meshDimRelToMax, const MEDFileMesh *mesh, int renumPol = 0
    ) const;
    MEDLOADER_EXPORT typename Traits<T>::FieldType *getFieldOnMeshAtLevel(
        TypeOfField type, int iteration, int order, const MEDCouplingMesh *mesh, int renumPol = 0
    ) const;
    MEDLOADER_EXPORT typename Traits<T>::FieldType *getFieldAtLevelOld(
        TypeOfField type, int iteration, int order, const std::string &mname, int meshDimRelToMax, int renumPol = 0
    ) const;
    ...
    MEDLOADER_EXPORT void appendFieldProfileFlatly(
        const typename Traits<T>::FieldType *field,
        const MEDFileMesh *mesh,
        int meshDimRelToMax,
        const DataArrayIdType *profile
   ...
   protected:
    ...
    void appendFieldProfileGeneral(
        const typename Traits<T>::FieldType *field,
        const MEDFileMesh *mesh,
        int meshDimRelToMax,
        const DataArrayIdType *profile,
...
class MEDFileNDTemplateFieldMultiTS : public MEDFileTemplateFieldMultiTS<T>
{
   ...
   protected:
    ...
    MEDFileNDTemplateFieldMultiTS() {}
    MEDFileNDTemplateFieldMultiTS(const typename MLFieldTraits<T>::FMTSWSDAType &other, bool shallowCopyOfContent)
        : MEDFileTemplateFieldMultiTS<T>(other, shallowCopyOfContent)
    {
    }
    MEDFileNDTemplateFieldMultiTS(med_idt fid, bool loadAll, const MEDFileMeshes *ms)
        : MEDFileTemplateFieldMultiTS<T>(fid, loadAll, ms)
    {
    }
    MEDFileNDTemplateFieldMultiTS(
        med_idt fid,
        ...
        : MEDFileTemplateFieldMultiTS<T>(fid, fieldName, loadAll, ms, entities)
    {
    }
};
...
class MEDFileInt32FieldMultiTS : public MEDFileNDTemplateFieldMultiTS<Int32>
{
   ...
   private:
    ...
    MEDFileInt32FieldMultiTS() {}
    MEDFileInt32FieldMultiTS(const MEDFileInt32FieldMultiTSWithoutSDA &other, bool shallowCopyOfContent)
        : MEDFileNDTemplateFieldMultiTS<Int32>(other, shallowCopyOfContent)
    {
    }
    MEDFileInt32FieldMultiTS(med_idt fid, bool loadAll, const MEDFileMeshes *ms)
        : MEDFileNDTemplateFieldMultiTS<Int32>(fid, loadAll, ms)
    {
    }
    MEDFileInt32FieldMultiTS(
        med_idt fid,
        ...
        : MEDFileNDTemplateFieldMultiTS<Int32>(fid, fieldName, loadAll, ms, entities)
    {
    }
};
...
class MEDFileInt64FieldMultiTS : public MEDFileNDTemplateFieldMultiTS<Int64>
{
   ...
   private:
    ...
    MEDFileInt64FieldMultiTS() {}
    MEDFileInt64FieldMultiTS(const MEDFileInt64FieldMultiTSWithoutSDA &other, bool shallowCopyOfContent)
        : MEDFileNDTemplateFieldMultiTS<Int64>(other, shallowCopyOfContent)
    {
    }
    MEDFileInt64FieldMultiTS(med_idt fid, bool loadAll, const MEDFileMeshes *ms)
        : MEDFileNDTemplateFieldMultiTS<Int64>(fid, loadAll, ms)
    {
    }
    MEDFileInt64FieldMultiTS(
        med_idt fid,
        ...
        : MEDFileNDTemplateFieldMultiTS<Int64>(fid, fieldName, loadAll, ms, entities)
    {
    }
};
...
class MEDFileFloatFieldMultiTS : public MEDFileNDTemplateFieldMultiTS<float>
{
   ...
   private:
    ...
    MEDFileFloatFieldMultiTS() {}
    MEDFileFloatFieldMultiTS(const MEDFileFloatFieldMultiTSWithoutSDA &other, bool shallowCopyOfContent)
        : MEDFileNDTemplateFieldMultiTS<float>(other, shallowCopyOfContent)
    {
    }
    MEDFileFloatFieldMultiTS(med_idt fid, bool loadAll, const MEDFileMeshes *ms)
        : MEDFileNDTemplateFieldMultiTS<float>(fid, loadAll, ms)
    {
    }
    MEDFileFloatFieldMultiTS(
        med_idt fid,
        ...
        : MEDFileNDTemplateFieldMultiTS<float>(fid, fieldName, loadAll, ms, entities)
    {
    }
};
