...
class MEDLoaderBasicsTest(unittest.TestCase):
    ...
    def testExampleMeshAdvAPI1(self):
        da = DataArrayDouble.New([0.0, 1.1, 2.3, 3.6])
        meshName = "Example2"
        cmesh = MEDCouplingCMesh.New()
        cmesh.setCoords(da, da, da)
        ...
        ###
        myMesh0 = myMesh[:]
        myMesh0.setName("Example2")
        myMesh1 = myMesh0.buildDescendingConnectivity()[0]
        myMesh1.setName(myMesh0.getName())
        myMesh2 = myMesh1.buildDescendingConnectivity()[0]
        myMesh2.setName(myMesh0.getName())
        myMesh3 = myMesh2.buildDescendingConnectivity()[0]
        myMesh3.setName(myMesh0.getName())
        mm = MEDFileUMesh.New()
