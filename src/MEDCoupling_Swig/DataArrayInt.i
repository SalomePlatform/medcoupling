...
//   {
  ...
  public:
    ...
    %extend
    {
      ...
      static PyObject *FromVTK94InternalReprOfPolyedra(const ARRAY *arrIn, const DataArrayIdType *arrIndxIn, const DataArrayIdType *arrIndxIn2) throw(INTERP_KERNEL::Exception)
      {
        MCAuto<ARRAY> arrOut;
        MCAuto<DataArrayIdType> arrIndexOut;
        ARRAY::FromVTK94InternalReprOfPolyedra(arrIn,arrIndxIn,arrIndxIn2,arrOut,arrIndexOut);
        PyObject *ret=PyTuple_New(2);
        PyTuple_SetItem(ret,0,SWIG_NewPointerObj(SWIG_as_voidptr(arrOut.retn()),SWIGTITraits<mcIdType>::TI, SWIG_POINTER_OWN | 0 ));
        PyTuple_SetItem(ret,1,SWIG_NewPointerObj(SWIG_as_voidptr(arrIndexOut.retn()),SWIGTITraits<mcIdType>::TI, SWIG_POINTER_OWN | 0 ));
        return ret;
      ...
      static PyObject *FromVTK93To94FacesInternaReprOfPolyedra(const ARRAY *arrIn, const DataArrayIdType *arrIndxIn) throw(INTERP_KERNEL::Exception)
      {
        MCAuto<ARRAY> arrOut;
        MCAuto<DataArrayIdType> arrIndexOut;
        ARRAY::FromVTK93To94FacesInternaReprOfPolyedra(arrIn,arrIndxIn,arrOut,arrIndexOut);
        PyObject *ret=PyTuple_New(2);
        PyTuple_SetItem(ret,0,SWIG_NewPointerObj(SWIG_as_voidptr(arrOut.retn()),SWIGTITraits<mcIdType>::TI, SWIG_POINTER_OWN | 0 ));
        PyTuple_SetItem(ret,1,SWIG_NewPointerObj(SWIG_as_voidptr(arrIndexOut.retn()),SWIGTITraits<mcIdType>::TI, SWIG_POINTER_OWN | 0 ));
        return ret;
