...
class MEDCouplingBasicsTest(unittest.TestCase):
    ...
    def testExampleFieldDoubleBuildSubPart1(self):
        ...
        for i in range(8):  # 8 is not an error
            ...
            pass
        self.assertEqual(
            expected3[:4], [int(i) for i in m2C.getNodalConnectivity()][4:]
        )
        self.assertEqual(
            expected3[4:8], [int(i) for i in m2C.getNodalConnectivity()][:4]
        )
        self.assertEqual(
            expected4[:3], [int(i) for i in m2C.getNodalConnectivityIndex()]
        )
        ...
        for i in range(8):  # 8 is not an error
            ...
            pass
        self.assertEqual(
            expected3[:4], [int(i) for i in m2C.getNodalConnectivity()][4:8]
        )
        self.assertEqual(
            expected3[4:8], [int(i) for i in m2C.getNodalConnectivity()][:4]
        )
    ...
    def testExampleFieldDoubleBuild1(self):
        XCoords = [-0.3, 0.07, 0.1, 0.3, 0.45, 0.47, 0.49, 1.0, 1.22]
        arrX = DataArrayDouble(XCoords)
        YCoords = [0.07, 0.1, 0.37, 0.45, 0.47, 0.49, 1.007]
        arrY = DataArrayDouble(YCoords)
        mesh = MEDCouplingCMesh("My2D_CMesh")
        mesh.setCoords(arrX, arrY)
    ...
    def testExampleFieldDoubleBuild2(self):
        XCoords = [-0.3, 0.0, 0.1, 0.3, 0.45, 0.47, 0.49, 1.0, 1.22]
        arrX = DataArrayDouble(XCoords)
        YCoords = [0.0, 0.1, 0.37, 0.45, 0.47, 0.49, 1.007]
        arrY = DataArrayDouble(YCoords)
        mesh = MEDCouplingCMesh("My2D_CMesh")
        mesh.setCoords(arrX, arrY)
    ...
    def testExampleDataArrayApplyFunc1(self):
        ...
        d = DataArrayDouble([1.0, 2.0, 11.0, 12.0, 21.0, 22.0, 31.0, 41.0], 4, 2)
        ...
        self.assertTrue(
            d1.isEqual(
                DataArrayDouble(
                    [1.0, 4.0, 121.0, 144.0, 441.0, 484.0, 961.0, 1681.0], 4, 2
                ),
                1e-12,
            )
        )
        ...
        self.assertTrue(
            d2.isEqual(
                DataArrayDouble([1.0, 4.0, 11.0, 24.0, 21.0, 44.0, 31.0, 82.0], 4, 2),
                1e-12,
            )
        )
        # ! [PySnippetDataArrayApplyFunc1_3]
        ...
        dd = DataArrayDouble(
            [1.0, 4.0, 3.0, 11.0, 144.0, 13.0, 21.0, 484.0, 23.0, 31.0, 1024.0, 33.0],
            4,
            3,
        )
        # ! [PySnippetDataArrayApplyFunc1_4]
        ...
        self.assertTrue(
            dd1.isEqual(DataArrayDouble([6.0, 36.0, 66.0, 96.0], 4, 1), 1e-12)
        )
        # ! [PySnippetDataArrayApplyFunc1_5]
        # ! [PySnippetDataArrayApplyFunc1_6]
        dd2 = dd.applyFunc(1, "a+0.*b+c")
        self.assertTrue(
            dd2.isEqual(DataArrayDouble([4.0, 24.0, 44.0, 64.0], 4, 1), 1e-12)
        )
        # ! [PySnippetDataArrayApplyFunc1_6]
        ...
        self.assertTrue(
            ddd1.isEqual(DataArrayDouble([4.0, 24.0, 44.0, 64.0], 4, 1), 1e-12)
        )
        # ! [PySnippetDataArrayApplyFunc1_8]
