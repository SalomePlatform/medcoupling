...
inline void
MPIAccess::deleteRequest(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
    {
        if (_trace)
            std::cout << "MPIAccess::DeleteRequest" << _my_rank << "( " << RequestId << " ) " << aRequestStruct
                      << " MPIRequest " << aRequestStruct->MPIRequest << " MPIIsRecv " << aRequestStruct->MPIIsRecv
                      << std::endl;
    ...
    {
        if (_trace)
            std::cout << "MPIAccess::DeleteRequest" << _my_rank << "( " << RequestId << " ) Request not found"
                      << std::endl;
    }
}
...
inline void
MPIAccess::deleteRequests(int size, int *ArrayOfSendRequests)
{
    for (int i = 0; i < size; i++) deleteRequest(ArrayOfSendRequests[i]);
}

// Returns the last MPITag of the destination rank destrank
inline int
MPIAccess::sendMPITag(int destrank)
{
...
inline int
MPIAccess::recvMPITag(int sourcerank)
{
...
inline int
MPIAccess::sendRequestIdsSize(int destrank)
{
...
inline int
MPIAccess::recvRequestIdsSize(int sourcerank)
{
...
inline bool
MPIAccess::isTimeMessage(int aMPITag) const
{
...
inline MPI_Aint
MPIAccess::extent(MPI_Datatype adatatype) const
{
...
inline int
MPIAccess::MPITag(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline int
MPIAccess::MPITarget(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline bool
MPIAccess::MPIIsRecv(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline bool
MPIAccess::MPIAsynchronous(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline bool
MPIAccess::MPICompleted(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline MPI_Datatype
MPIAccess::MPIDatatype(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline int
MPIAccess::MPIOutCount(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
// Look at MPIAccess::NewSendTag/NewRecvTag in MPIAccess.cxx
inline int
MPIAccess::valTag(int tag, int method)
{
...
inline void
MPIAccess::deleteSendRecvRequest(int RequestId)
{
    if (_trace)
        std::cout << "MPIAccess::DeleteSendRecvRequest" << _my_rank << "( " << RequestId << " ) " << std::endl;
...
inline void
MPIAccess::deleteStatus(int RequestId)
{
...
inline MPI_Request *
MPIAccess::MPIRequest(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline MPI_Status *
MPIAccess::MPIStatus(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline void
MPIAccess::setMPICompleted(int RequestId, bool completed)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
inline void
MPIAccess::setMPIOutCount(int RequestId, int outcount)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
// identifier
inline void
MPIAccess::clearMPIStatus(int RequestId)
{
    struct RequestStruct *aRequestStruct = _map_of_request_struct[RequestId];
    if (aRequestStruct)
...
// Look at MPIAccess::NewSendTag/NewRecvTag in MPIAccess.cxx
inline _MessageIdent
MPIAccess::methodId(MPI_Datatype adatatype) const
{
...
inline MPI_Datatype
MPIAccess::datatype(_MessageIdent aMethodIdent) const
{
...
std::ostream &
operator<<(std::ostream &, const _MessageIdent &);

std::ostream &
operator<<(std::ostream &, const TimeMessage &);
