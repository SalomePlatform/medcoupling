...
inline mcIdType
ExplicitTopology::globalToLocal(const mcIdType global) const
{
...
mcIdType
ExplicitTopology::localToGlobal(mcIdType local) const
{
...
inline mcIdType
ExplicitTopology::getNbElements() const
{
    return _nb_elems;
}
...
inline mcIdType
ExplicitTopology::getNbLocalElements() const
{
